...
public function integer of_convert (datawindow adw_data, string as_title, string as_output, boolean ab_autoadjustformat, boolean ab_grayscale, boolean ab_watermark, boolean ab_embedfonts, boolean ab_encrypted)
public function integer of_convert (datastore ads_data, string as_title, string as_output, boolean ab_autoadjustformat, boolean ab_grayscale, boolean ab_watermark, boolean ab_embedfonts, boolean ab_encrypt)
public function string of_get_last_error ()
public subroutine of_enable_multilingual_support (boolean ab_multilingual)
end prototypes
...
return of_convert(ads_Data, as_Title, as_Output, ab_autoadjustformat, false, false, false, false)
end function
...
return of_convert(adw_Data, as_Title, as_Output, ab_AutoAdjustFormat, false, false, false, false)
end function
...
// Drucker vorbereiten
iuo_Amyuni.of_prepare_printer(as_Output, as_Title, ib_Multilingual, ab_Grayscale, ab_Watermark, ab_Embedfonts, ab_Encrypted)
...
// Drucker vorbereiten
iuo_Amyuni.of_prepare_printer(as_Output, as_Title, ib_Multilingual, ab_Grayscale, ab_Watermark, ab_EmbedFonts, ab_Encrypt)
...
public subroutine of_enable_multilingual_support (boolean ab_multilingual);/*
* Objekt : uo_pdf_handler
* Methode: of_enable_multilingual_support (Function)
* Autor  : Dirk Bunk
* Datum  : 14.08.2013
*
* Argument(e):
*   ab_Multilingual Flag, das angibt, ob die Unterst$$HEX1$$fc00$$ENDHEX$$tzung angeschaltet werden soll, oder nicht.
*
* Beschreibung: Schaltet die Unterst$$HEX1$$fc00$$ENDHEX$$tzung f$$HEX1$$fc00$$ENDHEX$$r internationale Schriftzeichen an oder aus.
*               Das wird beispielsweise ben$$HEX1$$f600$$ENDHEX$$tigt, wenn kyrillische Zeichen verwendet werden.
*
* $$HEX1$$c400$$ENDHEX$$nderungshistorie:
*   Version    Wer          Wann          Was und warum
*   1.0        Dirk Bunk    14.08.2013    Erstellung
...
ib_Multilingual = ab_Multilingual
end subroutine
...
// Wenn vorhanden, Amyuni 4.50 w$$HEX1$$e400$$ENDHEX$$hlen, sonst Amyuni 2.51
ls_SystemDir = f_get_system_dir()
if FileExists(ls_SystemDir + "\cdintf450.dll") then

...
//			ls_barcode =	dwData.GetItemString(lRows, "cpackinglist")+is_delimiter + &
//								string(date(strflightinfo.dtdeparturedate))+is_delimiter+ &
//								 is_delimiter + is_delimiter +&
//								dwData.GetItemString(lRows, "ctotalquantity")
...
if this.ib_Trace then
	ll_Ret = dwdata.SaveAs(lsFilenameForTrace02 + ".xls", Excel!, True)
end if

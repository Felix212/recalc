...
////////////////////////////////////////////////////////////////////////////////////////
function ulong WNetAddConnection2A(ref str_netresource lpNetResource, string lpPassword, string lpUsername, ulong dwFlags) library "mpr.dll" alias for "WNetAddConnection2A;Ansi"
...
strNetR.dwScope       = RESOURCE_GLOBALNET 
strNetR.dwType        = RESOURCETYPE_DISK
strNetR.dwDisplayType = RESOURCEDISPLAYTYPE_GENERIC 
strNetR.dwUsage       = RESOURCEUSAGE_ALL
strNetR.lpRemoteName  = as_remote_name 
strNetR.lpLocalName   = as_local_name
...
lReturn = WNetAddConnection2A(strNetR, as_password, as_username, lFlags) 

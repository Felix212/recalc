...
$PBExportComments$Bei der Mahlzeitenverteilung wird f$$HEX1$$fc00$$ENDHEX$$r jedem Stauort der Standardbeladung ein Objekt dieser Klasse angelegt. ~r~n~r~n
forward
...
// --------------------------------------------------
if this.dsPackinglistSize.Find("npltype_key=" + string(lPLType) + &
   " and (cmeal_control_code = '" + sMealControlCode + "' or cmeal_control_code2 = '" + sMealControlCode + "')", + &
	1, this.dsPackinglistSize.RowCount()) = 0 then

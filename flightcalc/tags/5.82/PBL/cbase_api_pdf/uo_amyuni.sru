...
// --------------------------------------------------------------------------------------------------------------------
boolean	ib_MULTILINGUAL_SUPPORT 	= false
boolean	ib_FULL_EMBED 					= false
...
public function integer of_prepare_printer (string as_output, string as_doctitle, boolean ab_grayscale, boolean ab_watermark, boolean ab_encrypted, boolean ab_multilanguage, boolean ab_full_embed)
end prototypes
...
return of_prepare_printer(as_Output, as_DocTitle, false, false, false, ib_MULTILINGUAL_SUPPORT, ib_FULL_EMBED )
end function
...
// string as_output
//  string as_doctitle
//  boolean ab_grayscale
//  boolean ab_watermark
//  boolean ab_encrypted
//  boolean ab_multilanguage
//  boolean ab_full_embed
//
//  Beschreibung: Bereitet den aktuellen Amyuni Drucker f$$HEX1$$fc00$$ENDHEX$$r den Druck eines Dokuments vor.
//  
//   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
if il_PrinterHandle > 0 then	
	...
	if li_ret = 0 then
		...
		if ab_full_embed 		then ll_Options += OPTION_FULL_EMBED 
		if ab_multilanguage	then ll_Options += OPTION_MULTILINGUAL_SUPPORT
...
if sqlca.sqlcode=0 then
	if ls_temp = "1" then
		ib_MULTILINGUAL_SUPPORT =	true
	else
		ib_MULTILINGUAL_SUPPORT =	false
	end if
else
	ib_MULTILINGUAL_SUPPORT =	false
end if

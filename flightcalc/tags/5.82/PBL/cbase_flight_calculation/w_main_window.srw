...
type rb_jobnr from radiobutton within w_main_window
end type
type sle_jobnr from singlelineedit within w_main_window
end type
...
this.rb_jobnr=create rb_jobnr
this.sle_jobnr=create sle_jobnr
...
destroy(this.rb_jobnr)
destroy(this.sle_jobnr)
destroy(this.pb_2)
destroy(this.st_5)
...
dw_1.dataobject="dw_screen_job_list_all"
dw_1.settransobject(SQLCA)
end event
...
dw_1.dataobject="dw_screen_job_list_new"
dw_1.settransobject(SQLCA)
end event
...
IF Len(sle_jobnr.Text) > 0 AND IsNumber(sle_jobnr.Text) THEN
	ll_jobnr = Long(sle_jobnr.Text)
	dw_1.dataobject="dw_screen_job_list_singlejob"
	dw_1.settransobject(SQLCA)
	dw_1.retrieve(ll_jobnr)
ELSE
...
integer taborder = 10
string title = "none"
string dataobject = "dw_screen_job_list_new"
boolean hscrollbar = true
boolean vscrollbar = true
borderstyle borderstyle = stylelowered!
end type

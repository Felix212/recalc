...
boolean 							bChange
boolean							bReturnWithoutAbort	=	true
...
for lStowages = 1 to Upperbound(this.uoDistribution.uoStowages)
	...
	for i = 1 to lLabels
		...
		if this.uoDistribution.uoStowages[lStowages].dsPackingListSize.RowCount() = 1 then
			...
			dw_stowages.SetItem(a, "cmeal_control_code2", this.uoDistribution.uoStowages[lStowages].dsPackingListSize.GetItemString(1, "cmeal_control_code2"))		
			dw_stowages.SetItem(a, "cmeal_control_code3", this.uoDistribution.uoStowages[lStowages].dsPackingListSize.GetItemString(1, "cmeal_control_code3"))		
			dw_stowages.SetItem(a, "cmeal_control_code4", this.uoDistribution.uoStowages[lStowages].dsPackingListSize.GetItemString(1, "cmeal_control_code4"))		
			dw_stowages.SetItem(a, "cmeal_control_code5", this.uoDistribution.uoStowages[lStowages].dsPackingListSize.GetItemString(1, "cmeal_control_code5"))		
			dw_stowages.SetItem(a, "cmeal_control_code6", this.uoDistribution.uoStowages[lStowages].dsPackingListSize.GetItemString(1, "cmeal_control_code6"))		
			dw_stowages.SetItem(a, "cmeal_control_code7", this.uoDistribution.uoStowages[lStowages].dsPackingListSize.GetItemString(1, "cmeal_control_code7"))		
			dw_stowages.SetItem(a, "cmeal_control_code8", this.uoDistribution.uoStowages[lStowages].dsPackingListSize.GetItemString(1, "cmeal_control_code8"))		
			dw_stowages.SetItem(a, "cmeal_control_code9", this.uoDistribution.uoStowages[lStowages].dsPackingListSize.GetItemString(1, "cmeal_control_code9"))		
...
strReturn.bReturnWithoutAbort = bReturnWithoutAbort // 23.02.2015 HR: CBASE-CFC-CR-2014-001
...
// --------------------------------------------------------------------------------------------------------------------
// 23.02.2015 HR: CBASE-CFC-CR-2014-001	
// --------------------------------------------------------------------------------------------------------------------
if cbase.sapplicationname="FTQ" then
	
	if bChange  then
		if bReturnWithoutAbort then
			iReturn = uf.mbox("Speichern","Sie haben Daten ge$$HEX1$$e400$$ENDHEX$$ndert und diese werden gespeichert. M$$HEX1$$f600$$ENDHEX$$chten Sie anschlie$$HEX1$$df00$$ENDHEX$$end mit der Verarbeitung fortfahren?",Question!,YesNo!,1)
		else
			uf.mbox("Speichern", "Sie haben Daten ge$$HEX1$$e400$$ENDHEX$$ndert und diese werden gespeichert.")
			iReturn = 1
		end if
		...
		If iReturn = 1 Then					// Speichern
			strReturn.bReturnWithoutAbort = bReturnWithoutAbort 
		else
			strReturn.bReturnWithoutAbort = false
		end if			
		
		closewithreturn(parent, strReturn)
	else
		bReturnWithoutAbort =false
		uf.mbox("Warnung!","Bitte vor dem Verlassen der manuellen Verteilung die MZ-Verteilung fertigstellen!")
		return 0
	end if

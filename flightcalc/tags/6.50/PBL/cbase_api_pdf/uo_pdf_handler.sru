...
If IsValid(iuo_Amyuni) Then
	Return iuo_Amyuni.LastError
Else
	Return "Amyuni instance is invalid."
End If
end function
...
public function string of_get_version ();/*
* Objekt : uo_pdf_handler
* Methode: of_get_version (Function)
* Autor  : Dirk Bunk
* Datum  : 04.08.2021
*
* Argument(e):
*   keine
*
* Beschreibung: Gibt die genutzte Amyuni Version zur$$HEX1$$fc00$$ENDHEX$$ck.	
*
* $$HEX1$$c400$$ENDHEX$$nderungshistorie:
*   Version    Wer          Wann          Was und warum
*   1.0        Dirk Bunk    04.08.2021    Erstellung
*
* Return: 
*   Die genutzte Amyuni Version.
*/

If IsValid(iuo_Amyuni) Then
	Return iuo_Amyuni.of_get_version()
Else
	Return "not set"
End If
end function

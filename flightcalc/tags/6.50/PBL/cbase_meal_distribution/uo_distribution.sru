...
//				this.dsPackinglistSizeFind.SetItem(lSizes, "cmeal_control_code2", String(lNextLeg) + sCode)
	...
	if this.dsPackinglistSizeFind.RowCount() > 0 then
		...
		this.of_log("Stowage " + String(lCount) + " Class " + of_checknull(this.dsLoadingList.GetItemString(lRow, "cclass1")))
		this.of_log("Stowage " + String(lCount) + " Class " + of_checknull(this.dsLoadingList.GetItemString(lRow, "cclass2")))
		this.of_log("Stowage " + String(lCount) + " Class " + of_checknull(this.dsLoadingList.GetItemString(lRow, "cclass3")))
...
IF ls_save_distrtibution = "1" AND NOT this.bManuelDistribution THEN
	...
	f_trace(classname() + ".of_restore_distribution START ")
...
//		DESTROY lds_cen_out_md_ps
//		DESTROY lds_cen_out_md_co
//		f_trace(classname() + ".of_restore_distribution TOO MANY CONTAINERS  "+ String(ll_rows))		
//		return false
		f_trace(classname() + ".of_restore_distribution BEFORE INIT CONTAINER "+ String(ll_rows))		
		uoStowages[ll_rows] 								= 		CREATE uo_distribution_container

		f_yield(lRoleID)
		
		f_trace(classname() + ".of_restore_distribution AFTER INIT CONTAINER "+ String(ll_rows))		
	...
	IF ll_rows > 0 THEN
		...
		f_trace(classname() + ".of_restore_distribution CREATE CONTAINERS  "+ String(ll_rows))
		...
		//DO
		//For ll_rownum = lds_cen_out_md.rowcount( ) to 1 step -1	
		For ll_rownum = 1 to lds_cen_out_md.rowcount( ) 
			...
			f_trace(classname() + ".of_restore_distribution BEFORE uoStowages[" + String(ll_array_count)+ "] = CREATE uo_distribution_container")
			...
			if isvalid(uoStowages[ll_array_count] )	then
				...
				if Mod(ll_array_count, 25) = 0 then
					f_trace(classname() + ".of_restore_distribution ==============================================" )
					f_trace(classname() + ".of_restore_distribution BEFORE SLEEP Garbagecollect " + String(ll_array_count) )
					f_trace(classname() + ".of_restore_distribution ==============================================" )
			...
			f_trace(classname() + ".of_restore_distribution AFTER uoStowages[" + String(ll_array_count)+ "] = CREATE uo_distribution_container")
...
//				if Isvalid (uoStowages[ll_array_count].dsPackinglistSize) then 
//					f_trace(classname() + ".of_restore_distribution uoStowages["+String(ll_array_count)+"].dsPackinglistSize ISVALID TRUE ")
//				Else
//					f_trace(classname() + ".of_restore_distribution uoStowages["+String(ll_array_count)+"].dsPackinglistSize ISVALID FALSE ")
//							
//					DESTROY uoStowages[ll_array_count].dsPackinglistSize		
//					uoStowages[ll_array_count].dsPackinglistSize	= CREATE DataStore
//					uoStowages[ll_array_count].dsPackinglistSize.dataobject = "dw_uo_packinglist_size"
//					
//				End If
//				
//				
//				f_trace(classname() + ".of_restore_distribution BEFORE uoStowages["+String(ll_array_count)+"].dsPackinglistSize.Reset()  "+ String(ll_rows_1))
//				
//				try
//					li_Succ = uoStowages[ll_array_count].dsPackinglistSize.Reset()	
//				catch (exception le_xxx )
//					
//					f_trace(classname() + ".of_restore_distribution uoStowages["+String(ll_array_count)+"].dsPackinglistSize.Reset() FAILED ")
//					f_trace(classname() + ".of_restore_distribution " + le_xxx.text)
//					
//				finally
//					// continue
//				end try
//				
//				f_trace(classname() + ".of_restore_distribution AFTER uoStowages["+String(ll_array_count)+"].dsPackinglistSize.Reset()  "+ String(ll_rows_1))
				
				f_trace(classname() + ".of_restore_distribution SKIP uoStowages["+String(ll_array_count)+"].dsPackinglistSize.Reset()  "+ String(ll_rows_1))
				...
				DO
					...
					f_trace(classname() + ".of_restore_distribution LOOP BEFORE uoStowages["+String(ll_array_count)+"].dsPackinglistSize.InsertRow(0)")

					ll_newrow						=		uoStowages[ll_array_count].dsPackinglistSize.InsertRow(0)					

					f_trace(classname() + ".of_restore_distribution AFTER uoStowages["+String(ll_array_count)+"].dsPackinglistSize.InsertRow(0) " + String(ll_newrow))
				...
				f_trace(classname() + ".of_restore_distribution AFTER LOOP dsPackinglistSize")
			...
			IF ll_rows_2 > 0 THEN
				...
				f_trace(classname() + ".of_restore_distribution SKIP uoStowages["+String(ll_array_count)+"].dsContent.Reset()  "+ String(ll_rows_1))
				
				ll_rownum_1 = 1
				
				f_trace(classname() + ".of_restore_distribution lds_cen_out_md_co  "+ String(ll_rownum_1)+ " / " + String(ll_rows_2))
				...
				DO
					...
					f_trace(classname() + ".of_restore_distribution LOOP uoStowages["+String(ll_array_count)+"].dsContent.InsertRow(0)")
				...
				f_trace(classname() + ".of_restore_distribution AFTER LOOP dsContent " + String(ll_array_count))
		...
		f_trace(classname() + ".of_restore_distribution AFTER LOOP uoStowages " + String(ll_array_count))
...
//	blbSPMLSummary  	= 		lbl_empty		TSC 09.07.2018: SPML-Summary soll nicht mehr als Blob in der DB gespeichert werden
	blbDistributionErrors	= 		lbl_empty

	// Location Sheet .. nicht speichern issue #4015 U 5.72 1006
...
ELSE // IF ls_save_distrtibution = "1" ...
		f_trace(classname() + ".of_restore_distribution RETURN FALSE ")
...
f_trace(classname() + ".of_restore_distribution END  ")
...
If ll_Exception_Rows > 0 Then
	If dsFlight.RowCount() > 0 Then
		...
		ls_Filter += " AND ('" + ls_Departure_Time + "' >= ctime_from AND '" + ls_Departure_Time + "' <= ctime_to)"
				...
				f_trace("of_get_distribution_parameters_by_ac " +  ls_Filter)

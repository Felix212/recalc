HA$PBExportHeader$uo_get_rotation_bkp.sru
$PBExportComments$Userobject zum Ermittlung des Umlaufs (einer Mahlzeit oder einer Extrabeladung)
forward
global type uo_get_rotation_bkp from nonvisualobject
end type
end forward

global type uo_get_rotation_bkp from nonvisualobject
end type
global uo_get_rotation_bkp uo_get_rotation_bkp
...
if this.lDivRest = 0 then 
	...
	//Messagebox("", this.lRotationOffset)
...
if dsRotation.RowCount() = 0 then
	...
	// oder monatlicher(2) dekadischer(3) oder 
	// monatsmitten(4) Apparat ist
	// -------------------------------------------------------
...
on uo_get_rotation_bkp.create
call super::create
TriggerEvent( this, "constructor" )
end on

on uo_get_rotation_bkp.destroy

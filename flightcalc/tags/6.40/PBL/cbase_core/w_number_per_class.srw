HA$PBExportHeader$w_number_per_class.srw
forward
global type w_number_per_class from window
end type
type p_indicator from picture within w_number_per_class
end type
type dw_1 from uo_parent_dw within w_number_per_class
end type
type cb_cancel from commandbutton within w_number_per_class
end type
type cb_ok from commandbutton within w_number_per_class
end type
type st_ok from statictext within w_number_per_class
end type
type st_cancel from statictext within w_number_per_class
end type
end forward
...
global w_number_per_class w_number_per_class

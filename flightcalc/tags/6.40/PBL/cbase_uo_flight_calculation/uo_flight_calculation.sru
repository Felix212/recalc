...
// --------------------------------------------------------------------------------------------------------------------
// 20.10.2025 HR: #12814, 12813 O2C Changes
// --------------------------------------------------------------------------------------------------------------------
integer				ii_spml_not_valid					= 0 
integer				ii_aircraft_not_found				= 0
integer				ii_registration_not_found			= 0
long					il_job_nairline_qp_key
end variables
...
// --------------------------------------------------------------------------------------------------------------------
ii_spml_not_valid				= 0
ii_aircraft_not_found			= 0
ii_registration_not_found		= 0
il_job_nairline_qp_key		= dsJobs.GetItemNumber(lrow, "nairline_qp_key") // 20.10.2025 HR: #12814, 12813 O2C Changes
...
// 20.10.2025 HR: #12814, 12813 O2C Changes
// --------------------------------------------------------------------------------------------------------------------
dsChangeInformation.Setitem(lNewRow, "naircraft_not_found", 			ii_aircraft_not_found )
dsChangeInformation.Setitem(lNewRow, "nregistration_not_found", 		ii_registration_not_found ) 
dsChangeInformation.Setitem(lNewRow, "nspml_not_valid",				ii_spml_not_valid )
dsChangeInformation.Setitem(lNewRow, "nairline_qp_key", 				il_job_nairline_qp_key )

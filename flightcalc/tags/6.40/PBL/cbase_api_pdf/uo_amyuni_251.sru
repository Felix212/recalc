...
function integer DocGetPageCount(long edhDocument, ref integer pageCount) library "cdintf251.dll"
function integer DocSplit(long edhDocument, string prefix) library "cdintf251.dll" alias for "DocSplitA;Ansi"

HA$PBExportHeader$uo_amyuni_450.sru
$PBExportComments$Unterst$$HEX1$$fc00$$ENDHEX$$tzung f$$HEX1$$fc00$$ENDHEX$$r Amyuni PDF Creator Version 4.50
forward
global type uo_amyuni_450 from uo_amyuni
end type
end forward

global type uo_amyuni_450 from uo_amyuni
end type
global uo_amyuni_450 uo_amyuni_450
...
function integer DocAppend(long edhDocument, long edhSource) library "cdintf450.dll" alias for "DocAppend;Ansi"
function integer DocMerge(long edhDocument, long edhSource, boolean fRepeat, boolean fAbove) library "cdintf450.dll" alias for "DocMerge;Ansi"
function integer DocClose(long edhDocument) library "cdintf450.dll" alias for "DocClose;Ansi"
function long DocSetTitle(long edhDocument, string szValue) library "cdintf450.dll" alias for "DocSetTitleA;Ansi"
...
function integer DocGetPageCount(long edhDocument, ref integer pageCount) library "cdintf450.dll"
function integer DocSplit(long edhDocument, string prefix) library "cdintf450.dll" alias for "DocSplitA;Ansi"
//function integer DocOptimize(long edhDocument, integer iLevel) library "cdintf450.dll" alias for "DocOptimize;Ansi"
//function long BatchConvertEx(long hPrinter, string szFileName) library "cdintf450.dll" alias for "BatchConvertEx;Ansi"

subroutine DriverEnd(long hPrinter) library "cdintf450.dll" alias for "DriverEnd;Ansi"
subroutine GetLastErrorMsg(ref string Msg, long MaxMsg) library "cdintf450.dll" alias for "GetLastErrorMsg;Ansi"
...
on uo_amyuni_450.create
call super::create
end on

on uo_amyuni_450.destroy
call super::destroy
end on
...
is_PDFCreatorOLE = "PDFCreactiveX.PDFCreactiveX.4.5"

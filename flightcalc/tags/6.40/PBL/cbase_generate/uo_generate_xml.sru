...
type variables
	...
	Boolean						bGGSkyscopeFlight 	= false // 15.04.2020 HR:
...
public function string of_get_xml_packinglist (string arg_packinglist)
end prototypes
...
// -----------------------------------------------------	
	...
	For i = 1 to dsCenOutSPML.Rowcount()
		...
		For j = 1 to dsCenOutSPMLDetail.Rowcount()
			...
			of_create_xml_string("<SpmlType>",sSpmlType,"</SpmlType>")
			// 15.04.2020 HR:
			of_create_xml_string("<ItemListNumber>",of_get_xml_packinglist(dsCenOutSPMLDetail.Getitemstring(j,"cpackinglist")),"</ItemListNumber>")
...
//			of_create_xml_string("<CalcToPax>",of_get_ratiolist_topax(dsCenOutSPMLDetail.GetitemNumber(j,"ncalc_detail_key")),"</CalcToPax>")
		...
		if bCreateDaVinciInterface then
			...
			//Schl$$HEX1$$fc00$$ENDHEX$$sselnummer	Char	18	5323701	
			// 15.04.2020 HR:
			of_create_davinci_string(of_get_xml_packinglist(dsCenOutSPMLDetail.Getitemstring(j,"cpackinglist")),18,sSeparator)
			//Schl$$HEX1$$fc00$$ENDHEX$$sselnummer-Bezeichnung	Char	40	Emmentaler K$$HEX1$$e400$$ENDHEX$$se	
...
// -----------------------------------------------------	
	...
	For i = 1 to dsCenOutExtra.Rowcount()
		...
		of_create_xml_string("<Item>",sNull,sNull)
		// 15.04.2020 HR:
		of_create_xml_string("<ItemListNumber>",of_get_xml_packinglist(dsCenOutExtra.Getitemstring(i,"cpackinglist")),"</ItemListNumber>")
		...
		if bCreateDaVinciInterface then
			...
			//Schl$$HEX1$$fc00$$ENDHEX$$sselnummer	Char	18	5323701	
			// 15.04.2020 HR:
			of_create_davinci_string(of_get_xml_packinglist(dsCenOutExtra.Getitemstring(i,"cpackinglist")),18,sSeparator)
			//Schl$$HEX1$$fc00$$ENDHEX$$sselnummer-Bezeichnung	Char	40	Emmentaler K$$HEX1$$e400$$ENDHEX$$se	
...
// -----------------------------------------------------	
	...
	For i = 1 to dsCenOutMeals.Rowcount()
		...
		of_create_xml_string("<Item>",sNull,sNull)
		// 15.04.2020 HR:
		of_create_xml_string("<ItemListNumber>",of_get_xml_packinglist(dsCenOutMeals.Getitemstring(i,"cpackinglist")),"</ItemListNumber>")
		...
		if bCreateDaVinciInterface then
			...
			//Schl$$HEX1$$fc00$$ENDHEX$$sselnummer	Char	18	5323701	
			// 15.04.2020 HR:
			of_create_davinci_string(of_get_xml_packinglist(dsCenOutMeals.Getitemstring(i,"cpackinglist")),18,sSeparator)
			//Schl$$HEX1$$fc00$$ENDHEX$$sselnummer-Bezeichnung	Char	40	Emmentaler K$$HEX1$$e400$$ENDHEX$$se	
...
// -----------------------------------------------------	
	...
	For i = 1 to dsCenOutAddDelivery.Rowcount()
		...
		of_create_xml_string("<Item>",sNull,sNull)
		// 15.04.2020 HR:
		of_create_xml_string("<ItemListNumber>",of_get_xml_packinglist(dsCenOutAddDelivery.Getitemstring(i,"cpackinglist")),"</ItemListNumber>")
...
/*  TLE_20012009 Umstellung auf Bedingung statt Filter, da Filter neuen retrieve macht - Anfang - 
	...
	*/ 
	...
	For i = 1 to dsCenOutPeriodDetail.Rowcount()
		...
		of_create_xml_string("<Item>",sNull,sNull)
		// 15.04.2020 HR:
		of_create_xml_string("<ItemListNumber>",of_get_xml_packinglist(dsCenOutPeriodDetail.Getitemstring(i,"cpackinglist")),"</ItemListNumber>")
		...
		if bCreateDaVinciInterface then
			...
			//Schl$$HEX1$$fc00$$ENDHEX$$sselnummer	Char	18	5323701	
			// 15.04.2020 HR:
			of_create_davinci_string(of_get_xml_packinglist(dsCenOutPeriodDetail.Getitemstring(i,"cpackinglist")),18,sSeparator)
			//Schl$$HEX1$$fc00$$ENDHEX$$sselnummer-Bezeichnung	Char	40	Emmentaler K$$HEX1$$e400$$ENDHEX$$se	
...
public function string of_get_xml_packinglist (string arg_packinglist);// --------------------------------------------------------------------------------------------------------------------
// Objekt : uo_generate_xml
// Methode: of_get_xml_packinglist (Function)
// Autor  : Heiko Rothenbach
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):
// string arg_packinglist
// --------------------------------------------------------------------------------------------------------------------
// Return: string
// --------------------------------------------------------------------------------------------------------------------
//  Beschreibung: Wir ben$$HEX1$$f600$$ENDHEX$$tigen die SL bei Skyscope-Gate-Betrieben ohne die Supplier-Nr
// --------------------------------------------------------------------------------------------------------------------
//  Modifikationen:
//  Datum       Version  Autor          Kommentar
// --------------------------------------------------------------------------------------------------------------------
//  15.04.2020	   1.0      H.Rothenbach   Erstellung
//
// --------------------------------------------------------------------------------------------------------------------

if bGGSkyscopeFlight then
	if mid(arg_packinglist, 5, 1) = "_" then
		return mid(arg_packinglist, 6)
	else
		return arg_packinglist
	end if
else
	return arg_packinglist
end if

...
$PBExportComments$Zip-Funktionalit$$HEX1$$e400$$ENDHEX$$ten
forward
...
if iRet = 0 then
	iRet = ole_zip.ConnectToNewObject("XceedSoftware.XceedZip.4")
	if iRet <> 0 then
		isLastError = "Couldn't connect to object XceedSoftware.XceedZip.4. Error code " + String(iRet)
	end if
end if

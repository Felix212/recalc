...
FOR ll_row = 1 TO ll_rowcount_details
	...
	ELSE
		...
		ldw_work.SetItem(ll_row_work, "ninput_from_top_off", lds_details.GetItemNumber(ll_row, "ninput_from_top_off"))
		ldw_work.SetItem(ll_row_work, "nquantity_mis", 0)
	END IF
NEXT
...
//return wf_regenerate_paclos(ld_return, ls_Airline, ll_FlightNumber, ls_Suffix)                  
...
* Aenderungshistorie:
* 	Version 	Wer					Wann			Was und warum
*	1.0 		Thomas Schaefer	08.08.2015	Erstellung
*
* Return Codes:
*	 ...
*/
...
IF ll_count >0 THEN
	f_Log2Csv(0,1,"[of_process_freeze] Flug wurde eingefroren")
	this.sreturn_error_message = ": Successful freeze for Flight ${" + this.sFlightText + "} !"
	this.sreturn_error_message_short = "Successful freeze for Flight!"
	this.is_web_message = uf.translate("Flug wurde eingefroren")
...
ELSE
	...
	f_Log2Csv(0,1,"[of_process_freeze] " + ls_msg)
	this.sreturn_error_message = ": Keine FREEZE-Daten f$$HEX1$$fc00$$ENDHEX$$r Flug ${" + this.sFlightText + "} !"
	this.sreturn_error_message_short = "Keine FREEZE-Daten f$$HEX1$$fc00$$ENDHEX$$r Flug!"
	this.is_web_message = uf.translate("Keine FREEZE-Daten f$$HEX1$$fc00$$ENDHEX$$r Flug")
	of_log_jobstate(ii_log_warning, this.is_web_message)
END IF

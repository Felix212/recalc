...
public function integer uf_loc2utc (string arg_tlc, date arg_date, string arg_time, ref decimal arg_offset);datetime 	ldt1, ldt2, ldt_start, ldt_stop 
...
public function integer uf_utc2loc (string arg_tlc, date arg_date, string arg_time, ref decimal arg_offset);datetime 	ldt1, ldt2, ldt_start, ldt_stop 
long			ll_timezone_key
decimal		ld_gmt

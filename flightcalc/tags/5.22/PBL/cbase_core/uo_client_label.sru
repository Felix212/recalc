...
// -----------------------------------------
iFile = FileOpen(f_gettemppath() + is_log_prefix + "cbase_label.log", LineMode!, Write!, Shared!)
...
// 13.04.2016 HR:
uoDistribution.is_log_prefix = this.is_log_prefix
...
// 14.04.2016 HR:
// --------------------------------------------------------------------------------------------------------------------
luo_diagram.is_log_prefix = this.is_log_prefix 
luo_diagram.ib_use_doc_gen_settings = this.ib_use_doc_gen_settings  
luo_diagram.inv_doc_gen_settings = this.inv_doc_gen_settings 
...
li_Succ = rauo_cart_diagram.of_draw_tr_content_drawer(llIndexKey,  llDetailKey,  ll_Cart_Row, ll_Column, 1, lb_Explode, as_unit, ls_Distribution_Items, ls_Suppressed_Items,ls_Stowage )

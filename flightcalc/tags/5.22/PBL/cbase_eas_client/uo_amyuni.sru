...
function integer DocAppend(long edhDocument, long edhSource) library "cdintf500.dll"
function integer DocMerge(long edhDocument, long edhSource, boolean fRepeat, boolean fAbove) library "cdintf500.dll"
function integer DocClose(long edhDocument) library "cdintf500.dll"
//function integer DocOptimize(long edhDocument, integer iLevel) library "cdintf500.dll"
...
subroutine DriverEnd(long hPrinter) library "cdintf500.dll"
subroutine GetLastErrorMsg(ref string Msg, long MaxMsg) library "cdintf500.dll"

//int DocSetTitleA(EXTDOCHANDLE edhDocument, LPCSTR szValue)
function long DocSetTitleA(long edhDocument, string szValue) library "cdintf500.dll" alias for "DocSetTitleA;Ansi"
...
//	string as_title
//
// Beschreibung:		Document Title im PDF setzen
//
// Aenderungshistorie:
// Version 		Wer			Wann			Was und warum
...
li_ret = DocSetTitleA( ll_DocHandle, as_title)

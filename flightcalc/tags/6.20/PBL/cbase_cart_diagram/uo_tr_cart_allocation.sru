...
public function integer of_fit_into_cart (integer ai_content_height, integer ai_fill_order, long al_content, long al_tr_cart_key, long al_galley_group, string as_stowage)
public function integer of_add_content (long al_index_key, long al_detail_key, integer ai_fill_order, boolean ab_force_new_cart, long al_source_row, long al_galley_group, string as_stowage)
end prototypes

HA$PBExportHeader$w_report_printer_setting.srw
forward
global type w_report_printer_setting from window
end type
type ddlb_range from dropdownlistbox within w_report_printer_setting
end type
type st_444 from statictext within w_report_printer_setting
end type
type em_copies from editmask within w_report_printer_setting
end type
type st_44 from statictext within w_report_printer_setting
end type
type st_4 from statictext within w_report_printer_setting
end type
type ddlb_printers from dropdownlistbox within w_report_printer_setting
end type
type cb_ok from commandbutton within w_report_printer_setting
end type
type cb_cancel from commandbutton within w_report_printer_setting
end type
type sle_pages from singlelineedit within w_report_printer_setting
end type
type st_3 from statictext within w_report_printer_setting
end type
type st_2 from statictext within w_report_printer_setting
end type
type st_1 from statictext within w_report_printer_setting
end type
type rb_3 from radiobutton within w_report_printer_setting
end type
type rb_2 from radiobutton within w_report_printer_setting
end type
type rb_1 from radiobutton within w_report_printer_setting
end type
type gb_1 from groupbox within w_report_printer_setting
end type
type st_5 from statictext within w_report_printer_setting
end type
type st_55 from statictext within w_report_printer_setting
end type
end forward
...
global w_report_printer_setting w_report_printer_setting
...
on w_report_printer_setting.create
...
on w_report_printer_setting.destroy
...
f_set_printer(ddlb_printers.text)
...
strPrint.oDw.Modify("datawindow.print.copies=" + string(lCopies))
strPrint.oDw.Modify("datawindow.printer='" + ddlb_printers.text + "'")
// ------------------------------------------------------------------------
// Alle / gerade / ungerade
// ------------------------------------------------------------------------
if lPos = 0 or lPos = 1 or lPos = 2 then
	strPrint.oDw.Modify("datawindow.print.page.rangeinclude=" + string(lPos))
else
	strPrint.oDw.Modify("datawindow.print.page.rangeinclude=" + string(0))
end if
...
if rb_1.checked then // Alles
	strPrint.oDw.Modify("datawindow.print.page.range=''")
	
elseif rb_2.checked then // Aktuelle Seite
	strPrint.oDw.Modify("datawindow.print.page.range='" + string(strPrint.lCurrentPage) + "'")
	
elseif rb_3.checked then // Seitenbereich
	strPrint.oDw.Modify("datawindow.print.page.range='" + sle_pages.text + "'")
end if

strPrint.oDw.Print()

f_set_printer(s_app.sDefaultPrinter)
...
event clicked;sle_pages.SetFocus()
end event

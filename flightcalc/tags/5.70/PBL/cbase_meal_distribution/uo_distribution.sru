...
ls_file_add = "_"+string(today(), "yyyy-mm-dd")
iFile = FileOpen(this.sLogPath + "cbase_distribution"+ ls_file_add +".log", LineMode!, Write!, Shared!)
...
if this.dsDistributingMeals.RowCount() = 0 then
	...
	if this.dsMeals.RowCount() > 0  then
		...
		this.of_log("nresult_key's = " + ls_out)

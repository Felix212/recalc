...
For i = 1 to lRowcount
	...
	// --------------------------------------------------------------------------------------------------------------------
	guoLog.uf_allways("["+ this.classname( )+".of_generate_handling_objects] "+ ls_rowcount + sAirline + " "+string(lFlightNumber, "0000")+sSuffix+" "+sTLCFrom+"-"+sTLCTo + " ["+string(lResultKey)+"]")

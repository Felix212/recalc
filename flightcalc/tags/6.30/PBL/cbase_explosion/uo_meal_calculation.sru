...
for i = 1 to dsHandlingMealCover.RowCount()
	...
	if dsCenMeals.RowCount() > 0 then
		...
		//CR 3428 new override instead of 2 old overrides
...
//		end if
		...
		// 06.11.2018 HR: #2285 Wir m$$HEX1$$fc00$$ENDHEX$$ssen die Zahlen immer ermitteln, auch beim Wechsel
		//else
...
// --------------------------------------------------------------------------------------------------------------------
//Choose Case lCalcID
//	case 1, 4, 5, 6, 7, 9, 10, 11, 12, 13, 21, 22, 95, 106, 113
//		uf_get_flight_parm_diff ( lHandlingDetailKey, il_flgnr, is_suffix, iPercentage, dcValue, lMinValue, lMaxValue)
//End Choose
...
// --------------------------------------------------------------------------------------------------------------------
	Choose Case lCalcID
		//case 3, 24, 84, 98, 67, 65, 76, 14, 20, 78 
		// ALTE Liste plus neue Eintr$$HEX1$$e400$$ENDHEX$$ge....
		//case 1, 4, 5, 6, 7, 9, 10, 11, 12, 13, 21, 22, 95, 106, 113, 3, 24, 84, 98, 67, 65, 76, 14, 20, 78
		// 07.03.2019 #4696 aktualisierte Liste von VH
...
guoLog.uf_allways( "["+ this.classname( )+".uf_retrieve_local_subst] Rows in idsLocalEuSubst: "+string(idsLocalEuSubst.rowcount()))
 Lokale Ersetzung f$$HEX1$$fc00$$ENDHEX$$r EU-Labeling wieder raus */

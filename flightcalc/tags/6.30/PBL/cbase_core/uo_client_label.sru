...
// -----------------------------------------------------------
// CR 2575 kein Filter (Booksmarks f$$HEX1$$fc00$$ENDHEX$$r nachtr$$HEX1$$e400$$ENDHEX$$glichen Filter)
// -----------------------------------------------------------
//If ib_Cart_Diagram_Bookmark Then
//	as_Labelfilter = ""
//	f_trace("uo_ClientLabel.of_cartdiagram_sheet Add Bookmarks => no label filter!")
//End If
	...
	Else
		...
		If ib_extended_tr_handling Then
			...
			For ll_Count = 1 To dsCartdiagramSheet.RowCount()
				...
				ll_key = luo_cart_diagram.of_get_tr_cart_key(as_unit, ll_Temp, dDeparture , ll_number_of_rungs, ll_number_of_columns, ll_number_of_pages)
		...
		For ll_Row = 1 to This.dsCartdiagramSheet.Rowcount()
			...
			li_Succ = of_create_tr_cartidagram_main(ll_row, luo_cart_diagram, ll_airline_key , ls_unit ,ls_dep_time, ll_routing_id, &
																...
																lds_Unassigned	, ls_loadinglists)
...
//	rads_unassigned.Setitem(ll_unassigned_row, "cpackinglist", dsCartdiagramSheet.GetItemString(al_Row, "cpackinglist"))
//	rads_unassigned.Setitem(ll_unassigned_row, "ctext", dsCartdiagramSheet.GetItemString(al_Row, "ctext"))
//	rads_unassigned.Setitem(ll_unassigned_row, "cstowage", dsCartdiagramSheet.GetItemString(al_Row, "cstowage"))
//
//End If


ll_key = rauo_cart_diagram.of_get_tr_cart_key(as_unit, llIndexKey, dDeparture , ll_number_of_rungs, ll_number_of_columns, ll_number_of_pages)
...
//		li_Succ = rauo_cart_diagram.of_draw_additional_text( rauo_cart_diagram.is_TR_Freetext, "")
...
if dsWorkstations.RowCount() > 0 then
	...
	For ll_row = 1 to dsLoading.RowCount()
		...
		if dsWorkstations.RowCount() > 0 then
			// ll_Print = dsWorkstations.GetItemNumber(1, "nlabel_print")  

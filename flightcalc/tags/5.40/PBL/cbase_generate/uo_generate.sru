...
public function integer of_create_checkpts (datastore arg_cen_out, datastore arg_chkpts)
...
public function boolean of_generate_checkpts ();datastore 	lds_chkpt
integer  		liRet
long 			lSQLCode, lSQLRow
string 		sSQLErrorText

...
event constructor;integer i, j, k, li_width = 420
...
do
	...
	if j > 0 then
		...
		this.modify("nfunction"+string(i)+"_t.x = "+string(453 + k * (li_width + 18)))
		this.modify("nfunction"+string(i)+"_t.width = "+string(li_width))
		this.modify("nfunction"+string(i)+".x = "+string(453 + k * (li_width + 18)))
...
this.modify("r_24.width = "+string(453 + k * (li_width + 18)))
this.retrieve()

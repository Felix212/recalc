...
ib_SLReplaceForACType = (uf_cen_profilestring('MealCalculation','SLReplaceForACType',"1") = "1")
if not ib_SLReplaceForACType then
	uf_trace(0, "uf_compile(): SLReplaceForACType is set to FALSE")
end if

HA$PBExportHeader$uo_tree_verticalscroll_old.sru
forward
global type uo_tree_verticalscroll_old from vscrollbar
end type
end forward
...
global uo_tree_verticalscroll_old uo_tree_verticalscroll_old
...
//		if dwParent.RowCount() <= lLast then
//			this.lPages = 1
//		else
//			this.lPages = dwParent.RowCount() / lLast
//			this.lPages = this.lPages - 1
//		end if

		//messagebox("lPages", this.lPAges)
		//dwParent.SetDetailHeight(1, dwParent.RowCount() , dwParent.lDetailHeight)
		//messagebox("", dwParent.GetItemNumber(1, "c_pagecounter"))
		//messagebox("", this.lPages)
		//messagebox("", dwParent.GetItemNumber(1, "c_pagecounter"))
...
on uo_tree_verticalscroll_old.create
end on

on uo_tree_verticalscroll_old.destroy
end on

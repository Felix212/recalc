HA$PBExportHeader$uo_tree_datawindow.sru
forward
global type uo_tree_datawindow from uo_parent_dw
end type
end forward
...
global uo_tree_datawindow uo_tree_datawindow
...
on uo_tree_datawindow.create
call super::create
end on

on uo_tree_datawindow.destroy
call super::destroy
end on
...
m_context_tree_datawindow NewMenu

NewMenu = create m_context_tree_datawindow

NewMenu.MyTree = this

if this.iMultiSelection = 1 then
	NewMenu.m_start.m_-0.Visible = true
	NewMenu.m_start.m_allemarkieren.Visible = true
else
	NewMenu.m_start.m_-0.Visible = False
	NewMenu.m_start.m_allemarkieren.Visible = False
end if
...
NewMenu.m_start.PopMenu(w_mdi_master.PointerX(), w_mdi_master.PointerY())
end event

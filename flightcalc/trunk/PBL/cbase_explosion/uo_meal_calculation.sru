...
If ll_Override_Rows > 0 Then
	...
	lSPMLPLDetailKey			= ids_spmlreplace.GetItemNumber(1,"npackinglist_detail_key") // 04.07.2025 HR: Richtige G$$HEX1$$fc00$$ENDHEX$$ltigkeit der PL auch beim Ersetzen der SL setzen

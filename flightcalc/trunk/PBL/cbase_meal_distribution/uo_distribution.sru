...
// -----------------------------------------------------------
Boolean				bNewDistributionAssignment = FALSE

long lRoleID = 1000034
...
public function boolean of_restore_distr_old ()
public function integer of_create_spml_sheet ()
end prototypes
...
/*
// 24.01.2020 HR: Dateinamen um Datum und Instanznamen erweitert
iFile = FileOpen(this.sLogPath + "cbase_distribution_" + gs_instance_name + "_" + string(today(), "yyyy-mm-dd")+".log", LineMode!, Write!, Shared!)
...
if (this.iAccumulateSPML = 1 or this.iAccumulateSPMLType = 1) and iType = 3 then
	guoLog.uf_debug( "["+ this.classname( )+".of_distribution] SPML accumulation is activated!!!!")
...
For lRow = 1 to this.dsControl.RowCount()
	...
	if dsContents.RowCount() = 0 then
		// Um$$HEX1$$f600$$ENDHEX$$glich
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution] NO RECORDS for[" + string(iType) + "]: " + sFilter) 
		continue
	end if
	...
	// ---------------------------------------------
	if UpperBound(uoTemp) = 0 then
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution] PRESELECT -> NO STOWAGES with the proper parameters found: Class = " + sClass + " PL-Type: " + sPlType + "/" + string(lPLType) + " MealControlCode: " + sMealControlCode )
		if dsContents.RowsMove(1, dsContents.RowCount(), Primary!,  this.dsDistributionErrors, this.dsDistributionErrors.RowCount() + 1, Primary!) <> 1 then
			guoLog.uf_error( "["+ this.classname( )+".of_distribution] ERROR Rowscopy to ErrorList failed!")
		end if
		continue
	end if
	...
	if dsDistribution.RowCount() <> Upperbound(uoTemp) then
		guoLog.uf_error( "["+ this.classname( )+".of_distribution] ERROR unequal number of rows: dsDistribution = " + string(dsDistribution.RowCount()) + " Array = " + String(UpperBound(uoTemp)))
	end if
	...
	For a = 1 to UpperBound(uoTemp)
		...
		if not bFoundRoutine then
			...
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution] Found Routine: " + String(lParameters) )
		end if
				
	Next
	
	guoLog.uf_debug( "["+ this.classname( )+".of_distribution] Routine(s) found: "  + String(UpperBound(lDistributionRoutines)))
	...
	For lDistributionRoutine = 1 to UpperBound(lDistributionRoutines)
		...
		if strParams.iStatus = -1 then 
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution] ERROR no Distribution Parameters for Routine: " + string(lDistributionRoutines[lDistributionRoutine]) + " -  Class: " +  sClass + " PlType: " + sPlType + " DistributionCode: " + sMealControlCode + " SPML: " + String(lSPML))
									
			if dsContents.RowsMove(1, dsContents.RowCount(), Primary!,  this.dsDistributionErrors, this.dsDistributionErrors.RowCount() + 1, Primary!) <> 1 then
				guoLog.uf_debug( "["+ this.classname( )+".of_distribution] ERROR Rowscopy (Distribution Parameters) to ErrorList failed!")
			end if

			continue			
			
		else
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution] --------------------------------------------------------------------------------------------------------------")
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution] Distribution Parameters for Class: " +  sClass + " PlType: " + sPlType + " DistributionCode: " + sMealControlCode + " SPML: " + String(lSPML))
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution] Using Parameters: " + strParams.sName)
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution]            Class: " + strParams.sClass)
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution]          PL-Type: " + String(strParams.lPlType))
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution] DistributionCode: " + sMealcontrolcode)
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution]        Direction: " + String(strParams.lDirection))
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution]         Absolute: " + String(strParams.lAbsolute))
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution]        Splitting: " + String(strParams.lSplitting))
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution]        Alternate: " + String(strParams.lAlternate))
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution] --------------------------------------------------------------------------------------------------------------")
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution]              MCD: " + String(this.iMCD))
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution]            Mixed: " + String(this.iMixed))
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution] --------------------------------------------------------------------------------------------------------------")
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution]    AccumulateSPML: " + String(this.iAccumulateSPML))
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution]    AccumulateSPMLType : " + String(this.iAccumulateSPMLType))  // 24.04.2013 HR:
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution]       ExplodeSPML: " + String(this.iExplodeSPML))
			guoLog.uf_debug( "["+ this.classname( )+".of_distribution] --------------------------------------------------------------------------------------------------------------")
		...
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution] --------------------------------------------------------------------------------------------------------------")
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution]  ++++ Sortierung vorher ++++ ")
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution] --------------------------------------------------------------------------------------------------------------")
		...
		// ------------------------------------------------------------------------------------------
		// Beh$$HEX1$$e400$$ENDHEX$$ltnispriorit$$HEX1$$e400$$ENDHEX$$t of_unit_priority
		// ------------------------------------------------------------------------------------------
		...
		// ------------------------------------------------------------------------------------------
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution] --------------------------------------------------------------------------------------------------------------")
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution]  ++++ Sortierung nachher ++++ ")
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution] --------------------------------------------------------------------------------------------------------------")
		this.of_dump_stowage_sort()
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution] --------------------------------------------------------------------------------------------------------------")
		...
		if strParams.lAbsolute = 1 and strParams.lSplitting = 0 then
			...
			if UpperBound(uoAbsolute) > 0 then
				...
				guoLog.uf_debug( "["+ this.classname( )+".of_distribution] FINALSELECTION ABSOLUTE -> NO STOWAGES with the proper parameters found: Class = " + sClass + " PL-Type: " + sPlType + "/" + string(lPLType) + " MealControlCode: " + sMealControlCode )
		...
		elseif strParams.lAlternate = 1 then
			...
			if UpperBound(uoAbsolute) > 0 then
				...
				guoLog.uf_debug( "["+ this.classname( )+".of_distribution] FINALSELECTION ALTERNATE -> NO STOWAGES with the proper parameters found: Class = " + sClass + " PL-Type: " + sPlType + "/" + string(lPLType) + " MealControlCode: " + sMealControlCode )
		...
		elseif strParams.lSplitting = 1 and iType <> 3 then
			...
			For I = 1 to UpperBound(lRankings)
				...
				if strParams.lAbsolute = 1 then
					...
					// --------------------------------------------------------
					guoLog.uf_debug( "["+ this.classname( )+".of_distribution] --------------------------------------------- ")
					guoLog.uf_debug( "["+ this.classname( )+".of_distribution] starting splitting absolute")
					guoLog.uf_debug( "["+ this.classname( )+".of_distribution] --------------------------------------------- ")
					...
					for k = lLastComponent to lLastComponent
						...
						if dsAbsoluteSplitting.RowCount() = 1 then
							...
							guoLog.uf_debug( "["+ this.classname( )+".of_distribution] Remaining quantity after split = " + string(lQuantity))

							if lQuantity > 0 then
								guoLog.uf_debug( "["+ this.classname( )+".of_distribution] Quantity " + string(lQuantity) + " set to dsContents")
								dsContents.SetItem(k, "nquantity", lQuantity)
							else
								guoLog.uf_debug( "["+ this.classname( )+".of_distribution] Quantity set to zero")
								dsContents.SetItem(k, "nquantity", 0)
							end if 
							
						else
							
							guoLog.uf_debug( "["+ this.classname( )+".of_distribution] Contents missing, quantity set to zero")
							dsContents.SetItem(k, "nquantity", 0)
...
if  iType = 3 then
	if this.iAccumulateSPML = 1 and this.iExplodeSPML = 1 then
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution] SPML explosion is activated!!!!")
		this.of_explode_spmls()
	elseif this.iAccumulateSPML = 1 and this.iExplodeSPML = 0 then
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution] SPML combining is activated!!!!")
		this.of_combine_spmls()
	elseif this.iAccumulateSPMLType = 1 then
		guoLog.uf_debug( "["+ this.classname( )+".of_distribution] SPML-Type combining is activated!!!!")
...
lEnde = CPU()
guoLog.uf_debug("["+ this.classname( )+".of_add_classnumbers] (" + string(iType) + ") took " + string((lEnde - lStart)/1000, "0.00") + " seconds!")
...
If bnewdistributionassignment Then
	// ---------------------------------------------------------------------------------------------
...
Destroy(dsTemp)
lEnde 		= CPU()
guoLog.uf_debug( "["+ this.classname( )+".of_load_components] (" + string(iType) + ") took " + string((lEnde - lStart) / 1000, "0.00") + " seconds!")
...
guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] ---------------------------------------------------")
guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] Unique StowageGroupArray contains " + String(Upperbound(sStowageGroups)) + " groups")
guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] ---------------------------------------------------")
For i = 1 to Upperbound(sStowageGroups)
	guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] " + String(i, "00") + " -> " + sStowageGroups[i])
Next	
guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] ---------------------------------------------------")
...
for lRow = 1 to this.dsLoadingList.RowCount()
	...
	For lSizes = 1 to this.dsPackinglistSizeFind.RowCount()
		...
		if lNextLeg = 0 then
			...
			if lSeparate = 1 then
				...
				guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] ------------------------------------------------------------------------------------------------------------------------------------------------------------")
				guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] " +ls_stowage +" is a multileg stowage with reserved space, item list " + spackinglist + " is assigned,  height of " + string(ll_initial_width) + " will be devided by " + string(len(ls_legs)))
					
				if ll_initial_width <> ll_sum_devided_width then
					guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] Rounding issue found!")
					guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] Initial width was " + string(ll_initial_width))
					guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] Sum up after leg splitting is  " + string(ll_sum_devided_width))
				end if 
				...
				guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] " +ls_stowage +" is a multileg stowage,  item list " + spackinglist + " is assigned")
				...
				for ll_counter = 1 to Upperbound(ll_catering_legs)
					...
					if ll_catering_legs[ll_counter] > 0 then
						...
						guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] " + ls_stowage +" - " + ls_meal_control_codes[ll_counter] + " will be " + ls_temp )
	...
	if this.dsPackinglistSizeFind.RowCount() > 0 then
		...
		guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] Stowage " + String(lCount) + " Class " + of_checknull(this.dsLoadingList.GetItemString(lRow, "cclass1")))
		guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] Stowage " + String(lCount) + " Class " + of_checknull(this.dsLoadingList.GetItemString(lRow, "cclass2")))
		guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] Stowage " + String(lCount) + " Class " + of_checknull(this.dsLoadingList.GetItemString(lRow, "cclass3")))
		...
		if lFoundStowage > 0 then
			...
			guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] [" + this.uoStowages[lCount].sStowage	+ "] is assigned to stowage group [" + sStowageGroup + "]")
...
lEndePart = CPU()
guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] Creating StowageObjects took " + string((lEndePart - lStartPart) / 1000, "0.00") + " seconds.")
...
for lRow = 1 to this.dsMeals.RowCount()
	...
	if not isnull(this.dsMeals.GetItemNumber(lRow, "npltype_key")) then
		...
		guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] " + sPackinglist + "- ErrorCode:" + string(sqlca.sqlcode) + " Errormessage: " + string(sqlca.sqlcode))
...
lEndePart = CPU()
guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] Adding height and depth to Meals took " + string((lEndePart - lStartPart) / 1000, "0.00") + " seconds.")
...
lEndePart = CPU()
guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] Adding height and depth to Additional Loading took " + string((lEndePart - lStartPart) / 1000, "0.00") + " seconds.")
...
lEndePart = CPU()
guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] Adding height and depth to SPML's took " + string((lEndePart - lStartPart) / 1000, "0.00") + " seconds.")
this.dsMeals.Sort()
this.dsAdditional.Sort()
this.dsSPMLDistribution.Sort()

lEnde = CPU()
guoLog.uf_debug( "["+ this.classname( )+".of_get_dimensions] of_get_dimensions() took " + string((lEnde - lStart) / 1000, "0.00") + " seconds.")
Destroy(dsPackinglistSizeTemp)
return 0
...
guoLog.uf_allways("["+ this.classname( )+".of_clone] START")
...
guoLog.uf_debug("["+ this.classname( )+".of_clone] BEFORE DS SetFilter")
...
guoLog.uf_debug("["+ this.classname( )+".of_clone] AFTER DS ROWSCOPY")

ll_Count = UpperBound(this.uoStowages)
guoLog.uf_debug("["+ this.classname( )+".of_clone] UpperBound(this.uoStowages " + String(ll_Count))

// ---------------------------------------------------------
// Die Stauorte
// ---------------------------------------------------------
for i = 1 to UpperBound(this.uoStowages)
	guoLog.uf_debug("["+ this.classname( )+".of_clone] LOOP Stowages " + String(i) + " / " + String(ll_Count))
	...
	guoLog.uf_debug("["+ this.classname( )+".of_clone] LOOP Stowages BEFORE dsPackinglistSize.RowsCopy " + String(i))
	...
	guoLog.uf_debug("["+ this.classname( )+".of_clone] LOOP Stowages BEFORE dsContent.RowsCopy " + String(i))
...
guoLog.uf_allways("["+ this.classname( )+".of_clone] END ")
...
//  21.11.2017	1.10			Oliver H$$HEX1$$f600$$ENDHEX$$fer   		Distribution st$$HEX1$$fc00$$ENDHEX$$rzt ab, wenn nicht der Dokumentenbrowser ge$$HEX1$$f600$$ENDHEX$$ffnet ist
//  08.11.2018	1.20			Oliver H$$HEX1$$f600$$ENDHEX$$fer   		Issue #4015 U 5.72 1006 "Location Sheet is not created after SPML Sheet"
// -----------------------------------------------------------------------------------------------------------------------------------------
...
if this.dsFlight.RowCount() = 0 then
	...
	IF of_restore_distribution() THEN
		...
		guoLog.uf_allways("["+ this.classname( )+".of_run] Distribution took " + string((lEnde - lStart)/1000, "0.00") + " seconds! (1)")
		if this.bSPMLSummary then
			...
			if dsPackinglistTypes.RowCount() = 0 then
				...
				guoLog.uf_error("["+ this.classname( )+".of_run] (2) " +  this.sError)
				return -1
			end if
			// -----------------------------------------------------
			...
			if this.of_get_dimensions() <> 0 then
				guoLog.uf_error("["+ this.classname( )+".of_run] of_get_dimensions() (1): " + this.sError)
			end if
			// ---------------------------------------------------------------
			// Die Legs retrieven
			// ---------------------------------------------------------------
			this.dsLeg.Retrieve(this.lResultKeys)
			of_create_spml_sheet()
		end if	
		
		// -----------------------------------------------------
		// Issue #4015 U 5.72 1006 "Location Sheet is not created after SPML Sheet"
		// Das Location Sheet
		// -----------------------------------------------------
		...
		RETURN 0
	ELSE
		guoLog.uf_allways("["+ this.classname( )+".of_run] Start Distribution ")
...
if this.dsClasses.RowCount() = 0 then
	...
	guoLog.uf_error("["+ this.classname( )+".of_run] (3) " + this.sError )
	return -1
end if
...
if dsPackinglistTypes.RowCount() = 0 then
	this.sError = "No packinglist types defined!"
	guoLog.uf_error("["+ this.classname( )+".of_run] (4) " + this.sError )
	return -1
end if
...
guoLog.uf_debug("["+ this.classname( )+".of_run] Found [" + string(this.dsStowageGroups.RowCount()) + "] stowage group assignments for AircraftKey: " + String(this.lAircraftKey))
...
// 4 = dsLoadingList
// ---------------------------------------------------------------
guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_add_classnumbers()")
...
guoLog.uf_debug("["+ this.classname( )+".of_run] After of_add_classnumbers()")
...
if isnull(dsLoadingList) or dsLoadingList.RowCount() <= 0 then
	...
	guoLog.uf_error("["+ this.classname( )+".of_run] (6) " +  this.sError)
	return -1
else
...
if this.of_get_distribution_parameters() <> 0 then
	guoLog.uf_error("["+ this.classname( )+".of_run] of_get_distribution_parameters(): " +  this.sError)
end if

// -----------------------------------------------------
// Die H$$HEX1$$f600$$ENDHEX$$hen und Tiefen ermitteln
// -----------------------------------------------------
guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_get_dimensions()")
if this.of_get_dimensions() <> 0 then
	guoLog.uf_error("["+ this.classname( )+".of_run] of_get_dimensions() (2): " +  this.sError)
end if

// -----------------------------------------------------
// Klassen l$$HEX1$$f600$$ENDHEX$$schen, wenn MCD Verteilung erfolgen soll
// -----------------------------------------------------
guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_mcd_prepare()")
this.of_mcd_prepare()
...
if this.bManuelDistribution = false then
	...
	// 3 = SPML's
	// -----------------------------------------------------
	guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_distribution() (1)")
	this.of_distribution(3)
	this.of_distribution(1)
	this.of_distribution(2)
	
	guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_to_errorlist() (1)")
	this.of_to_errorlist(1)
	this.of_to_errorlist(2)
	this.of_to_errorlist(3)
	
	guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_distribution_errorlist() (1)")
	...
	if this.iMixed = 1 then
		guoLog.uf_debug("["+ this.classname( )+".of_run] Removing MultiClassFlag (1)")
...
elseif this.bManuelDistribution = true and this.bManuelDistributionOnError = true then
	...
	guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_distribution() (2)")	
	this.of_distribution(3)
	this.of_distribution(1)
	this.of_distribution(2)
	
	guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_to_errorlist() (2)")
	this.of_to_errorlist(1)
	this.of_to_errorlist(2)
	this.of_to_errorlist(3)
	
	guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_distribution_errorlist() (2)")
	this.of_distribution_errorlist()
	...
	// -----------------------------------------------------
	if this.iMixed = 1 then
		guoLog.uf_debug("["+ this.classname( )+".of_run] Removing MultiClassFlag (2)")
		this.of_remove_multiclass_flag()
		this.of_distribution_errorlist()
	end if 
	
	if this.dsDistributionErrors.RowCount() > 0 then
		guoLog.uf_debug("["+ this.classname( )+".of_run] Before w_manual_distribution (1)")
		...
		if not isvalid(strReturn) then
			...
			// ---------------------------------
			guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_to_errorlist() (3)")
			this.of_to_errorlist(1)
			this.of_to_errorlist(2)
			this.of_to_errorlist(3)
		end if
		...
		if not strReturn.bSuccessful  then
			...
			// in die Fehlerliste kopieren
			// ---------------------------------
			guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_to_errorlist() (4)")
			this.of_to_errorlist(1)
			this.of_to_errorlist(2)
			this.of_to_errorlist(3)
			return -1000
			...
			// in die Fehlerliste kopieren
			// ---------------------------------
			guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_to_errorlist() (5)")
			this.of_to_errorlist(1)
			this.of_to_errorlist(2)
			this.of_to_errorlist(3)
...
elseif this.bManuelDistribution = true and this.bManuelDistributionOnError = false then
	guoLog.uf_debug("["+ this.classname( )+".of_run] Before w_manual_distribution (2)")
	...
	if not isvalid(strReturn) then
		...
		// in die Fehlerliste kopieren
		// ---------------------------------
		guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_to_errorlist() (6)")
		this.of_to_errorlist(1)
		this.of_to_errorlist(2)
		this.of_to_errorlist(3)
	end if
	...
	if not strReturn.bSuccessful  then
		...
		// in die Fehlerliste kopieren
		// ---------------------------------
		guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_to_errorlist() (7)")
		this.of_to_errorlist(1)
		this.of_to_errorlist(2)
		this.of_to_errorlist(3)
		return -1000
		...
		// in die Fehlerliste kopieren
		// ---------------------------------
		guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_to_errorlist() (8)")
		this.of_to_errorlist(1)
		this.of_to_errorlist(2)
		this.of_to_errorlist(3)
...
// -----------------------------------------------------
// 21.11.2017 Distribution st$$HEX1$$fc00$$ENDHEX$$rzt ab, wenn nicht Dokumentenbrowser ge$$HEX1$$f600$$ENDHEX$$ffnet ist
...
// -----------------------------------------------------
guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_mcd_complete()")
...
// -----------------------------------------------------
if this.bLocationSheet then
	guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_format_datastore_report()")
	this.of_format_datastore_report(this.dsLocationSheet, "Location Sheet")
	
	guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_get_location_sheet()")
	this.of_get_location_sheet()
...
// SPML Summary
// -----------------------------------------------------
guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_create_spml_sheet()")
of_create_spml_sheet()

// -----------------------------------------------------
// In die Arrays ins dsLoadingList $$HEX1$$fc00$$ENDHEX$$bertragen
// -----------------------------------------------------
guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_add_text_to_label()")
this.of_add_text_to_label()

guoLog.uf_debug("["+ this.classname( )+".of_run] Before of_check_labeltypes()")
...
lEnde = CPU()
guoLog.uf_allways("["+ this.classname( )+".of_run] Distribution took " + string((lEnde - lStart)/1000, "0.00") + " seconds! (2)")
...
// OLD: this.dsLocationSheet.Modify("t_14.text='Bosta " + sClasses + "'")
// 2019-08-01 request #5247 translation needed in header section
ls_BOSTA = uf.translate("Bosta")
this.dsLocationSheet.Modify("t_14.text='" + ls_BOSTA + " " + sClasses + "'")
...
*	1.1 		Thomas Schaefer		27.03.2018	#3266 - alternative Version des SPML-Sheets
*
* Return Codes:
* 	-1 	Fehler
* 	 1	OK
...
Long			ll_plkindkey_ms0
Long			ll_plkindkey
// Auf dem alternativen SPML Sheet sollen nur MS0-Stuecklisten stehen
if bSPMLSummary2 then
	select npl_kind_key into :ll_plkindkey_ms0 from sys_packinglist_kinds where ckind = 'MS0';
end if
	...
	For lRow = 1 to this.uoStowages[i].dsContent.RowCount()
		...
		if this.uoStowages[i].dsContent.GetItemNumber(lRow, "nspml") = 1 then
			...
			if lFound > 0 then
				...
				//  TSC 27.03.2018: SPML-Sheet Version 2 will nur MS0
				if bSPMLSummary2 then
					ls_cpackinglist = this.uoStowages[i].dsContent.GetItemString(lRow, "cpackinglist")
					select npl_kind_key into :ll_plkindkey from cen_packinglist_index where cpackinglist = :ls_cpackinglist;
					if ll_plkindkey <> ll_plkindkey_ms0 then continue
				end if
				//  TSC 27.03.2018: SPML-Sheet Version 2 will kein Service = 3
				if bSPMLSummary2 and Mid(this.uoStowages[i].dsContent.GetItemString(lRow, "cmeal_control_code"), 2, 1) = '3' then continue
...
ll_rowcount = this.dsPackinglistTypes.RowCount()
for lRows = 1 to ll_rowcount
...
guoLog.uf_allways("["+ this.classname( )+".of_explode_spmls] Entering  ......")
...
for lStowages = 1 to Upperbound(this.uoStowages)
	...
	// ------------------------------------------------------------------
	guoLog.uf_debug("["+ this.classname( )+".of_explode_spmls] Stowage: " + this.uoStowages[lStowages].sStowage + " contains " + string(this.uoStowages[lStowages].dsContent.RowCount()) + " SPML's" )
	...
	For I = this.uoStowages[lStowages].dsContent.RowCount() to 1 step -1
		...
		guoLog.uf_debug("["+ this.classname( )+".of_explode_spmls] [" + String(I) + "] - SPML Content " + String(lQuantity) + " x " + sPackinglist)
		...
		if this.dsSPMLDistributionMaster.RowCount() = 0 then
			guoLog.uf_debug("["+ this.classname( )+".of_explode_spmls] [" + String(I) + "] - Found no Details for " + sPlType + "/" + String(lPlType) + " + " + sClass + "/" + string(lClass) + " + " + sMealcontrolCode + "  Height " + String(lHeight)  + " Width " + string(lWidth))
		end if
		...
		for j = 1 to this.dsSPMLDistributionMaster.RowCount()
			...
			guoLog.uf_debug("["+ this.classname( )+".of_explode_spmls] [" + String(I) + "] - Found   " + String(lMovedQuantity) + " x " + sPLMaster)
			...
			if lMovedQuantity <= lQuantity then
				...
				guoLog.uf_debug("["+ this.classname( )+".of_explode_spmls] [1][" + String(I) + "] - Added   " + String(lMovedQuantity) + " x " + sPLMaster)
				
				this.dsSPMLDistributionMaster.SetItem(j, "nquantity", 0)
										
				guoLog.uf_debug("["+ this.classname( )+".of_explode_spmls] [1][" + String(I) + "] - Stowage now Contains: " + string(this.uoStowages[lStowages].dsContent.GetItemNumber(I, "nquantity")) + " SPML's")
			...
			elseif lMovedQuantity > lQuantity then
				...
				guoLog.uf_debug("["+ this.classname( )+".of_explode_spmls] [2][" + String(I) + "] - Added   " + String(lQuantity) + " x " + sPLMaster)
				...
				guoLog.uf_debug("["+ this.classname( )+".of_explode_spmls] [2][" + String(I) + "] - Stowage now Contains: " + string(this.uoStowages[lStowages].dsContent.GetItemNumber(I, "nquantity")) + " SPML's")
				
			else
				guoLog.uf_debug("["+ this.classname( )+".of_explode_spmls] [2][" + String(I) + "] -	ELSE ??  lMovedQuantity=" + String(lMovedQuantity) + " lQuantity=" + String(lQuantity))
			end if
		...
		if this.uoStowages[lStowages].dsContent.GetItemNumber(I, "nquantity") = 0 then 
			guoLog.uf_debug("["+ this.classname( )+".of_explode_spmls] [" + String(I) + "] - Remove " + sPLMaster)
...
For I = this.dsSPMLDistributionMaster.RowCount() to 1 step -1
	if this.dsSPMLDistributionMaster.GetItemNumber(I, "nquantity") = 0 then
		...
		lQuantity = this.dsSPMLDistributionMaster.GetItemNumber(I, "nquantity") 
		guoLog.uf_debug("["+ this.classname( )+".of_explode_spmls] Can't remove " + sPLMaster + " quantity is still " + string(lQuantity))
	end if
Next
...
Else
	// ------------------------------------------------
	// 08.09.217  Issue 2729 Window im Service nicht $$HEX1$$f600$$ENDHEX$$ffnen
	// ------------------------------------------------
...
//  23.05.2018	1.05			Oliver Hoefer  		CR 3604 Flight Data Repository; Merken der Information "MZV beendet"
// -----------------------------------------------------------------------------------------------------------------------------------------
...
//		end if
	...
	IF ll_rows = 0 THEN
		...
		// SPML-Summary ----------------------
//	TSC 09.07.2018: SPML-Summary soll nicht mehr als Blob in der DB gespeichert werden
...
//					lds_cen_out_md_lo.SetItem(ll_found,"ncom_nduplicated",li_ncom_nduplicated)					
	...
	// ------------------------------------------------------
	// Merken der Information "MZV beendet"
	// ------------------------------------------------------
	DECLARE pf_md_finished PROCEDURE FOR cbase_distribution.pf_md_finished(:ll_nresult_key, :ll_ntransaction) USING SQLCA;
	IF  SQLCA.sqlcode <> 0 THEN
		//f_Log2Csv(0,1,"[of_store_distribution] Error DECLAREing Procedure cbase_distribution.pf_md_finished: " + SQLCA.SQLErrText)
		//Return -1
	Else
	
		EXECUTE pf_md_finished;
		IF SQLCA.sqlcode <> 0 AND SQLCA.sqlcode <> 100 THEN
			// ls_msg = "Fehler EXECUTEing cbase_distribution.pf_md_finished(resultkey:"+string(ll_nresult_key)+", transaction:"+string(ll_ntransaction)+"). "+string( SQLCA.sqlcode) +" "+f_check_null(SQLCA.sqlerrtext)
			 //f_Log2Csv(0,1,"[of_store_distribution] " + ls_msg)
			 //Return -1
		Else
			fetch pf_md_finished into :ll_ret;
			if ll_ret < 0 then
					 // nicht noetig, da immer 0 zurueckkommt oder eine exception
			Else
				COMMIT;
			end if
			CLOSE pf_md_finished;
		End if
	End If
	
	
//	DECLARE	lpr_pf_md_finished PROCEDURE FOR cbase_distribution.pf_md_finished(:ll_nresult_key, :ll_ntransaction ) USING SQLCA;	
//	EXECUTE lpr_pf_md_finished;
...
IF ls_save_distrtibution = "1" AND NOT this.bManuelDistribution THEN
	...
	guoLog.uf_allways("["+ this.classname( )+".of_restore_distribution] Restoring Meal Distribution Data ...")
	...
	if ll_rows > 100 then
		guoLog.uf_allways("["+ this.classname( )+".of_restore_distribution] BEFORE INIT CONTAINER "+ String(ll_rows))		

		uoStowages[ll_rows] 								= 		CREATE uo_distribution_container

		f_yield(lRoleID)
		
		guoLog.uf_allways("["+ this.classname( )+".of_restore_distribution] AFTER INIT CONTAINER "+ String(ll_rows))		
	...
	IF ll_rows > 0 THEN
		...
		guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] CREATE CONTAINERS  "+ String(ll_rows))
		
		// Array initialisieren ...
		
		ll_rownum 		= 	1
		
		For ll_rownum = 1 to lds_cen_out_md.rowcount( ) 
			...
			guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] BEFORE uoStowages[" + String(ll_array_count)+ "] = CREATE uo_distribution_container")
			
			uoStowages[ll_array_count] 								= 		CREATE uo_distribution_container

			if isvalid(uoStowages[ll_array_count] )	then
				//f_yield(lRoleID)
				if Mod(ll_array_count, 25) = 0 then
					guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] ==============================================" )
					guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] BEFORE SLEEP Garbagecollect " + String(ll_array_count) )
					guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] ==============================================" )
					lb_Yield = f_yield(lRoleID)
					sleep(2)
					Garbagecollect()
					lb_Yield = f_yield(lRoleID)
			...
			guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] AFTER uoStowages[" + String(ll_array_count)+ "] = CREATE uo_distribution_container")
			...
			IF ll_rows_1 > 0 THEN
				guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] SKIP uoStowages["+String(ll_array_count)+"].dsPackinglistSize.Reset()  "+ String(ll_rows_1))
				...
				DO
					...
					guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] LOOP BEFORE uoStowages["+String(ll_array_count)+"].dsPackinglistSize.InsertRow(0)")

					ll_newrow						=		uoStowages[ll_array_count].dsPackinglistSize.InsertRow(0)					

					guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] AFTER uoStowages["+String(ll_array_count)+"].dsPackinglistSize.InsertRow(0) " + String(ll_newrow))
				...
				guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] AFTER LOOP dsPackinglistSize")
			...
			IF ll_rows_2 > 0 THEN
				...
				//li_Succ = uoStowages[ll_array_count].dsContent.Reset()	
				guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] SKIP uoStowages["+String(ll_array_count)+"].dsContent.Reset()  "+ String(ll_rows_1))
				
				ll_rownum_1 = 1
				
				guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] lds_cen_out_md_co  "+ String(ll_rownum_1)+ " / " + String(ll_rows_2))
				...
				DO
					...
					guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] LOOP uoStowages["+String(ll_array_count)+"].dsContent.InsertRow(0)")
				...
				guoLog.uf_debug("["+ this.classname( )+".of_restore_distribution] AFTER LOOP dsContent " + String(ll_array_count))
			
			END IF
			
		Next	

		guoLog.uf_allways("["+ this.classname( )+".of_restore_distribution] AFTER LOOP uoStowages " + String(ll_array_count))
	...
	IF 	SQLCA.SQLCode <> 100 AND SQLCA.SQLCode <> 0 THEN
		guoLog.uf_error("["+ this.classname( )+".of_restore_distribution] Fehler bei Lesen Distribution Errors: " + sqlca.sqlerrtext)
...
ELSE // IF ls_save_distrtibution = "1" ...
	guoLog.uf_allways("["+ this.classname( )+".of_restore_distribution] RETURN FALSE ")
...
guoLog.uf_allways("["+ this.classname( )+".of_restore_distribution] END  ")
...
// 1.1 			O.Hoefer	31.10.2016		Issue #1843 - Exception Valid from
// 1.2 			O.Hoefer	21.09.2017		Issue #2195 - Exception Time Frame
//
//
// Return: integer
//
...
if this.dsDistributionPerACType.RowCount() = 0 then
	...
	guoLog.uf_error("["+ this.classname( )+".of_get_distribution_parameters_by_ac] " + this.sError)
	return -1
End If
...
If ll_Exception_Rows > 0 Then
	If dsFlight.RowCount() > 0 Then
		...
		ll_Routing = dsFlight.GetItemNumber(1, "nrouting_id")
		...
		ls_Filter += " AND (nrouting_key=" + String(ll_Routing) + " OR nrouting_all=1)"
		ls_Filter += " AND (nfreq" + String( ll_Freq ) + "=1)"

		//issue #1816
		//issue #1843
		//ls_Filter += " AND (" + String( ldt_Departure, "yyyy-mm-dd" ) + " between dvalid_from and dvalid_to )"
		ls_Filter += " AND (" + String( ldt_Departure, "yyyy-mm-dd" ) + " between date(dvalid_from) and date(dvalid_to) )"
		
		//issue #2195
		ls_Filter += " AND ('" + ls_Departure_Time + "' >= ctime_from AND '" + ls_Departure_Time + "' <= ctime_to)"
		
		guoLog.uf_debug("["+ this.classname( )+".of_get_distribution_parameters_by_ac] " +  ls_Filter)
		...
		CHOOSE CASE	ll_Exception_Rows
			...
			CASE IS > 0 	
				...
				ll_Distribution_Key =  dsDistributionExceptions.GetItemNumber(1, "ndistribution_key" )
				guoLog.uf_error("["+ this.classname( )+".of_get_distribution_parameters_by_ac] multiple exceptions (" + String(ll_Exception_Rows) + ") using random one")
...
if this.dsDistributingMeals.RowCount() = 0 then
	this.sError = "No galleyparameters for Meal distribution found"
	guoLog.uf_error("["+ this.classname( )+".of_get_distribution_parameters_by_ac] (2)" +this.sError)
	return -1
else
	...
	if this.dsMeals.RowCount() > 0  then
		...
		guoLog.uf_debug("["+ this.classname( )+".of_get_distribution_parameters_by_ac] ------------------------------------------------------------------------------------------------------------------------")
		ls_out = ""
		...
		guoLog.uf_debug("["+ this.classname( )+".of_get_distribution_parameters_by_ac] nresult_keys = " + ls_out)
		guoLog.uf_debug("["+ this.classname( )+".of_get_distribution_parameters_by_ac] AC Type is used to identify Distribution rule: " + this.dsMeals.GetItemString(1, "cpackinglist") + " - " + this.dsMeals.GetItemString(1, "cproduction_text"))
		guoLog.uf_debug("["+ this.classname( )+".of_get_distribution_parameters_by_ac] -------------------------------------------------------------------------------------------------------------------------")
		...
		if not isnull(ll_Cover) then
			...
			if this.iTrace = 1 then
				...
				if sqlca.sqlcode = 0 then
					guoLog.uf_debug("["+ this.classname( )+".of_get_distribution_parameters_by_ac] [1] Meal loading is: " + ls_out)
				else
					guoLog.uf_error("["+ this.classname( )+".of_get_distribution_parameters_by_ac] Error getting Meal Loading description: " + sqlca.sqlerrtext)
				end if
				
				ls_out = ""
				select ctext into :ls_out from cen_distribution where ndistribution_key = :ll_Distribution_Key;
				if sqlca.sqlcode = 0 then
					guoLog.uf_debug("["+ this.classname( )+".of_get_distribution_parameters_by_ac] Using Distribution rule: " + ls_out)
				else
					guoLog.uf_error("["+ this.classname( )+".of_get_distribution_parameters_by_ac] Error getting Distribution Rule description: " + sqlca.sqlerrtext)
				end if
			end if
	...
	if this.dsAdditional.RowCount() > 0  then
		...
		if ll_Cover = 0 then
			if this.dsMeals.RowCount() > 0 then
				...
				guoLog.uf_debug("["+ this.classname( )+".of_get_distribution_parameters_by_ac] ADDITIONAL found no distribution routine for aircraft: " + string(this.lAircraftKey))				
				return -1
			end if
		end if
...
ll_Ende = CPU()
guoLog.uf_debug("["+ this.classname( )+".of_get_distribution_parameters_by_ac] took " + string((ll_Ende - ll_Start)/1000, "0.00") + " seconds!")
...
public function integer of_create_spml_sheet ();if this.bSPMLSummary then
	// TSC 27.03.2018: Unterscheidung SPML-Sheets
	if bSPMLSummary2 then
		dsSPMLSummary.dataobject = "dw_uo_spml_summary_2"
	end if
	if iWebService = 0 then
		if bSPMLSummary2 then
			this.of_format_datastore_report(this.dsSPMLSummary, uf.translate("SPML-Liste2"))
		else
			this.of_format_datastore_report(this.dsSPMLSummary, uf.translate("SPML-Liste"))
		end if
	else
...
if luo_FormatMandant.of_mandant_profilestring(sqlca, s_app.smandant ,'Distribution','ByACType','0') = '1' then
	bnewdistributionassignment = TRUE
end if
...
SetNULL(			blbDistributionErrors)
SetNULL(			blbSPMLSummary)
SetNULL(			blbLocationSheet)
SetNULL(			blastgroupvalues)

...
public function blob of_encode (blob ab_string);
// --------------------------------------------------------------------------------
// Objekt : uo_label_return
// Methode: of_encode (Function)
//
// Argument(e):
// blob ab_string
//
// Beschreibung:		XML Erstellung
//
// Aenderungshistorie:
// Version 		Wer			Wann			Was und warum
// 1.0 			<unknown>
// 1.1 			O.Hoefer	20.03.2017		Erstkommentar; Dateiname ge$$HEX1$$e400$$ENDHEX$$ndert 
// 1.2 			O.Hoefer	22.06.2017		Dateiname plus Temp Path
//
//
// Return: blob
//
...
// Verdacht auf Konflikt, wenn alle Instanzen ein File namens "Test" erstellen  
uoXML.sXMLFile = f_gettemppath() + "Test_" + String(today(), "yymmdd") + String(now(),"hhmmssfff") + ".XML"
...
if fileexists(uoXML.sXMLFile) then 
	FileDelete(uoXML.sXMLFile )
End If

...
*	1.1 		Thomas Schaefer	24.11.2016		Job_nr < 0 abfangen und dann false zur$$HEX1$$fc00$$ENDHEX$$ckgeben
*
* Return Codes:
*	 ...
*/
...
IF	sqlca.sqlcode = 0 THEN
	...
	IF ab_wab THEN
		...
		SELECT 	MAX(NJOB_NR)
		INTO		:il_job_nr_last_wab
		FROM		CEN_REQUEST_OUT
		WHERE	NRESULT_KEY = :al_nresult_key
		AND		NREQUEST_TYPE = 4;
		ll_rc = ids_store_cen_request_out_wab.Retrieve(il_job_nr_last_wab)
	END IF

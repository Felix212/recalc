...
boolean						bOutstation = false //19.09.2025 HR:
Boolean 					bExtendedLog = true

Boolean						bRecalcGGSkyscopeFlight 	= false // 15.04.2020 HR:

Boolean						bSaveFlightByFlight			= false // 20.05.2020 HR:

string							is_service_instance 	= "NONE"
string							is_service_version  	= "NONE"
long 							il_service_sleeptimer = 0

boolean						ib_onetimegen_exit = false

long 							il_flightcalc_jobnr	= -1				// 17.03.2017 HR: Flightcalc kann hiermit das Ausz$$HEX1$$e400$$ENDHEX$$hlungsfenster bef$$HEX1$$fc00$$ENDHEX$$llen
...
integer 						ii_delete_flights 		= 0			// HR: 28.05.2010: Bei 1 werden die Fl$$HEX1$$fc00$$ENDHEX$$ge vor dem Generieren gel$$HEX1$$f600$$ENDHEX$$scht
...
String							sNFBUnit
uo_generate_datastore	dsjobs2generate
...
integer						ii_freeze									// 02.09.2016 HR: 
integer						ii_newFlightState						// 02.09.2016 HR: 
...
Datetime						dtEnd
Datetime						dtToday
Datetime						dtDepartureTimeLocal //15.08.2025 HR: request #12288 
...
uo_generate_datastore					dsGenerateSchedule
uo_generate_datastore					dsReturnFlightSchedule
uo_generate_datastore					dsGenerateRoutingPlan
uo_generate_datastore					dsLocal_adjustments
uo_generate_datastore					dsForecastUse

//FRE 15.05.2008
uo_generate_datastore					dsGenerateRoutingPlanHandling

uo_generate_datastore					dsHandlingObjects
uo_generate_datastore					dsHandlingObjects_CP
uo_generate_datastore					dsHandlingObjects_LCL // TBR 29.06.2009
uo_generate_datastore					dsHandlingDetail
uo_generate_datastore					dsTrafficAreas		  
uo_generate_datastore					dsHandlingNewspaper
uo_generate_datastore					dsAirlineClasses
uo_generate_datastore					dsAircaftVersion
uo_generate_datastore					dsCentralForecast
uo_generate_datastore					dsLocalForecast
uo_generate_datastore					dsCrewQuantities
uo_generate_datastore					dsHandlingQaq
uo_generate_datastore					dsHandlingNewsAddon
uo_generate_datastore					dsLocalTimes
uo_generate_datastore					dsLocalTimesFlights
uo_generate_datastore					dsGenerateFlight			// Flugplaninfo f$$HEX1$$fc00$$ENDHEX$$r konkret einen Flug
uo_generate_datastore					dsFlightData
uo_generate_datastore 					dsCITPFlightData  			//HR 06.07.2009: Welche QP soll genommen werden
uo_generate_datastore 					dsResultkeys  				//HR 07.07.2009: Hier werden die alten Resaultkeys eines Tages zwischengespeichert
uo_generate_datastore					dsGenerateNFB
uo_generate_datastore					dsHandlingMealCover
uo_generate_datastore					dsGenerateCenExternalSchedule
uo_generate_datastore 					dsGenerateCenExternalSpml		// 05.02.2016 HR: CBASE-DE-CR-2015-052 Auch SPMLs sollen eingespielt werden
uo_generate_datastore					dsCustomerCodes						// 19.01.05: Kundennummern
uo_generate_datastore					dsHandlingInfo
uo_generate_datastore					dsExplosion					// 06.06.05: Volle St$$HEX1$$fc00$$ENDHEX$$cklistenaufl$$HEX1$$f600$$ENDHEX$$sung
uo_generate_datastore					dsFlightsForUnit			
uo_generate_datastore					dsGenerateNonACType
uo_generate_datastore					dsHandlingTypeCache
uo_generate_datastore					dsCenOutCache
uo_generate_datastore 					dsCITPFlightDataSPML 		// 02.09.2009 HR: F$$HEX1$$fc00$$ENDHEX$$r CITP-SPMLs zu $$HEX1$$fc00$$ENDHEX$$bertragen
uo_generate_datastore 					dsFlightDataSpml 				// 29.10.2021 HR: F$$HEX1$$fc00$$ENDHEX$$r Amos-SPMLs zu $$HEX1$$fc00$$ENDHEX$$bertragen
uo_generate_datastore					dsFlightClosedFlights			// 25.05.2023 HR:
integer										ii_fc_KeepRegistration		// 25.05.2023 HR:
integer										ii_fc_NoRegistrationCheck		// 25.05.2023 HR:
integer										ii_fc_OfCXwithoutReg		// 25.05.2023 HR:
...
uo_generate_datastore	dsCharterMemory			// Ist-Zustand des Fluges
...
uo_generate_datastore	dsRatioCache	// Ratiolist-Caching
...
uo_generate_datastore 					dsValidSPML
...
integer						ii_document_generation				// 09.06.2016 HR
...
// --------------------------------------------------------------------------------------------------------------------
// 03.11.2017 HR: REQ 3020: AccountCode aus Beladedefinition
// --------------------------------------------------------------------------------------------------------------------
Long	 						il_nAccountKeyBelDef
String							is_sAccountBelDef

boolean						ib_forecast_relevant 					// 08.11.2019 HR: AlmID 5710: Forecast Ramp Up Extension
boolean						ib_use_comapp_data					// 04.12.2019 HR: 
integer						ii_data_source

integer 						ii_job_prio 								// 11.05.2022 HR: Prio f$$HEX1$$fc00$$ENDHEX$$r das Logfile

// --------------------------------------------------------------------------------------------------------------------
// 16.01.2023 HR: AlmID 6658: Dynamic Meal CBASE Integration
// --------------------------------------------------------------------------------------------------------------------
boolean						ib_use_dynamic_meals	= false				

long 							lRoleID = 1000029

// --------------------------------------------------------------------------------------------------------------------
// 26.06.2023 HR:  #8552 add new columns to allow Ramp Box to be maintained here 
// --------------------------------------------------------------------------------------------------------------------
string 						is_cfs_cbox_from 	= ""
string 						is_cfs_cbox_to 		= ""


datastore 					ids_polaris_documentnumber  	// 31.01.2025 HR: 

string							is_spml_source							// 23.04.2025 HR: Almid 11358 Flight Generation with SPML setting "Forecast" is ignoring SPMLs

// --------------------------------------------------------------------------------------------------------------------
// 24.04.2025 HR: request #11290 New dynamic loading settings on loading lists on CBASEclassic
// --------------------------------------------------------------------------------------------------------------------
uo_generate_datastore	idsCenOutLoading
uo_generate_datastore	idsOldCenOutLoading
boolean						ibGenerateLoading
integer 						ii_loc_jobs_types_ctext_length
end variables
...
public function integer of_build_arrays (uo_generate_datastore odw, string scolumn)
...
public function long of_search_cfs_flight (uo_generate_datastore arg_ds, long arg_row)
...
public function integer of_generate_handling_paclos (uo_generate_datastore arg_dshandling, long arg_row, long arg_lcenoutrow, integer arg_sslzbl)
...
public function boolean of_generate_explosion_level1 ()
public function boolean of_generate_explosionjobs (integer arg_requester)
public function boolean of_checkpt_exists (long arg_airline_key, string arg_unit)
public function boolean of_generate_docengine_jobs ()
public function integer of_create_checkpts (uo_generate_datastore arg_cen_out, uo_generate_datastore arg_chkpts)
public function boolean of_generate_checkpts ()
public function boolean of_freeze_flights ()
public function boolean of_write_job_history_once_start ()
public function boolean of_write_job_history_once_end (integer arg_status)
public function integer of_generate_flights ()
public function integer of_generate_flights_cfs ()
public function integer of_get_account_from_ld ()
public function integer of_generate_flights_deletebefore ()
public function integer of_checkconnection ()
public function integer of_get_unit_language (string arg_cunit)
public function integer of_retrieve_bob_figures (long arg_nreq_flight_key, long arg_lcenoutrow)
public function integer of_generate_flights_delete ()
public function integer of_service_alive ()
public function integer of_reset_flight_ds ()
public function integer of_update_flights (integer arg_was, integer arg_lrow)
public function integer of_lock_flights (integer arg_start)
public function boolean of_generate_spml_from_amos (long lcenoutrow)
public function string of_checknull2 (string stext)
public function integer of_get_dynamicmeals (string arg_ls_cflight_key)
public function boolean of_generate_flightclose ()
public function boolean of_generate_distribution ()
public function boolean of_generate_flightcalc ()
public function boolean of_generate_flightcalcjobs (integer arg_function, datastore arg_dscenout, integer arg_distribution)
public function boolean of_flightclose_for_one_flight (long arg_row)
public function integer of_create_flighthistory (longlong arg_result_key, ref string arg_return)
public function longlong of_get_polaris_docnr ()
public function integer of_generate_loading ()
end prototypes
...
Else
   ...
   if lFound > 0 then   
      guoLog.uf_allways("["+ this.classname( )+".of_citypair_flight] Flight found in NotToRegenerate Cache: " + string(lFlightNumber)+sSuffix+" Leg "+string(lLegNumber)+" " +dsCenOutNotRegenerate.getitemstring(lFound, "ctlc_from")+"-"+dsCenOutNotRegenerate.getitemstring(lFound, "ctlc_to"))
      return true
   end if
...
// -----------------------------------------
	If dsCenOutNFB.update() = -1 Then
		...
		dsCenOutNFB.SaveAs("C:\dsCenOutNFB.xlsx", XLSX!,True)
		of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,"NFB", &
								string(dGenerationDate,s_app.sDateformat),&
...
string	 				sClassNameArray[], sAircraftConfiguration, ls_CFLIGHT_KEY, sClassName, sClassText, sVersion, sVersionFormat, ls_filter, ls_filter_spml
...
// 19.01.2023 HR: Moved set Flightkey to the beginning, as we need it for dynamic meals also
...
// --------------------------------------------------------------------------------------------------------------------
// 19.01.2023 HR: AlmID 6658: Dynamic Meal CBASE Integration
// --------------------------------------------------------------------------------------------------------------------
of_get_dynamicmeals( ls_CFLIGHT_KEY )
...
// 21.08.2019 HR: Wir setzen hier das DW zur$$HEX1$$fc00$$ENDHEX$$ck
dsForecastUse.reset()
...
if li_PaxTypeLocal = 9 then
	...
	guoLog.uf_trace("["+ this.classname( )+".of_generate_version] Airline-Key=" + string(lAirlineKey) + " Flightnumber=" + string(lFlightnumber) +" Paxtype set to "+of_get_job_paxtype(li_PaxTypeLocal))
end if
...
If li_PaxTypeLocal = 3 then
	...
	if bDifferentReturnDate = false and lVersionGroupKey > 0 Then
		guoLog.uf_trace("["+ this.classname( )+".of_generate_version] Airline-Key=" + string(lAirlineKey) + " Flightnumber=" + string(lFlightnumber) + &
			...
			if dsFlightData.RowCount() > 0 then
				...
				if lVersionGroupKey > 0 then
					...
					if lFind > 0 then
						...
						dsCenOut.SetItem(lFind,"nconfiguration_key", lVersionGroupKey) // 21.07.2020 HR: AlmID 3962: Wir merken uns den VersionGroupKey f$$HEX1$$fc00$$ENDHEX$$r die Anzeige
	...
	// --------------------------------------------------------------------------------------------------------------------
	// 29.10.2021 HR: AlmID 7905
	// --------------------------------------------------------------------------------------------------------------------
	if lRows > 0 and iImportSpmls>=1 then
		dsFlightDataSpml.retrieve( dsFlightData.getitemnumber(1, "npax_index_key") )
	else
		dsFlightDataSpml.reset()
	end if

// --------------------------------------------------------------------------------------------------------------------
// betriebliche Prognose
// --------------------------------------------------------------------------------------------------------------------
ElseIf li_PaxTypeLocal = 4 then
...
// CITP/COMapp Daten
// --------------------------------------------------------------------------------------------------------------------
elseif li_PaxTypeLocal >=5 and li_PaxTypeLocal <=11 then
		// 04.12.2019 HR: COMapp Weiche 
		if ib_use_comapp_data then
			ls_filter = "csource = 'COMapp' "
		else
			ls_filter = "csource = 'CITP' "
		end if
	
		if iQPType <> -1 then
			ls_filter += " and nairline_qp_key = "+string(iQPType)
		end if
		
		dsCITPFlightData.setfilter( ls_filter )
		
		// --------------------------------------------------------------------------------------------------------------------
		// 20.08.2019 HR: AlmID 4226: Tempor$$HEX1$$e400$$ENDHEX$$re Tabelle f$$HEX1$$fc00$$ENDHEX$$r die schrittweise Umstellung auf den Forecasterzahlen
		// 08.11.2019 HR: AlmID 5710: Nur Tabelle ber$$HEX1$$fc00$$ENDHEX$$cksichtigen, wenn auch f$$HEX1$$fc00$$ENDHEX$$r den Job aktiviert
		// --------------------------------------------------------------------------------------------------------------------
		if ib_forecast_relevant then
			dsForecastUse.retrieve(ls_cunit, ls_cairline, ll_nflight_number, ls_ctl_from, ls_ctl_to, ls_crouteing, dGenerationDate)
			IF dsForecastUse.rowcount()>0 then
				guoLog.uf_allways("["+ this.classname( )+".of_generate_version] CITP - Forecast should be used: Flightnumber=" + string(lFlightnumber) )
			end if
		end if
			
		dsCITPFlightData.Retrieve(ls_CFLIGHT_KEY, sUnit)
		
		// 02.09.2009 HR: Falls SPMLs eingelesen werden sollen, dann jetzt lesen 
		
		if iImportSpmls>=1 and dsCITPFlightData.rowcount()>0 then 
			// 04.12.2019 HR: COMapp Weiche 
			if ib_use_comapp_data then
				ls_filter_spml = "csource = 'COMapp' "
				is_spml_source = "COMapp" 					// 27.11.2024 HR: AlmID 10926 If no SPML Forecast is available use ALTEA data
			else
				
				// --------------------------------------------------------------------------------------------------------------------
				// 06.09.2022 HR: iImportSpmls=2 => Use Forecast SPMLs
				// --------------------------------------------------------------------------------------------------------------------
				if iImportSpmls=1 then 
					ls_filter_spml = "csource = 'CITP' " 
					is_spml_source = "CITP" 					// 27.11.2024 HR: AlmID 10926 If no SPML Forecast is available use ALTEA data
				else
					ls_filter_spml = "csource = 'FC' and  nquantity > 0" 
					is_spml_source	= "FC"						// 27.11.2024 HR: AlmID 10926 If no SPML Forecast is available use ALTEA data
				end if
			end if
			
			i=dsCITPFlightDataSPML.setfilter( ls_filter_spml )
			dsCITPFlightDataSPML.filter()

			// 27.11.2024 HR: AlmID 10926 Wir holen uns nur die SPMLs der aktuellsten QP und nicht die beste die wir haben
			dsCITPFlightDataSPML.Retrieve(dsCITPFlightData.getitemnumber(1, "nreq_flight_key") )
			
			// 27.11.2024 HR: AlmID 10926 If no SPML Forecast is available use ALTEA data
			if dsCITPFlightDataSPML.rowcount()=0 and is_spml_source	= "FC" then
				guoLog.uf_info("["+ this.classname( )+".of_generate_version] is_spml_source="+is_spml_source+", ls_CFLIGHT_KEY="+ls_CFLIGHT_KEY+" ("+string(dsCITPFlightData.getitemnumber(1, "nreq_flight_key"))+"), Rows in dsCITPFlightDataSPML = " + string(dsCITPFlightDataSPML.rowcount()) +" " + ls_filter_spml +" => "+ string(i))
			...
			dsCITPFlightDataSPML.reset()
		end if

		if dsCITPFlightData.RowCount() > 0 then
			string ls_reg, ls_config, ls_temp1, ls_temp2, ls_temp3
			long  ll_ackey
			sOwnerForeign					= dsCITPFlightData.GetItemString(1,"cairline_owner")
			sACTypeForeign					= dsCITPFlightData.GetItemString(1,"cactype")
			sDepartureTimeForeign	= dsCITPFlightData.GetItemString(1,"cdeparture_time_local")
			ls_reg										= dsCITPFlightData.GetItemString(1,"cregistration")
			ls_config								= dsCITPFlightData.GetItemString(1,"cconfiguration")
						
			// --------------------------------------------------------------------------------------------------------------------
			// 14.10.2025 HR: #13038 Flight Generation does not considers Polaris "Seat Configuration"
			// --------------------------------------------------------------------------------------------------------------------
			
			ls_temp1 = '## n/a ##'
			if trim(ls_reg) > " " then
				
			 	SELECT CEN_AIRLINES.CAIRLINE, CEN_AIRCRAFT.CACTYPE, CEN_AIRCRAFT.CGALLEYVERSION, CEN_AIRCRAFT.NAIRCRAFT_KEY
					INTO :ls_temp1, :ls_temp2, :ls_temp3, :ll_ackey
  				  FROM CEN_AIRLINES, 
       					  CEN_AIRCRAFT, 
       					  CEN_AIRCRAFT_REGISTRATIONS 
 				 where CEN_AIRLINES.NAIRLINE_KEY = CEN_AIRCRAFT.NAIRLINE_OWNER_KEY 
   				 and CEN_AIRCRAFT.NAIRCRAFT_KEY= CEN_AIRCRAFT_REGISTRATIONS.NAIRCRAFT_KEY
   				and CEN_AIRCRAFT_REGISTRATIONS.CREGISTRATION = :ls_reg
   				and rownum < 2;
			 
			 	if sqlca.sqlcode <> 0 then
					ls_temp1 = '## n/a ##'
				else
					if ls_temp1 <> sOwnerForeign or ls_temp2 <> sACTypeForeign or lAircraftKey <> ll_ackey then
						guoLog.uf_info("["+ this.classname( )+".of_generate_version] AC changed due to REG " + ls_reg +" from " + sOwnerForeign +" " + sACTypeForeign +" to " + ls_temp1 +" " + ls_temp2 + " ["+ls_temp3+"] ll_ackey("+string(ll_ackey)+" => lAircraftKey("+string( lAircraftKey)+")")
						
						sOwnerForeign 	= ls_temp1
						sACTypeForeign 	= ls_temp2
						lAircraftKey			= ll_ackey
					end if
				end if
			end if
			
			if ls_temp1 = '## n/a ##' then
				SELECT CEN_AIRLINES.CAIRLINE, CEN_AIRCRAFT.CACTYPE, CEN_AIRCRAFT.CGALLEYVERSION, CEN_AIRCRAFT.NAIRCRAFT_KEY
				   INTO :ls_temp1, :ls_temp2, :ls_temp3, :ll_ackey
				  FROM CEN_AIRLINES, 
				           CEN_AIRCRAFT,  
				           CEN_AIRCRAFT_MAPPING
				  where CEN_AIRLINES.NAIRLINE_KEY = CEN_AIRCRAFT.NAIRLINE_OWNER_KEY 
				      and CEN_AIRCRAFT.NAIRCRAFT_KEY= CEN_AIRCRAFT_MAPPING.NAIRCRAFT_KEY
				      and CEN_AIRCRAFT_MAPPING.CAIRCRAFT_OWNER = :sOwnerForeign
				      and CEN_AIRCRAFT_MAPPING.CAIRCRAFT_TYPE = :sACTypeForeign
				      and CEN_AIRCRAFT_MAPPING.CAIRCRAFT_VERSION = :ls_config
				      and rownum < 2;		
						
				if sqlca.sqlcode = 0 and ls_temp1 > " " then		
					if ls_temp1 <> sOwnerForeign or ls_temp2 <> sACTypeForeign or lAircraftKey <> ll_ackey then
						guoLog.uf_info("["+ this.classname( )+".of_generate_version] AC changed due to Mapping "  + sOwnerForeign +" " + sACTypeForeign +" " + ls_config +" to " + ls_temp1 +" " + ls_temp2 + " ["+ls_temp3+"] ll_ackey("+string(ll_ackey)+" => lAircraftKey("+string( lAircraftKey)+")")
			...
			// Nun die Sitzplatzversion
			// -------------------------------------------------------
			lQueryID 		= dsCITPFlightData.GetItemNumber(1,"nairline_qp_key")
			For i = 1 to dsCITPFlightData.Rowcount()
				If dsCITPFlightData.GetItemNumber(i,"nairline_qp_key") <> lQueryID Then
					Exit
				End if	
				sClassNameArray[i] 		= dsCITPFlightData.GetItemString(i,"cclass")
				iClassNumberArray[i] 	= dsCITPFlightData.GetItemNumber(i,"nclass_number")
				iSeatVersion[i] 				= dsCITPFlightData.GetItemNumber(i,"nversion")
				iForecast[i] 	 					= dsCITPFlightData.GetItemNumber(i,"npax")    //Hier muss noch gepr$$HEX1$$fc00$$ENDHEX$$ft werden, was da $$HEX1$$fc00$$ENDHEX$$bergeben werden soll
			Next
			// -------------------------------------------------------
			// Und nun die eigentliche Pr$$HEX1$$fc00$$ENDHEX$$fung Flugger$$HEX1$$e400$$ENDHEX$$t
			// -------------------------------------------------------
			...
			If uo_get_ac.of_get_aircraft() <> 0 then
				...
				if sAircraftConfiguration <> uo_get_ac.sVersionString then
						...
						guoLog.uf_error( "["+ this.classname( )+".of_generate_version] (CITP) No valid aircraft type found: Airline-Key=" + string(lAirlineKey) + " Flightnumber=" + string(lFlightnumber) + &
					                      " AC-Version: "+sAircraftConfiguration +" CITP-Version: "+uo_get_ac.sVersionString +" CITP-Actype: "+sOwnerForeign+"-"+sACTypeForeign +": "+uo_get_ac.sStatustext)
				else
					
					lFlightDataQuery			=  dsCITPFlightData.GetItemNumber(1,"nairline_qp_key")
				end if
				// 21.10.2009 HR: 
			...
			// 15.03.2019 HR: 
			of_retrieve_bob_figures( dsCITPFlightData.GetItemNumber(1,"nreq_flight_key"), lcenoutrow )
			 
		end if			

// --------------------------------------------------------------------------------------------------------------------
// zentrale & lokale Auslastung
// --------------------------------------------------------------------------------------------------------------------
Else
...
if lVersionGroupKey = 0 then
	...
	if sqlca.sqlcode=0 then	
		dsCenOut.SetItem(lcenoutrow,"nversiongroupkey",lVersionGroupKey)
		dsCenOut.SetItem(lFind,"nconfiguration_key", lVersionGroupKey) // 21.07.2020 HR: AlmID 3962: Wir merken uns den VersionGroupKey f$$HEX1$$fc00$$ENDHEX$$r die Anzeige
	end if
end if

// --------------------------------------------------------------------------------------------------------------------
// 17.11.2023 HR: request #7919: Handling also important for select the AC Type
// --------------------------------------------------------------------------------------------------------------------
datastore lds

lds = create datastore
lds.dataobject="dw_select_aircraftconfig_by_handling"
lds.settransobject(SQLCA)
lds.retrieve(lAircraftKey, lHandlingTypeKey)

if lds.rowcount()>0 then
	lVersionGroupKey = lds.getitemnumber(1, "ngroup_key")	
	
	guoLog.uf_info( "["+ this.classname( )+".of_generate_version] Flightnumber=" + string(lFlightnumber) + &
					", dw_select_aircraftconfig_by_handling Retrieve( " + string(lAircraftKey) +", "+string(lHandlingTypeKey)+") = "+string(lds.rowcount())+" rows" )

	dsCenOut.SetItem(lcenoutrow,"nversiongroupkey",lVersionGroupKey)
	dsCenOut.SetItem(lcenoutrow,"nconfiguration_key", lVersionGroupKey) // 21.07.2020 HR: AlmID 3962: Wir merken uns den VersionGroupKey f$$HEX1$$fc00$$ENDHEX$$r die Anzeige
	dsCenOut.SetItem(lcenoutrow,"CCONFIGURATION",  lds.getitemstring(1, "comp_configuration"))
else
	guoLog.uf_debug( "["+ this.classname( )+".of_generate_version] Flightnumber=" + string(lFlightnumber) + &
					", dw_select_aircraftconfig_by_handling Retrieve( " + string(lAircraftKey) +", "+string(lHandlingTypeKey)+") = "+string(lds.rowcount())+" rows" )
end if
...
If lRow <= 0 Then
	...
	guoLog.uf_debug( "["+ this.classname( )+".of_generate_version] Airline-Key=" + string(lAirlineKey) + " Flightnumber=" + string(lFlightnumber) + &
					", dsAircaftVersion.Retrieve(lAircraftKey,lVersionGroupKey) = 0 rows!!!" )
End if

// --------------------------------------------------
// Crew Mengen retrieven
// 06.06.2018 HR: CR 2468: CrewConfig f$$HEX1$$fc00$$ENDHEX$$r Abfertigungsart
// --------------------------------------------------
lRow = dsCrewQuantities.Retrieve(lAircraftKey, lHandlingTypeKey) 
If lRow <= 0 Then
	guoLog.uf_debug( "["+ this.classname( )+".of_generate_version] Airline-Key=" + string(lAirlineKey) + " Flightnumber=" + string(lFlightnumber) + &
					", dsCrewQuantities.Retrieve(lAircraftKey="+ string(lAircraftKey) +",lHandlingTypeKey="+ string(lHandlingTypeKey) +") = 0 rows!!!" )	
end if
...
For i = 1 to dsAirlineClasses.Rowcount()
	 ...
	 // --------------------------------------------------------------------------------------------------------------------
	 // 15.08.2025 HR: request #12288 
	 // --------------------------------------------------------------------------------------------------------------------
	 dsCenOutPax.SetItem(lRow,"nresult_key_group", lresultkeygroup)
	 dsCenOutPax.SetItem(lRow,"nleg_number",ii_Leg_number)
...
// 04.12.2019 HR: Pax Source am Flug speichern
choose case ii_data_source
	case 0
		dsCenOut.Setitem(lcenoutrow, "csource", " ")
	case 1
		dsCenOut.Setitem(lcenoutrow, "csource", " (CITP)")
	case 2
		dsCenOut.Setitem(lcenoutrow, "csource", " (FC)")
	case 3
		dsCenOut.Setitem(lcenoutrow, "csource", " (CA)")
	case 4
		dsCenOut.Setitem(lcenoutrow, "csource", " (CAFC)")
end choose
...
// 21.08.2019 HR: Nur wenn Flug nicht vom Forecaster bedient wird.
if dsForecastUse.rowcount()=0 and li_PaxTypeLocal <>11 then
...
// -----------------------------------------------
	...
	// 05.05.2025 HR:
	// --------------------------------------------------------------------------------------------------------------------
	idsCenOutLoading.ResetUpdate()
	sTableName	= idsCenOutLoading.Object.DataWindow.Table.UpdateTable
	For i = 1 to idsCenOutLoading.Rowcount()
		idsCenOutLoading.Setitemstatus(i,0,Primary!,NewModified!)
	Next
	
	idsCenOutLoading.Object.DataWindow.Table.UpdateTable = sTableName + "_history"
	
	if idsCenOutLoading.update() = -1 then
		lSQLCode 		= idsCenOutLoading.lSQLErrorDBCode
		lSQLRow  		= idsCenOutLoading.lSQLErrorRow
		sSQLErrorText	= idsCenOutLoading.sSQLErrorText
		of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline, &
								string(dGenerationDate,s_app.sDateformat),&
								"Can't write generated Loading to database, sqlcode " + &
								string(lSQLCode))
		f_job_error(string(dGenerationDate,"dd.mm.yyyy") + "~t" + sclient + "~t" + &
						sunit + "~tCan't write generated loading to database, " + &
						"sqlcode : " + string(lSQLCode) + "~n" + sSQLErrorText,sTraceFile + "-" + this.sInstanceName + ".log")
		idsCenOutLoading.Object.DataWindow.Table.UpdateTable = sTableName
		return False
	else
		guoLog.uf_debug("["+ this.classname( )+".of_update_history_change] Rows in idsCenOutLoading_history: "+string(idsCenOutLoading.rowcount()))	
	end if
	idsCenOutLoading.Object.DataWindow.Table.UpdateTable = sTableName
...
// --------------------------------------
	If dsCenOut.update() = -1 Then
		dsCenOut.SaveAs("C:\temp\dsCenOut.xlsx", XLSX!,True)
		return False
	End if
// --------------------------------------
...
// --------------------------------------
	If dsCenOutHandling.update() = -1 Then
		dsCenOutHandling.SaveAs("C:\temp\dsCenOutHandling.xlsx", XLSX!,True)
		return False
	End if
// --------------------------------------
...
// --------------------------------------
	If dsCenOutQaq.update() = -1 Then
		dsCenOutQaq.SaveAs("C:\temp\dsCenOutQaq.xlsx", XLSX!,True)
		return False
	End if
// -----------------------------------------
...
// -----------------------------------------
	If dsCenOutHandlingNews.update() = -1 Then
		dsCenOutHandlingNews.SaveAs("C:\temp\dsCenOutHandlingNews.xlsx", XLSX!,True)
		return False
	End if
// -----------------------------------------
...
// -----------------------------------------
	If dsCenOutNewsExtra.update() = -1 Then
		dsCenOutNewsExtra.SaveAs("C:\temp\dsCenOutNewsExtra.xlsx", XLSX!,True)
		return False
	End if
// -----------------------------------------
...
// -----------------------------------------
	If dsCenOutPax.update() = -1 Then
		dsCenOutPax.SaveAs("C:\temp\dsCenOutPax.xlsx", XLSX!,True)
		return False
	End if
	...
	// --------------------------------------------------------------------------------------------------------------------
	if idsCenOutLoading.update() = -1 then
		idsCenOutLoading.SaveAs("C:\temp\dsCenOutLoading.xlsx", XLSX!,True)
		return false
	end if
...
elseif ii_generate_jobtype=2 then
	...
	return of_write_job_history_once_end(1)	
	...
	// 05.07.2016 HR: Wir merken uns auch die Instance in der History
	if this.sInstanceName <>  "None" then
		ls_instance = this.sInstanceName
	else
		ls_instance = "GUI"
	end if

	// 24.10.2014 HR: DGEN_DATE eingef$$HEX1$$fc00$$ENDHEX$$gt
	INSERT INTO loc_job_history (njob_key,djob_date,djob_run_date,ncpu,nflights, DGEN_DATE, CINSTANCE) VALUES (:lJob_Key,:dGenerationDate,:dtstart,:lCPU,:lJobActions, :idt_generate_date, :ls_instance);
...
If sqlca.sqlcode <> 0 then
	guoLog.uf_error("["+ this.classname( )+".of_generate_schedule_delete_history] ERROR - Delete on cen_out_history failed: ["  + string(sqlca.sqlcode) + "] - " + sqlca.sqlerrtext)
...
if isnull(s_Message) or s_Message="" then s_Message = "NULL"
guoLog.uf_allways("["+ this.classname( )+".of_write_protocol] ("+s_message_key+") "+s_Message)
...
//	uo_matdispo.sMatDispoTraceFile = sTraceFile + "-" + this.sInstanceName + "_Explosion.log"  // 23.09.2010 HR: LOG-Files Explosion pro Instanze erzeugen
	...
	if ii_orders_transfer + ii_freeze > 0 then
...
//      	dsCenOut.retrieve(this.lairlinekey, this.dGenerationDate, this.sClient, this.sUnit)
	...
	// 30.09.2016 HR: wenn eingeschaltet und OE erfolgrech, dann FreeceFlight-Auftrag f$$HEX1$$fc00$$ENDHEX$$r FlightCalc erstelllen
	// 11.04.2019 HR: wir m$$HEX1$$fc00$$ENDHEX$$ssen zwischen Prod / Preprod / beide unterscheiden
	if  ii_freeze >= 1 then
		if ii_freeze = 1 or ii_freeze = 3 then
			if not of_generate_flightcalcjobs(15, dsCenOut, 0) then
				of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline,string(dGenerationDate,s_app.sDateformat),"Can't write FlightCalcJobs (Production).")
				rollback using sqlca;
				return false
			end if
		end if
		
		if ii_freeze = 2 or ii_freeze = 3 then
			if not of_generate_flightcalcjobs(17, dsCenOut, 0) then
				of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline,string(dGenerationDate,s_app.sDateformat),"Can't write FlightCalcJobs (Preproduction).")
				rollback using sqlca;
				return false
			end if
		end if
		...
		if dsCenOut.update()<> 1 then
			of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline,string(dGenerationDate,s_app.sDateformat),"Can't write into FlightState.")
			rollback using sqlca;
			return False
		end if			
	end if
...
// -----------------------------------------
	...
	// --------------------------------------------------------------------------------------------------------------------
	// 25.07.2017 HR: Wenn wir was gefunden haben, dann pr$$HEX1$$fc00$$ENDHEX$$fen wir, ob der Abflug nach der Ankunft des Vorlegs liegt
	// --------------------------------------------------------------------------------------------------------------------
	if lFound > 0 then
		ld_dt = datetime(dReturnFlightDate, 	time(dsReturnFlightSchedule.getitemstring(lFound, "cdeparture_time")))

		If lFlightScheduleTime = 1 Then
			ldt_vorleg = dsCenOut.getitemdatetime(dsCenOut.rowcount(),"darrival_time_loc")
		else
			ldt_vorleg = dsCenOut.getitemdatetime(dsCenOut.rowcount(), "darrival_time_utc")
		end if

		if f_dt_diff(ldt_vorleg, ld_dt)<= 0 then
			return 0
		end if
...
// ---------------------------------------------------------------
	long 			lRow,i,j
	long			lHandling_Key
	uo_generate_datastore 	dsHandling
	string		sFilter
...
// ----------------------------------------
   ...
   Long         ll_Rows
   Long         ll_Owner_Key
   uo_generate_datastore   lds_TrafficAreas
   ...
   Else
      ...
      lds_TrafficAreas                        = Create uo_generate_datastore
...
public function boolean of_generate_pax (long lcenoutrow, long lrow, long lclass_number);uo_generate_datastore 	dsForecast
string			sFind
long			lFoundRow
integer		iVerkehrsTag
string  		sField
...
long			lcnt
Long 			lFoundCrew
integer		li_data_source = 0
string 		ls_source 

iVerkehrsTag 	= f_getfrequence(dNewGenerationDate)
sField 			= "nload_factor_freq" + string(iVerkehrsTag)

dsCenOutPax.Setitem(lrow, "csource", " ")
...
if iLocalPaxType = 9 then
	...
	guoLog.uf_trace("["+ this.classname( )+".of_generate_pax] Airline-Key=" + string(lAirlineKey) + " Flightnumber=" + string(lFlightnumber) +" Paxtype for Class "+string(lclass_number)+" set to "+of_get_job_paxtype(iLocalPaxType))
end if
...
// 19.03.2019 HR: Erweiterung um Forecast
Elseif (iLocalPaxType >= 5 and iLocalPaxType <=8) or iLocalPaxType >= 10 then
	...
	if dsCITPFlightData.RowCount() > 0 then
		...
		// -------------------------------------------------
		lQueryID 		= dsCITPFlightData.GetItemNumber(1,"nairline_qp_key")
		ls_source 	= dsCITPFlightData.GetItemstring(1,"cen_airline_qp_cquery_period")
		...
		lFoundRow	= dsCITPFlightData.Find("cclass = '" + ls_Class + "'"+ &
		                             " and nairline_qp_key = "+string(lQueryID),1,dsCITPFlightData.Rowcount())

		If lFoundRow > 0 Then
			// --------------------------------------------------------------------------------------------------------------------
			// 01.07.2025 HR: #12154 Import Crew Pax Counts via Polaris (for Finnair)
			// --------------------------------------------------------------------------------------------------------------------
			 if dsCenOutPax.GetItemNumber(lRow,"nbooking_class") = 0 then
				dsCenOutPax.Setitem(lrow,"npax", 		dsCITPFlightData.GetItemNumber(lFoundRow,"npax"))
				dsCenOutPax.Setitem(lrow, "csource", 	ls_source + " (CITP)")
				
				guoLog.uf_debug("["+ this.classname( )+".of_generate_pax] Pax for Class " + ls_Class + " is " + string( dsCITPFlightData.GetItemNumber(lFoundRow,"npax") )) 
			else
				// --------------------------------------------------------------------------------------------------------------------
				// 20.08.2019 HR: AlmID 4226: Tempor$$HEX1$$e400$$ENDHEX$$re Tabelle f$$HEX1$$fc00$$ENDHEX$$r die schrittweise Umstellung auf den Forecasterzahlen
				// --------------------------------------------------------------------------------------------------------------------
				IF dsForecastUse.rowcount()>0 and iLocalPaxType < 11 then
					iLocalPaxType = 11
					guoLog.uf_debug( "["+ this.classname( )+".of_generate_pax] CITP - Forecast  for Class " + dsCenOutPax.Getitemstring(lRow,"cclass_name") )
				end if
	
				choose case iLocalPaxType
					case 5  //Booked Pax
							iPax = dsCITPFlightData.GetItemNumber(lFoundRow,"npax")
					
					case 6  //Booked Pax + PAD
							iPax = dsCITPFlightData.GetItemNumber(lFoundRow,"npax")
							iPax += dsCITPFlightData.GetItemNumber(lFoundRow,"npad")
					
					case 7  //Expected Pax 
							iPax = dsCITPFlightData.GetItemNumber(lFoundRow,"nexpected")
					...
					case 11 // Forecast Daten
						// --------------------------------------------------------------------------------------------------------------------
						// 15.03.2019 HR: AlmID 4226:  Forecasterzahlen verwenden
						// --------------------------------------------------------------------------------------------------------------------
						if isnull(dsCITPFlightData.GetItemNumber(lFoundRow,"nfc_pax")) then
							// --------------------------------------------------------------------------------------------------------------------
							// 12.09.2019 HR: Wenn keine Forecastzahlen dann Pax+Expected / 2
							// --------------------------------------------------------------------------------------------------------------------
							iPax = dsCITPFlightData.GetItemNumber(lFoundRow,"npax")
							iPax += dsCITPFlightData.GetItemNumber(lFoundRow,"nexpected")
							iPax = int(iPax / 2)
	
							guoLog.uf_debug( "["+ this.classname( )+".of_generate_pax] class: " + ls_Class +": CITP instead of Forecast  for npax " + string(iPax))
						else
							iPax = dsCITPFlightData.GetItemNumber(lFoundRow,"nfc_pax")
							guoLog.uf_debug( "["+ this.classname( )+".of_generate_pax] class: " + ls_Class +": Forecast  used for nfc_pax " + string(iPax))
							li_data_source ++
						end if
						
				end choose
				
				if dsCenOutPax.Setitem(lrow,"npax",iPax) <> 1 then
					guoLog.uf_error( "["+ this.classname( )+".of_generate_pax] Fehler dsCenOutPax.Setitem(lrow,'npax',"+string(iPax)+") [" + dsCenOutPax.dataobject+"]")
				end if
				
				choose case li_data_source
					case 1
						dsCenOutPax.Setitem(lrow, "csource", ls_source + " (CITP)")
					case 2
						dsCenOutPax.Setitem(lrow, "csource", ls_source + " (FC)")
					case 3
						dsCenOutPax.Setitem(lrow, "csource", ls_source + " (CA)")
					case 4
						dsCenOutPax.Setitem(lrow, "csource", ls_source + " (CAFC)")
				end choose
				
				if li_data_source > ii_data_source then ii_data_source = li_data_source
			...
			if iImportSpmls >= 1 then
				// 15.03.2019 HR:
				if iImportSpmls = 1 or isnull(dsCITPFlightData.GetItemNumber(lFoundRow,"nfc_pax")) then
					iPax = dsCITPFlightData.GetItemNumber(lFoundRow,"npax_spml")
					guoLog.uf_debug( "["+ this.classname( )+".of_generate_pax] ResultKey: "+string( lResultKey )+",  class: " + ls_Class +": CITP-SPML Amount " + string(iPax))
				else
					iPax = dsCITPFlightData.GetItemNumber(lFoundRow,"nfc_spml")
					guoLog.uf_debug( "["+ this.classname( )+".of_generate_pax] ResultKey: "+string( lResultKey )+",  class: " + ls_Class +": FC-SPML Amount " + string(iPax))
				end if
				
				if dsCenOutPax.Setitem(lrow,"npax_spml",iPax)= 1 then
					if iPax > 0 then
						iPax = iPax
					end if
				else
					guoLog.uf_error( "["+ this.classname( )+".of_generate_pax] Fehler dsCenOutPax.Setitem(lrow,'npax_spml',"+string(iPax)+") [" + dsCenOutPax.dataobject+"]")
				end if
				...
				if iSearchClass =1 or iSearchClass=2 then
					iChildrenFC += dsCITPFlightData.GetItemNumber(lFoundRow,"nchd")
				end if
			end if
		...
		elseif  iBooking = 1 Then
			guoLog.uf_error("["+ this.classname( )+".of_generate_pax] Class " + ls_Class + " not found in dsCITPFlightData")
		...
		guoLog.uf_error("["+ this.classname( )+".of_generate_pax] No rows in dsCITPFlightData for Airline-Key=" + string(lAirlineKey) + " Flightnumber=" + string(lFlightnumber) )
	end if
...
// -------------------------------------------------
	dsAircaftVersion								= Create uo_generate_datastore
...
// ---------------------------------------------------------
	...
	guoLog.uf_debug("["+ this.classname( )+".of_change_version] Change NPAX_SPML")
// -------------------------------------------------
// Alle Klassen der Airline in dsCenOutPax eintragen
// ------------------------------------------------
	sVersion = ""
...
// 180 Tagesflugplan CCS (Tagesflugplan + Matdispo nur Level 1)
// 190 Erstelle Checkpoints
// ------------------------------------------------
	long 		lCount
	date		dJobDate
	...
	if ii_generate_jobtype=2 then
		...
		of_write_job_history_once_start()
		
		return False
	end if

	//Aus der Entwicklungsumgebung immer ausf$$HEX1$$fc00$$ENDHEX$$hren
	if bAdmin then
		return false
	end if
	//
	...
	Elseif 	iJob_Type = 180  Then	 //Tagesflugplan CCS (Tagesflugplan + Matdispo nur Level 1)
	
		SELECT count(*) INTO :lCount FROM loc_job_history  
		 WHERE njob_key = :lJob_Key and djob_date = :dGenerationDate;
	
	elseif iJob_Type = 190  Then	// 190 Erstelle Checkpoints

		SELECT count(*) INTO :lCount FROM loc_job_history  
		 WHERE njob_key = :lJob_Key and djob_date = :dGenerationDate;

	elseif iJob_Type = 200  Then	// 200 FlightClosed

		SELECT count(*) INTO :lCount FROM loc_job_history  
		 WHERE njob_key = :lJob_Key and djob_date = :dGenerationDate;
		
	elseif iJob_Type = 210  Then	// 210 Distribution

		SELECT count(*) INTO :lCount FROM loc_job_history  
		 WHERE njob_key = :lJob_Key and djob_date = :dGenerationDate;
		
	elseif iJob_Type = 220  Then	// 220 Flight Calculation with Docs
		...
		guoLog.uf_allways("["+ this.classname( )+".of_job_executed] Job_type " + String(iJob_Type)+" not defined.")

	End if	
	
	If lCount > 0 then
		guoLog.uf_allways("["+ this.classname( )+".of_job_executed] Job was executed today")
		return True
	Else
		return False
	End if
...
uo_generate_datastore 	lds_Handling, lds_PackageLos
...
// 15.04.2020 HR:
// --------------------------------------------------------------------------------------------------------------------
if bRecalcGGSkyscopeFlight then return true
...
// ------------------------------------------
	...
	string 	sSearch
	Long  	lSequence
	integer li_ll_leg1, li_ll_leg2, li_ll_leg3, li_ll_leg4
// ------------------------------------------
// Loadinglist Index Key
// 18.08.2025 HR request #12288 Wir brauchen auch die Leg Werte
// ------------------------------------------	
	select NLOADINGLIST_INDEX_KEY, nleg1, nleg2, nleg3, nleg4
	  into :lloadinglistindexkey, :li_ll_leg1, :li_ll_leg2, :li_ll_leg3, :li_ll_leg4
...
// -------------------------------------------------------
	...
	// 18.08.2025 HR: request #12288 Schreiben der Leg Werte
	dsCenOutHandling.SetItem(lRow,"nll_leg1", li_ll_leg1)
	dsCenOutHandling.SetItem(lRow,"nll_leg2", li_ll_leg2)
	dsCenOutHandling.SetItem(lRow,"nll_leg3", li_ll_leg3)
	dsCenOutHandling.SetItem(lRow,"nll_leg4", li_ll_leg4)
...
// ---------------------------------------------------------------
	For i = 1 to dsHandling.Rowcount()
		...
		If lHandlingId = 6  Then
			...
			guoLog.uf_trace("["+ this.classname( )+".of_generate_handling_newspaper] processing result_key=" + &
...
delete from cen_request 
       where nresult_key in (select nresult_key from cen_out 
		                                                     where  ddeparture 			= :dGenerationDate and 
																	...
																	nairline_key 	= :lAirlineKey);
If sqlca.sqlcode <> 0 then
	guoLog.uf_error( "["+ this.classname( )+".of_generate_schedule_delete] ERROR - Delete on cen_request failed: ["  + string(sqlca.sqlcode) + "] - " + sqlca.sqlerrtext)
...
delete from CEN_OUT_QP 
       where nresult_key in (select nresult_key from cen_out 
		                                                     where  ddeparture 			= :dGenerationDate and 
																	...
																	nairline_key 	= :lAirlineKey);
If sqlca.sqlcode <> 0 then
	guoLog.uf_error( "["+ this.classname( )+".of_generate_schedule_delete] ERROR - Delete on CEN_OUT_QP failed: ["  + string(sqlca.sqlcode) + "] - " + sqlca.sqlerrtext)
...
If sqlca.sqlcode <> 0 then
	guoLog.uf_error( "["+ this.classname( )+".of_generate_schedule_delete] ERROR - Delete on cen_out failed: ["  + string(sqlca.sqlcode) + "] - " + sqlca.sqlerrtext)
...
If sqlca.sqlcode <> 0 then
	guoLog.uf_error( "["+ this.classname( )+".of_generate_schedule_delete] ERROR - Delete on cen_external_schedule failed: ["  + string(sqlca.sqlcode) + "] - " + sqlca.sqlerrtext)
...
If sqlca.sqlcode <> 0 then
	guoLog.uf_error( "["+ this.classname( )+".of_generate_schedule_delete] ERROR - Delete on cen_in failed: ["  + string(sqlca.sqlcode) + "] - " + sqlca.sqlerrtext)
...
DELETE FROM cen_in_out 
		WHERE darrival 		= :dGenerationDate and 
				...
				cunit		  		= :sunit;
If sqlca.sqlcode <> 0 then
	guoLog.uf_error( "["+ this.classname( )+".of_generate_schedule_delete] ERROR - Delete on cen_in_out failed: ["  + string(sqlca.sqlcode) + "] - " + sqlca.sqlerrtext)
	of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline,string(dGenerationDate,s_app.sDateformat),"Can't delete inbound, sqlcode " + string(sqlca.sqlcode) + ".")
	rollback using sqlca;
	return False
end if		
...
If sqlca.sqlcode <> 0 then
	guoLog.uf_error( "["+ this.classname( )+".of_generate_schedule_delete] ERROR - Delete on cen_transport failed: ["  + string(sqlca.sqlcode) + "] - " + sqlca.sqlerrtext)
	of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline,string(dGenerationDate,s_app.sDateformat),"Can't delete inbound, sqlcode " + string(sqlca.sqlcode) + ".")
	rollback using sqlca;
	return False
end if	
...
if s_change.bDoMealCalculation = true then
	...
	// 17.01.2024 HR: request #9604 detailes SPML counts wrong
	uo_generate_meals.dsspmldetail_old.retrieve( lResultkey )
...
// -----------------------------------------------------------------------------------------------------------
// 03.05.2019 HR: L$$HEX1$$f600$$ENDHEX$$schen von vor der Generierung auf vor das Speichern umgezogen
// 31.07.2019 HR: Wir d$$HEX1$$fc00$$ENDHEX$$rfen nur bei gesetztem Schalter l$$HEX1$$f600$$ENDHEX$$schen
// 18.03.2020 HR: ALM-ID 6208: In eine Funktion ausgelagert, damit wir dies auch an anderer Stelle aufrufen k$$HEX1$$f600$$ENDHEX$$nnen
// -----------------------------------------------------------------------------------------------------------
if of_generate_flights_delete() = 0 then
	return false
end if
...
for i= dsCenOut.rowcount() to 1 step -1
   ...
   if lFound > 0 then   
      	guoLog.uf_allways("["+ this.classname( )+".of_update] Flight found in NotToRegenerate Cache: " + string(lFlightNumber)+sSuffix+" Leg "+string(lLegNumber)+" " +sTLCFrom+"-"+sTLCTo)
		...
		if sqlca.sqlnrows>0 then
			guoLog.uf_allways("["+ this.classname( )+".of_update] Delete Flight because new in DSCENOUT: "+string(nairlinekey)+" "+string(nflightnumber, "000")+csuffix+" "+string(ddeparture, "dd.mm.yyyy")+" Leg "+string(nlegnumber)+" "+cunit)
		end if 
	end if
next

guoLog.uf_allways("["+ this.classname( )+".of_update] CEN_OUT (" + string(dsCenOut.rowcount())+" rows)") // 21.06.2012 HR:
...
// Datastore dsCenOutHandling speichern.
// --------------------------------------
guoLog.uf_allways("["+ this.classname( )+".of_update] CEN_OUT_Handling (" + string(dsCenOutHandling.rowcount())+" rows)")
...
// Default dsCenOutPax speichern.
// -----------------------------------------
guoLog.uf_allways("["+ this.classname( )+".of_update] CEN_OUT_PAX (" + string(dsCenOutPax.rowcount())+" rows)")
If dsCenOutPax.update() = -1 Then
...
// ---------------------------------------------------------
guoLog.uf_allways("["+ this.classname( )+".of_update] CEN_OUT_MEALS (" + string( uo_generate_meals.dsCenOutMeals.rowcount())+" rows)")
...
guoLog.uf_allways("["+ this.classname( )+".of_update] CEN_OUT_SPML (" + string(dsCenOutAllSPML.rowcount())+" rows)")
...
End if
guoLog.uf_allways("["+ this.classname( )+".of_update] CEN_OUT-Packets etc") // 21.06.2012 HR:
...
if dsCenOutPackets.RowCount()>0 then
	guoLog.uf_info("["+ this.classname( )+".of_update] Rows in dsCenOutPackets before flightsearch "+string(dsCenOutPackets.rowcount()))
	...
	if dsCenOutPackets.update() = -1 then
		...
		guoLog.uf_info("["+ this.classname( )+".of_update] Rows in dsCenOutPackets: "+string(dsCenOutPackets.rowcount()))
	end if
elseif bCFSAirline then
		guoLog.uf_info("["+ this.classname( )+".of_update] Rows in dsCenOutPackets: 0")
END IF
...
if dsCenOutLos.RowCount()>0 then
	guoLog.uf_info("["+ this.classname( )+".of_update] Rows in dsCenOutLos before flightsearch "+string(dsCenOutLos.rowcount()))
	...
	if dsCenOutLos.update() = -1 then
		...
		guoLog.uf_info("["+ this.classname( )+".of_update] Rows in dsCenOutLos: "+string(dsCenOutLos.rowcount()))	
	end if
elseif bCFSAirline then
		guoLog.uf_info("["+ this.classname( )+".of_update] Rows in dsCenOutLos: 0")
end if
...
if dsCenOutPPM.update() = -1 then
	...
	guoLog.uf_info("["+ this.classname( )+".of_update] Rows in dsCenOutPPM: "+string(dsCenOutPPM.rowcount()))	
end if
...
if dsCenOutPPMStowages.update() = -1 then
	...
	guoLog.uf_info("["+ this.classname( )+".of_update] Rows in dsCenOutPPMStowages: "+string(dsCenOutPPMStowages.rowcount()))	
end if
...
if dsCenOutCheckPt.update() = -1 then
	...
	guoLog.uf_info("["+ this.classname( )+".of_update] Rows in dsCenOutCheckPt: "+string(dsCenOutCheckPt.rowcount()))	
end if
...
if idsCenOutLoading.update() = -1 then
	...
	guoLog.uf_info("["+ this.classname( )+".of_update] Rows in idsCenOutLoading: "+string(idsCenOutLoading.rowcount()))	
end if
...
// --------------------------------------------
	...
	// --------------------------------------------------------------------------------------------------------------------
	// 22.05.2020 HR: Wenn wir Flugweise commiten, dann auch nur den Flug in die History speichern
	// --------------------------------------------------------------------------------------------------------------------
	if bSaveFlightByFlight then
		dsCenOut.Setitemstatus(lrow,0,Primary!,NewModified!)
	else
		For i = 1 to dsCenOut.Rowcount()
			dsCenOut.Setitemstatus(i,0,Primary!,NewModified!)
		Next
...
// -----------------------------------------------
	...
	// --------------------------------------------------------------------------------------------------------------------
	// 10.06.2025 HR: Datastore CEN_OUT_SPML (History)speichern.
	// --------------------------------------------------------------------------------------------------------------------
	guoLog.uf_allways("["+ this.classname( )+".of_update_history] History CEN_OUT_SPML (" + string(dsCenOutAllSPML.rowcount())+" rows)")
	
	dsCenOutAllSPML.ResetUpdate()
	sTableName	= dsCenOutAllSPML.Object.DataWindow.Table.UpdateTable
	For i = 1 to dsCenOutAllSPML.Rowcount()
		dsCenOutAllSPML.Setitemstatus(i,0,Primary!,NewModified!)
	Next
	
	dsCenOutAllSPML.Object.DataWindow.Table.UpdateTable = sTableName + "_history"

	if dsCenOutAllSPML.update() = -1 Then
		lSQLCode 		= dsCenOutAllSPML.lSQLErrorDBCode
		lSQLRow  		= dsCenOutAllSPML.lSQLErrorRow
		sSQLErrorText	= dsCenOutAllSPML.sSQLErrorText
		dsCenOutAllSPML.Object.DataWindow.Table.UpdateTable = sTableName
		of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline, &
								string(dGenerationDate,s_app.sDateformat),&
								"Can't write generated spmls history to database, sqlcode " + &
								string(lSQLCode))
		f_job_error(string(dGenerationDate,"dd.mm.yyyy") + "~t" + sclient + "~t" + &
						sunit + "~tCan't write generated  spmls history to database, " + &
						"sqlcode : " + string(lSQLCode) + "~n" + sSQLErrorText,sTraceFile + "-" + this.sInstanceName + ".log")
		...
		dsCenOutAllSPMLDetail.ResetUpdate()
		sTableName	= dsCenOutAllSPMLDetail.Object.DataWindow.Table.UpdateTable
		For i = 1 to dsCenOutAllSPMLDetail.Rowcount()
			dsCenOutAllSPMLDetail.Setitemstatus(i,0,Primary!,NewModified!)
		Next
		
		dsCenOutAllSPMLDetail.Object.DataWindow.Table.UpdateTable = sTableName + "_history"

		if dsCenOutAllSPMLDetail.update() = -1 Then
			lSQLCode 		= dsCenOutAllSPMLDetail.lSQLErrorDBCode
			lSQLRow  		= dsCenOutAllSPMLDetail.lSQLErrorRow
			sSQLErrorText	= dsCenOutAllSPMLDetail.sSQLErrorText
			dsCenOutAllSPMLDetail.Object.DataWindow.Table.UpdateTable = sTableName
			
			of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline, &
									string(dGenerationDate,s_app.sDateformat),&
									"Can't write generated spmldetails history  to database, sqlcode " + &
									string(lSQLCode))
			f_job_error(string(dGenerationDate,"dd.mm.yyyy") + "~t" + sclient + "~t" + &
							sunit + "~tCan't write generated  spmldetails history  to database, " + &
							"sqlcode : " + string(lSQLCode) + "~n" + sSQLErrorText,sTraceFile + "-" + this.sInstanceName + ".log")
	...
	if idsCenOutLoading.update() = -1 then
		...
		guoLog.uf_debug("["+ this.classname( )+".of_update_history] Rows in idsCenOutLoading_history: "+string(idsCenOutLoading.rowcount()))	
	end if
...
// 31.08.2016 HR: CBASEalm ID #1424: Owner wird bei manchen Wechseln nicht gesetzt
sOwner = f_get_airline_name(lOwnerKey)
...
dsCenOut.SetItem(lRow,"nconfiguration_key", lVersionGroupKey) // 21.07.2020 HR: AlmID 3962: Wir merken uns den VersionGroupKey f$$HEX1$$fc00$$ENDHEX$$r die Anzeige
...
uo_generate_datastore 	lds_Handling
...
For i = 1 to lds_Handling.Rowcount()
	...
	For j = 1 to dsHandlingDetail.Rowcount()
		...
		if j = 1 then
			...
			// 03.11.2017 HR: REQ 3020: AccountCode aus Beladedefinition
			// --------------------------------------------------------------------------------------------------------------------
			if isnull(il_nAccountKeyBelDef) then
				dsCenOut.SetItem(lcenoutrow,"naccount_key",lAccountKey)
				dsCenOut.SetItem(lcenoutrow,"caccount",sGetAccount)
			else
				dsCenOut.SetItem(lcenoutrow,"naccount_key",il_nAccountKeyBelDef)
				dsCenOut.SetItem(lcenoutrow,"caccount",is_sAccountBelDef)
			end if
		end if
		// -------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------------------------------------------
// 29.08.2017 HR: Das erste Leg kann nicht an Folgetagen sein
// --------------------------------------------------------------------------------------------------------------------
if lScheduleRow <= 0 and  this.llegnumber= 1 Then 
	return lScheduleRow
end if
...
// 25.07.2017 HR: Wenn wir was gefunden haben, dann pr$$HEX1$$fc00$$ENDHEX$$fen wir, ob der Abflug nach der Ankunft des Vorlegs liegt
// --------------------------------------------------------------------------------------------------------------------
if lScheduleRow > 0 and lLegNumber > 1 and dsCenOut.rowcount() >0 then
	ld_dt = datetime(dGenerationDate, time(dsGenerateSchedule.getitemstring(lScheduleRow, "cdeparture_time")))
	...
	if f_dt_diff(ldt_vorleg, ld_dt)<= 0 then
		// Wenn Ankunft Vorleg nach Abflug ist, dann ist das kein Treffer und wir m$$HEX1$$fc00$$ENDHEX$$ssen an den Folgetagen schauen
		lScheduleRow = 0
	end if
...
// 25.07.2017 HR: Wenn das Vorleg schon ein Weiter oder R$$HEX1$$fc00$$ENDHEX$$ckflug ist, dann auch dieser
// ----------------------------------------------------------------------
If (lScheduleRow <= 0 or iOffset_RF >0) and  this.llegnumber>1 Then 
	if bCharter then
		if iOffset_RF = 0 then iOffset_RF++
		For i = iOffset_RF to 2
			// ------------------------------------------
			// Wir schauen maximal 1 Tag in die Zukunft
			// 31.08.2017 HR: issue #2875 Bei Charter jetzt bis $$HEX1$$fc00$$ENDHEX$$bermorgen schauen
			// ------------------------------------------
		...
		// 25.07.2017 HR: Wir starten mit dem Offset vom Vorleg
		//For i = 1 to 3 
		if iOffset_RF = 0 then iOffset_RF++
		For i = iOffset_RF to 3 
			// ------------------------------------------
...
// --------------------------------------------------------------------------------------------------------------------
// 26.06.2023 HR:  #8552 add new columns to allow Ramp Box to be maintained here  ( 25.08.2023 HR: #9514 Wrong Variable used)
// --------------------------------------------------------------------------------------------------------------------
If iJobParameter = 7 then
	sBoxFrom			= is_cfs_cbox_from
	sBoxTo				= is_cfs_cbox_to
end if
...
// 03.11.2017 HR: REQ 3020: AccountCode aus Beladedefinition
// --------------------------------------------------------------------------------------------------------------------
il_nAccountKeyBelDef			= dsGenerateRoutingPlan.Getitemnumber(lroutingplanrow,"naccount_key")
is_sAccountBelDef				= dsGenerateRoutingPlan.Getitemstring(lroutingplanrow,"caccount")
...
// 26.07.2017 HR: Eine Minute zur lokalen Abflugszeit reicht
// 23.06.2023 HR: #8628: Wir m$$HEX1$$fc00$$ENDHEX$$ssen 1 Minuten auf die UTC Abflugszeit nehmen und das ganze nach Local umrechnen, damit die weitere Verarbeitung funktioniert
	...
	guoLog.uf_debug( "["+ this.classname( )+".of_write_cen_out] lFlightNumber = " +  string(lFlightNumber)+" sArrivalTime changed from " + sArrivalTime + " to " +   uoConvUtcLoc.is_new_time )
	sArrivalTime				= uoConvUtcLoc.is_new_time
end if

// 2. Ankunftszeit UTC als DateTime
uoConvUtcLoc.uf_loc2utc(sTLCTo, DATE( dtDepartureDateLoc) , sArrivalTime, nArrivalFaktor)
...
IF 	dtArrivalDateUtc < dtDepartureDateUtc THEN
	guoLog.uf_debug( "["+ this.classname( )+".of_write_cen_out] lFlightNumber = " +  string(lFlightNumber)+" Arrival next day " + string(dtArrivalDateUtc, "dd.mm.yy hh:mm") + " < " + string(dtDepartureDateUtc, "dd.mm.yy hh:mm") )
...
// 29.09.2021 HR: Remove ii_reuse_result_keys due to no longer used and extend check on LegNumber for NAM
a = dsCenOutCache.find("cflight_key = '"+ls_fk+"' and nleg_number = " + string( lLegNumber ) + " and nreused = 0 and nnotregenerate = 0", 1, dsCenOutCache.rowcount())
if a > 0 then
	dsCenOutCache.setitem(a, "nreused", 1)
	lSequence = dsCenOutCache.getitemnumber(a, "NRESULT_KEY")
	guoLog.uf_trace("["+ this.classname( )+".of_write_cen_out] NRESULT_KEY - Recycler for "+ls_fk +" ReUse "+string(lSequence))
else
...
// --------------------------------------------------------------------------------------------------------------------
// 20.05.2020 HR: Wenn wir Flugweise speichern, dann setzen wir die Fl$$HEX1$$fc00$$ENDHEX$$ge erst mal auf Status 0 
//                            und sp$$HEX1$$e400$$ENDHEX$$ter dann auf iGenerierungsstatus
// --------------------------------------------------------------------------------------------------------------------
if bSaveFlightByFlight then
	dsCenOut.SetItem(lRow,"NSTATUS", 0)
else
	dsCenOut.SetItem(lRow,"NSTATUS",iGenerierungsstatus)
end if
...
// 03.11.2017 HR: REQ 3020: AccountCode aus Beladedefinition
// --------------------------------------------------------------------------------------------------------------------
dsCenOut.SetItem(lRow,"naccount_key", il_nAccountKeyBelDef)
dsCenOut.SetItem(lRow,"caccount", is_sAccountBelDef)

// --------------------------------------------------------------------------------------------------------------------
// 31.01.2025 HR: 
// --------------------------------------------------------------------------------------------------------------------
dsCenOut.SetItem(lRow,"ndelivery_note_no", of_get_polaris_docnr() )
...
uo_generate_datastore 	dsValidSPMLDetail
long 			lFindDef
long			lhmealkeyold
long			lhmealkey
long			i2
...
if isvalid(uo_generate_meals.dsRotationCache) then
	guoLog.uf_trace("["+ this.classname( )+".of_generate_handling_objects] Reset uo_generate_meals.dsRotationCache...")
...
For i = 1 to lRowcount
	...
	// --------------------------------------------------------------------------------------------------------------------
	 // 15.08.2025 HR: request #12288 
	 // --------------------------------------------------------------------------------------------------------------------
	 lresultkeygroup 					= dsCenOut.GetItemnumber(i,"nresult_key_group" )
	 sRoutingShortText 			= dsCenOut.Getitemstring(i,"CROUTING")
	 dtDepartureTimeLocal 	= dsCenOut.Getitemdatetime(i,"ddeparture_time_loc")
	...
	// --------------------------------------------------------------------------------------------------------------------
	guoLog.uf_allways("["+ this.classname( )+".of_generate_handling_objects] "+ ls_rowcount + sAirline + " "+string(lFlightNumber, "0000")+sSuffix+" "+sTLCFrom+"-"+sTLCTo + " ["+string(lResultKey)+"]" + fill("#-", 10))
	...
	// 03.11.2017 HR: REQ 3020: AccountCode aus Beladedefinition
	// --------------------------------------------------------------------------------------------------------------------
	il_nAccountKeyBelDef			= dsCenOut.GetitemNumber(i,"naccount_key")
	is_sAccountBelDef				= dsCenOut.Getitemstring(i,"caccount")
	...
	if lLegNumber > 1 and ldReturnFlightDate <> dNewGenerationDate then
		...
		if li_HORFWDD = 1 then
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_objects] "+ls_rowcount +"DepartureDate <> ReturnFlightDate (DepDate Used)" + string(dNewGenerationDate) + ", sAirline=" + sAirline + ", sAirlineCode=" + sAirlineCode + &
			...
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_objects] "+ls_rowcount+"DepartureDate <> ReturnFlightDate " + string(dNewGenerationDate) + ", sAirline=" + sAirline + ", sAirlineCode=" + sAirlineCode + &
							", lFlightNumber=" + string(lFlightNumber) + ", lRoutingPlanDetailKey=" + string(lRoutingPlanDetailKey) + &
							", lRoutingPlanDetailKey_CP=" + string(lRoutingPlanDetailKey_CP))
		end if
	else
		bDifferentReturnDate = false
		guoLog.uf_trace("["+ this.classname( )+".of_generate_handling_objects] "+ ls_rowcount+"DepartureDate = ReturnFlightDate " + string(dNewGenerationDate) + ", sAirline=" + sAirline + ", sAirlineCode=" + sAirlineCode + &
						", lFlightNumber=" + string(lFlightNumber) + ", bDifferentReturnDate = false")
	end if

	guoLog.uf_trace("["+ this.classname( )+".of_generate_handling_objects] "+ ls_rowcount +"sAirline=" + sAirline + ", sAirlineCode=" + sAirlineCode + &
					", lFlightNumber=" + string(lFlightNumber) + ", lRoutingPlanDetailKey=" + string(lRoutingPlanDetailKey) + &
					", lRoutingPlanDetailKey_CP=" + string(lRoutingPlanDetailKey_CP))
	...
	If dsCenOut.GetitemString(i,"cunit") = sUnit Then
		...
		// ---------------------------------------------------------------		
		dsCITPFlightDataSPML.reset() // 04.11.2016 HR: Wir l$$HEX1$$f600$$ENDHEX$$schen die SPMLs an dieser Stelle, damit sie nicht einem falschen Flug zugespielt werden
		...
		// --------------------------------------------------------------------------------------------------------------------
		// 16.05.2024 HR: Wir brauchen nur die Paxe f$$HEX1$$fc00$$ENDHEX$$r den aktuellen Flug
		// --------------------------------------------------------------------------------------------------------------------
		...
		// 27.01.2016 Abfertigung INT CBASE-BRU-CR-2015-014
		if sCurrentHandling = "STD" or sCurrentHandling = "DLV" or sCurrentHandling = "REQ" or sCurrentHandling = "SPC"  or sCurrentHandling = "INT" then
			guoLog.uf_allways("["+ this.classname( )+".of_generate_handling_objects] "+ls_rowcount+sOut +" PaxReset because REQ-FLight")
			iDontGeneratePaxCounts	= 1
		...
		// 24.04.2025 HR: request #11290 New dynamic loading settings on loading lists on CBASEclassic
		// --------------------------------------------------------------------------------------------------------------------
		if ibGenerateLoading then
			of_generate_loading()
		else
			idsCenOutLoading.reset()
			idsOldCenOutLoading.reset()
		end if
		...
		if iImportSpmls >= 1 then
			...
			// 29.10.2021 HR: AlmID 7905
			// --------------------------------------------------------------------------------------------------------------------
			elseif  iPaxType = 3 then	
				if not of_generate_spml_from_amos(i)then
					of_write_protocol(iJob_Type,iGenerierungsstatus,1,iWarnung,sAirline + " " + &
									string(lFlightNumber),&
									string(dGenerationDate,s_app.sDateformat),&
									"Can't create spml's." )			
		...
		//	uo_generate_meals.dsCenOutMeals.Reset()
		guoLog.uf_trace("["+ this.classname( )+".of_generate_handling_objects] "+ ls_rowcount+sOut +" Create Meals")
				
		// --------------------------------------------------------------------------------------------------------------------
		// 08.08.2016 HR: Wir setzen das pro Flug zur$$HEX1$$fc00$$ENDHEX$$ck
		// --------------------------------------------------------------------------------------------------------------------
		uo_generate_meals.uf_new_flight()
		...
		End if		
		guoLog.uf_trace("["+ this.classname( )+".of_generate_handling_objects] "+ ls_rowcount+sOut +" Reduce Overload")
		...
		guoLog.uf_trace("["+ this.classname( )+".of_generate_handling_objects] "+ ls_rowcount+sOut +" Create Extra")
		...
		// 16.01.2023 HR: AlmID 6658: Dynamic Meal CBASE Integration
		// --------------------------------------------------------------------------------------------------------------------
		if this.ib_use_dynamic_meals then
			uo_generate_meals.idscitpflightdatapreorder.setfilter(" nfound <> 1 ")
			uo_generate_meals.idscitpflightdatapreorder.filter()
			if uo_generate_meals.idscitpflightdatapreorder.rowcount()>0 then 
				guoLog.uf_error("["+ this.classname( )+".of_generate_handling_objects] DynamicMeals Find errors: " + string( uo_generate_meals.idscitpflightdatapreorder.rowcount() ))

				string ls_error
				
				for j = 1 to uo_generate_meals.idscitpflightdatapreorder.rowcount()
					
					if uo_generate_meals.idscitpflightdatapreorder.getitemnumber(j, "nfound")=0 then
						ls_error = "DM not in Masterdata: "
					else
						ls_error = "DM no Order found: "
					end if
					
					ls_error +=  of_checknull2(uo_generate_meals.idscitpflightdatapreorder.getitemstring(j, "cen_request_preorder_cclass")) + " - " 
					ls_error +=  of_checknull2(uo_generate_meals.idscitpflightdatapreorder.getitemstring(j, "cen_request_preorder_ccustomer_pl")) + " - " 
					ls_error +=  of_checknull2(uo_generate_meals.idscitpflightdatapreorder.getitemstring(j, "cen_request_preorder_cdish_name"))
					
					of_write_protocol(iJob_Type,iGenerierungsstatus,1,iWarnung,sAirline + " " + &
										string(lFlightNumber),&
										string(dGenerationDate,s_app.sDateformat),&
										ls_error)
					guoLog.uf_error("["+ this.classname( )+".of_generate_handling_objects] Error "+ string(j) + ": " + ls_error)
				next
			end if
			
			uo_generate_meals.idscitpflightdatapreorder.setfilter("")
			uo_generate_meals.idscitpflightdatapreorder.filter()
		...
		if iImportSpmls >= 1 then
			...
			if iChildrenFC >0 then
				...
				uo_generate_datastore								dsPackinglistFunctions	// St$$HEX1$$fc00$$ENDHEX$$cklisten der Extrabeladung, die 
																								 // automatisch ver$$HEX1$$e400$$ENDHEX$$ndert werden.
				dsPackinglistFunctions								= Create uo_generate_datastore
						...
						if lFind > 0 then
							...
							choose Case lFunctioncode
								case 1
									...
									guoLog.uf_trace("["+ this.classname( )+".of_generate_handling_objects] "+ ls_rowcount+" CHD-Import: "+string(iChildrenFC)+"x CHD in Extrabeladung")
							end choose
						end if
					next
				end if
			...
			dsValidSPMLDetail								= Create uo_generate_datastore
			...
			for i2 = 1 to dsCenOutNewSPML.rowcount()
				...
				if lFindDef = 0 then
					of_write_protocol(iJob_Type,iGenerierungsstatus,2,iWarnung,sAirline + " " + string(lFlightNumber) + sSuffix,&
											string(dGenerationDate,s_app.sDateformat),&
											lsClass+" "+lsSPML + " not permitted in conjunction with the prescribed meals.")		
					
					guoLog.uf_error("["+ this.classname( )+".of_generate_handling_objects] "+ls_rowcount+sOut+": "+lsClass+" "+lsSPML+" nicht zul$$HEX1$$e400$$ENDHEX$$ssig in Verbindung mit den angewiesenen Mahlzeiten!")
			...
			for j=1 to dsCenOutPax.rowcount()
				...
				if lFindDef>0 then
					guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_objects] Class " + dsCenOutPax.getitemstring(j,"cclass")+": Change/unchange dsCenOutPax.Setitem(j,'npax_spml') from " + string(dsCenOutPax.GetitemNumber(j,"npax_spml"))+" to " +string(dsCenOutNewSPML.getitemnumber(lFindDef,"compute_sum")))
					...
					guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_objects] Class " + dsCenOutPax.getitemstring(j,"cclass")+": Set dsCenOutPax.Setitem(j,'npax_spml') from " + string(dsCenOutPax.GetitemNumber(j,"npax_spml"))+" to '0' => "+string(lFindDef))
		...
		// --------------------------------------------------------------------------------------------------------------------
		// 16.05.2024 HR: Filter wieder entfernen
		// --------------------------------------------------------------------------------------------------------------------
		i2=dsCenOutPax.setfilter("")
		i2=dsCenOutPax.filter()
		
		// --------------------------------------------------------------------------------------------------------------------
		// 20.05.2020 HR: Wir wollen hier ggf. Flug f$$HEX1$$fc00$$ENDHEX$$r Flug speichern
		// --------------------------------------------------------------------------------------------------------------------
		if bSaveFlightByFlight then
			dsCenOut.setitem(i,"nstatus", this.igenerierungsstatus )
			if of_update_flights(2, i) = -2 then
...
guoLog.uf_allways("["+ this.classname( )+".of_generate_handling_objects] Finish")
...
if iDays_Offset <1 then 
   guoLog.uf_error("["+ this.classname( )+".of_generate_schedule] Offset "+string(iDays_Offset)+" is less than 1, so job is ignored.") 
   return false
end if
...
if isvalid(dsCenOutPax) then dsCenOutPax.Reset()
if isvalid(dsCenOutCheckPt) then dsCenOutCheckPt.Reset() // 13.11.2015 HR: M$$HEX1$$fc00$$ENDHEX$$ssen wir auch reseten
...
// 29.04.2011 HR:
if isvalid(dsCenOutQp) then dsCenOutQp.Reset()
if isvalid(dsCenOutAllSPML) then dsCenOutAllSPML.Reset()
if isvalid(dsCenOutAllSPMLdetail) then dsCenOutAllSPMLdetail.Reset()
if isvalid(dsCenOutLos) then dsCenOutLos.Reset()
if isvalid(dsCenOutPackets) then dsCenOutPackets.Reset()

// 23.05.2012 HR:
if isvalid(dsCenOutPPM) then dsCenOutPPM.Reset()
if isvalid(dsCenOutPPMStowages) then dsCenOutPPMStowages.Reset()
if isvalid(dsCenOutPPMMD) then dsCenOutPPMMD.Reset()

if isvalid(idsCenOutLoading) then idsCenOutLoading.Reset() // 20.05.2025 HR:
...
// 29.09.2021 HR: Remove ii_reuse_result_keys due to no longer used
...
//if ii_resuse_resultkeys = 1 then
	 guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] Reuse NRESULT_KEY is on.")
//end if
...
if ii_new_cfs_handlinggen = 1 then
	 guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] NewCFSHandlingGen is on.")
end if
...
dsValidSPML  = create uo_generate_datastore
...
// 08.06.2016 HR: Wegen Performanceprobleme muss diese Funktion abschaltbar sein
uo_generate_meals.ib_SLReplaceForACType = (f_mandant_profilestring(sqlca, sClient, 'MealCalculation','SLReplaceForACType',"1") = "1")
if not uo_generate_meals.ib_SLReplaceForACType then
   guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] SLReplaceForACType is set to FALSE")
end if
...
// --------------------------------------------------------------------------------------------------------------------
if bCFSAirline then
	 guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] Generate with CFS-Roles "+is_schedule_parameter)
	ls_GenerateRoutingPlan = dsGenerateRoutingPlan.dataobject 
	
	//destroy dsGenerateRoutingPlan
	//dsGenerateRoutingPlan					= Create uo_generate_datastore
	...
	//dsGenerateSchedule					= Create uo_generate_datastore
	...
	li_ret = of_generate_flights_cfs()
	...
	if isvalid(dsExtCatSched) then destroy dsExtCatSched // 20.06.2012 HR:
	
	garbagecollect()

	guoLog.uf_debug("["+ this.classname( )+".of_generate_schedule] Rows in dsCenOut after creation (cfs): "+string(dsCenOut.rowcount()))
else
	 guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] Generate with Standard-Roles "+is_schedule_parameter)
	li_ret = of_generate_flights()
	guoLog.uf_debug("["+ this.classname( )+".of_generate_schedule] Rows in dsCenOut after creation: "+string(dsCenOut.rowcount()))
end if

// --------------------------------------------------------------------------------------------------------------------
// 01.09.2017 HR: issue #2836 Wenn bei der Generierung ein Fehler aufgetreten ist, dann raus hier
// 04.10.2017 HR: issue #2836 Wenn keine Fl$$HEX1$$fc00$$ENDHEX$$ge in Schedule oder Beladedefinition, dann setzen wir das ganze trotzdem auf okay
// --------------------------------------------------------------------------------------------------------------------
if li_ret = 0 then
	return false
elseif li_ret = 2 then

	if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"of_generate_schedule_1_ds_cen_out_after_generate_flights"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
	
	// --------------------------------------------------------------------------------------------------------------------
	// Pr$$HEX1$$fc00$$ENDHEX$$fung der generierten Daten vor dem Speichern
	// --------------------------------------------------------------------------------------------------------------------
	guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] of_validation start") // 21.06.2012 HR:
	
	of_validation()
	
	guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] Rows in dsCenOut after validation: "+string(dsCenOut.rowcount()))

	if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"of_generate_schedule_2_ds_cen_out_after_validation"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
	
	// --------------------------------------------------------------------------------------------------------------------
	// HR 26.08.2008: CBASE-DE-EM-2046: Legnummer neu durchnummerieren und Zeiten anpassen
	// --------------------------------------------------------------------------------------------------------------------
	of_reorg_legs()
	if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"of_generate_schedule_3_ds_cen_out_after_reorg"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
	guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] Rows in dsCenOut after reorg_legs: "+string(dsCenOut.rowcount()))
	
	// --------------------------------------------------------------------------------------------------------------------
	// 20.05.2020 HR: Nach der Erstellung der Fl$$HEX1$$fc00$$ENDHEX$$ge speichern wir diese ggf erst mal
	// --------------------------------------------------------------------------------------------------------------------
	if bSaveFlightByFlight then
		if of_update_flights(1, 0) = -1 then
			guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] In of_update_flights ist was schief gelaufen, daher raus hier")
			rollback using sqlca;	
			return false
		end if
	end if
	...
	guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] Rows in dsCenOut after create handling: "+string(dsCenOut.rowcount()))
	if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"of_generate_schedule_4_ds_cen_out_after_handling"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
	...
	// ---------------------------------------------------------	
	if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"cen_out_upd.xlsx", XLSX!, true)
	...
	if ii_create_checkpts  = 1 then
		...
		guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] After create Checkpoints") 
	end if
	
	guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] of_update start") 
	
	if bSaveFlightByFlight then
		if of_update_flights(3, 0) = -1 then
			guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] In of_update_flights(3) ist was schief gelaufen, daher raus hier")
			rollback using sqlca;	
			return false
		end if
	else
	...
	guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] of_update finish") 
	...
	// --------------------------------------------------------------------------------------------------------------------
	// --------------------------------------------------------------------------------------------------------------------
	// 22.05.2020 HR: Wenn wir Flugweise commiten, dann haben wir die History schon geschrieben
	// --------------------------------------------------------------------------------------------------------------------
	if not bSaveFlightByFlight then

		guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] of_update_history start") 
	
		If not of_update_history() Then
			rollback using sqlca;	
			return False
		End if
		guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] of_update_history finish") 
	...
	if ii_aut_mahlzeitenverteilung = 1 then
		if not of_generate_flightcalcjobs(10, dsCenOut, 0) then
			return false
		end if
		guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] mealdistribution jobs created")
	end if
	
	// 06.09.2016 HR: wenn eingeschaltet und Generierung erfolgrech, dann FreeceFlight-Auftrag f$$HEX1$$fc00$$ENDHEX$$r FlightCalc erstelllen
	// 11.04.2019 HR: wir m$$HEX1$$fc00$$ENDHEX$$ssen zwischen Prod / Preprod / beide unterscheiden
	if  ii_freeze >= 1 then
		if ii_freeze = 1 or ii_freeze = 3 then
			if not of_generate_flightcalcjobs(15, dsCenOut, 0) then
			...
			guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] freeze jobs created")
		end if
		...
		if ii_freeze = 2 or ii_freeze = 3 then
			...
			guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] preprod freeze jobs created")
		end if
	end if
	...
	// --------------------------------------------------------------------------------------------------------------------
	// 09.06.2016 HR: CBASE-NAM-CR-16008: Wir erstellen Doc-Jobs
	// --------------------------------------------------------------------------------------------------------------------
	if ii_document_generation = 1 then
		of_generate_docengine_jobs()
		guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] docengine jobs created")
	end if
	
	
	// --------------------------------------------------------------------------------------------------------------------
	// 24.01.2018 HR: request #2893: Erweiterung f$$HEX1$$fc00$$ENDHEX$$r BRU: Nachberechnung von Fl$$HEX1$$fc00$$ENDHEX$$gen mit verwendeten MehrlegCalcIDs
	// --------------------------------------------------------------------------------------------------------------------
	datastore lds 
	lds = create datastore
	lds.dataobject="dw_cen_out_with_multilegcalcids"
	lds.settransobject(SQLCA)
	
	lds.retrieve(sclient, sunit, lAirlineKey, dGenerationDate)
	if not of_generate_flightcalcjobs(1, lds, 0) then
		destroy lds
		return false
	end if
...
// --------------------------------------------------------------------------------------------------------------------
if  iJob_Type <> 170 and iJob_Type <> 180 then
	If not of_write_Job_history() Then
		of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline,string(dGenerationDate,s_app.sDateformat),"Can't write into table job_history.")
		rollback using sqlca;
		return False
	Else
		of_write_protocol(iJob_Type,iGenerierungsstatus,1,iInfo,sAirline,string(dGenerationDate,s_app.sDateformat),"Successfully generated in " + string ((lTimeEnd - lTimeStart) / 1000 , "0.000") + " seconds.") 
		guoLog.uf_allways("["+ this.classname( )+".of_generate_schedule] Successfully generated "+string(dsCenOut.rowcount())+" Flights in " + string ((lTimeEnd - lTimeStart) / 1000 , "0.000") + " seconds.") 
		commit using sqlca;
		return True
	End if
else
...
for i = 1 to dsCenOutPax.RowCount()
	...
	if lFind > 0 then
		...
		guoLog.uf_debug("["+ this.classname( )+".of_change_pax] class " + dsCenOutPax.GetItemString(i,"cclass") +": Change NPAX_SPML to " + string(lspml_act))
		...
		guoLog.uf_debug("["+ this.classname( )+".of_change_pax] class " + dsCenOutPax.GetItemString(i,"cclass") +": Change NPAX_SPML => 0 ")
	end if
	...
	if lFlightStatus = 2 then
		...
		if dsCenOutPax.GetItemNumber(i,"npax_spml") <> 0 then
			dsCenOutPax.SetItem(i,"npax_spml",0)
			dsCenOutPax.SetItem(i,"status_npax_spml",1)
			guoLog.uf_debug("["+ this.classname( )+".of_change_pax] class " + dsCenOutPax.GetItemString(i,"cclass") +": Change NPAX_SPML => 0 REQ")
		end if
	end if
next
...
uo_generate_datastore	dsSupplierArlineAssign

dsSupplierArlineAssign = create uo_generate_datastore	
...
// 15.08.2025 HR: request #12288 
// --------------------------------------------------------------------------------------------------------------------
lResultKeyGroup						= dsCenOut.Getitemnumber(1,"NRESULT_KEY_GROUP")
ii_leg_number							= lLegNumber
sRoutingShortText 				= dsCenOut.Getitemstring(1,"CROUTING")
dtDepartureTimeLocal 			= dsCenOut.Getitemdatetime(1,"ddeparture_time_loc")
	 
// --------------------------------------------------------------------------------------------------------------------
// 26.02.2019 HR: Wir setzen die Sprache auf die Betriebssprache
// --------------------------------------------------------------------------------------------------------------------
f_change_pl_language(sUnit, false)
...
ii_new_cfs_handlinggen = integer(f_mandant_profilestring(sqlca, sClient, "Generierung","NewCFSHandlingGen","0"))
if ii_new_cfs_handlinggen = 1 then
	guoLog.uf_allways("["+ this.classname( )+".of_change_handling_objects] NewCFSHandlingGen is on.")
end if
...
// --------------------------------------------------------------------------------------------------------------------
// 17.03.2017 HR: Wenn der Flightcalc seine Job-Nr eintr$$HEX1$$e400$$ENDHEX$$gt, dann schauen wir nach, ob zum Job 
//                            auch das Ausz$$HEX1$$e400$$ENDHEX$$hlungsfenster gef$$HEX1$$fc00$$ENDHEX$$llt wurde und laden dieses
// --------------------------------------------------------------------------------------------------------------------
if il_flightcalc_jobnr > 0 then
	uo_generate_meals.uf_ask4passenger_flightcalc( il_flightcalc_jobnr )
end if
...
// --------------------------------------------------------------------------------------------------------------------
// 24.01.2023 HR: AlmID 6658: Dynamic Meal CBASE Integration
// --------------------------------------------------------------------------------------------------------------------
if not ib_use_dynamic_meals then
	uo_generate_meals.ib_use_dynamic_meals = false
	uo_generate_meals.idsCITPFlightDataPreorder.reset()
	if isvalid( s_change.dsCenExternalPreorder) then
		if  s_change.dsCenExternalPreorder.rowcount()>0 then
			uo_generate_meals.ib_use_dynamic_meals = true
			i = s_change.dsCenExternalPreorder.rowscopy(1,  s_change.dsCenExternalPreorder.rowcount(), primary!, uo_generate_meals.idsCITPFlightDataPreorder, 1, primary!)
			
			if i = -1 then
				guoLog.uf_error("["+ this.classname( )+".of_change_handling_objects] Error rowscopy from " + s_change.dsCenExternalPreorder.dataobject + " to " + uo_generate_meals.idsCITPFlightDataPreorder.dataobject)
			end if
		end if
	end if
end if
...
if ibGenerateLoading then
	// --------------------------------------------------------------------------------------------------------------------
	// 15.08.2025 HR: request #12288 Wir brauchen die Paxwerte f$$HEX1$$fc00$$ENDHEX$$r alle Legs
	// --------------------------------------------------------------------------------------------------------------------
	datastore lds
	lds = create datastore 
	lds.dataobject = "dw_cen_out_pax_other_legs"
	lds.settransobject(SQLCA)
	lds.retrieve(lresultkey, lresultkeygroup)
	
	if lds.rowcount()>0 then
		if lds.rowscopy(1, lds.rowcount(), primary!, dsCenOutPax, dsCenOutPax.rowcount(), primary!) = 1 then
			guoLog.uf_allways("["+ this.classname( )+".of_change_handling_objects] Copy "+string(lds.rowcount()) +" Rows for other Legs to dsCenOutPax ("+string(dsCenOutPax.rowcount())+")"  )
		else
			guoLog.uf_error("["+ this.classname( )+".of_change_handling_objects] Error Rowcopy other Legs :  lds.dataobject("+lds.dataobject+") => dsCenOutPax.dataobject("+dsCenOutPax.dataobject+")")
		end if
	else
		guoLog.uf_debug("["+ this.classname( )+".of_change_handling_objects] No Pax for other Legs found lresultkey("+string(lresultkey)+"), lresultkeygroup("+string(lresultkeygroup)+")")
	end if
	
	destroy lds
	
	idsOldCenOutLoading = s_change.dsOldCenOutLoading
	of_generate_loading()
	idsCenOutLoading.rowscopy( 1, idsCenOutLoading.rowcount(), primary!, s_change.dsCenOutLoading, 1, primary!)
end if
...
if f_mandant_profilestring(sqlca, sClient, "Generierung","FillPPM","0") = "0" then 
	...
	guoLog.uf_warn("["+ this.classname( )+".of_change_handling_objects] Generate PPM-Data is switched off")	
else
...
if dsCenOutPPM.update() = -1 then
	...
	lSQLRow  		= dsCenOutPPM.lSQLErrorRow
	sSQLErrorText	= dsCenOutPPM.sSQLErrorText
	guoLog.uf_error("["+ this.classname( )+".of_change_handling_objects] Can't write generated dsCenOutPPM to database, sqlcode " + string(lSQLCode))
else
	guoLog.uf_info("["+ this.classname( )+".of_change_handling_objects] Rows in dsCenOutPPM: "+string(dsCenOutPPM.rowcount()))	
end if
...
if dsCenOutPPMStowages.update() = -1 then
	...
	lSQLRow  		= dsCenOutPPMStowages.lSQLErrorRow
	sSQLErrorText	= dsCenOutPPMStowages.sSQLErrorText
	guoLog.uf_error("["+ this.classname( )+".of_change_handling_objects] Can't write generated dsCenOutPPMStowages to database, sqlcode " + string(lSQLCode))
else
	guoLog.uf_info("["+ this.classname( )+".of_change_handling_objects] Rows in dsCenOutPPMStowages: "+string(dsCenOutPPMStowages.rowcount()))	
end if
...
// 24.01.2023 HR: AlmID 6658: Dynamic Meal CBASE Integration
// --------------------------------------------------------------------------------------------------------------------
if uo_generate_meals.ib_use_dynamic_meals then
	if isvalid( s_change.dsCenExternalPreorder ) then
		s_change.dsCenExternalPreorder.reset()
	
		if uo_generate_meals.idsCITPFlightDataPreorder.rowcount()>0 then
			i = uo_generate_meals.idsCITPFlightDataPreorder.rowscopy(1,  uo_generate_meals.idsCITPFlightDataPreorder.rowcount(), primary!, s_change.dsCenExternalPreorder, 1, primary!)
			if i = -1 then
				guoLog.uf_error("["+ this.classname( )+".of_change_handling_objects] Error rowscopy (back) from " + uo_generate_meals.idsCITPFlightDataPreorder.dataobject + " to " +  s_change.dsCenExternalPreorder.dataobject)
			end if
		end if
	end if
end if
...
// --------------------------------------------------------------------------------------------------------------------
// 26.02.2019 HR: Wir setzen die Sprache auf die Usersprache
// --------------------------------------------------------------------------------------------------------------------
f_change_pl_language(sUnit, true)
...
Long		lEnd
Boolean	bReturn
boolean  lbUseNewJobOrder

guoLog.uf_debug("["+ this.classname( )+".of_generate_jobs]  Start")
// -----------------------------------------------------------
// Job Liste erstellen
// 10 Tagesflugplan Neuanlage 			pro Betrieb
// 20 Tagesflugplan Update 					pro Betrieb
...
// --------------------------------------------------------------------------------------------------------------------
// 22.05.2020 HR: Neuer Schalter: Speichern pro Flug 
// --------------------------------------------------------------------------------------------------------------------
bSaveFlightByFlight = ( f_mandant_profilestring(sqlca, s_app.sMandant, "Generierung", "SaveFlightByFlight", "0") = "1")

// --------------------------------------------------------------------------------------------------------------------
// 11.08.2021 HR:  #7982 change priority of generations
// --------------------------------------------------------------------------------------------------------------------
lbUseNewJobOrder = ( f_mandant_profilestring(sqlca, s_app.sMandant, "Generierung", "UseNewJobOrder", "0") = "1")

// 31.07.2019 HR: Wir setzen Umgebungsvariable auf 1 damit alles wie vorher ist und initialisieren die Variable mit 0, damit von extern bei of_update der Tag nicht gel$$HEX1$$f600$$ENDHEX$$scht wird.
ii_delete_flights 		= 1

// 19.12.2018 HR: issue #4476 One Time Generation Reload Joblist after everey Job
ib_onetimegen_exit = false
...
If sClientParm <> "" and sUnitParm <> "" Then
	...
	//MB 27.06.2016 Neuer Filter f$$HEX1$$fc00$$ENDHEX$$r Paralleverarbeitung
...
if lbUseNewJobOrder then
	if ii_generate_type <> 2 then
		dsjobs2generate.SetSort("njob_kind A, compute_sapjob A, njob_prio A, ndays_offset A, cclient A, cunit A, nairline_key A, comp_njob_type A")
	else
		dsjobs2generate.SetSort("njob_prio A, ndays_offset A, cclient A, cunit A, nairline_key A, comp_njob_type A")
	end if
else
	if ii_generate_type <> 2 then
		dsjobs2generate.SetSort("njob_kind A, compute_sapjob A, njob_prio A, cclient A, cunit A, comp_njob_type A, ndays_offset A, nairline_key A")
	else
		// --------------------------------------------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------------------------------------------
if bExtendedLog then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs]  ")
	guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs]  ")
	guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] #######################################################################################################")
	guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] Processing joblist for date " + String(dgenerate_date)+ "   Jobs in Queue: "+string(dsjobs2generate.rowcount()))
	guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] Debug Level " + String(this.idebug_level))
	if bSaveFlightByFlight then
		guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] Save Flight by Flight is ON !!!")
	end if
	// --------------------------------------------------------------------------------------------------------------------
	// 11.05.2022 HR:
	// --------------------------------------------------------------------------------------------------------------------
	if lbUseNewJobOrder then
		guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] Process jobs in new Order (AlmID 7982) !!!")
	end if

	guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] #######################################################################################################")
end if

if guolog.uf_get_loglevel() > 5 then
...
For i = 1 to dsjobs2generate.rowcount()
	//10.06.2024 HR: Logging Job-Nr and Result_key to Graylog
	gll_log_job_key		= dsJobs2Generate.Getitemnumber(i,"njob_key")
	
	// --------------------------------------------------------------------------------------------------------------------
	// 05.03.2018 HR: Da es immer mal wieder zu Verbindungsabbr$$HEX1$$fc00$$ENDHEX$$che w$$HEX1$$e400$$ENDHEX$$rend des Laufs kommt, pr$$HEX1$$fc00$$ENDHEX$$fen
	//                        wir vor jedem Job, ob wir noch eine Verbindung haben
	// --------------------------------------------------------------------------------------------------------------------
	if of_checkconnection() <> 0 then
		guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] We stop processing, due to dabase problems ")
		return false
	else
	...
	if of_service_alive() = 1 then
		guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] Service is paused by table SYS_SERVICES_ALIVE")
		return false
	else
	...
	ii_job_prio										= dsJobs2Generate.Getitemnumber(i,"njob_prio") // 11.05.2022 HR: Jobprio f$$HEX1$$fc00$$ENDHEX$$rs Logging merken
	...
	ii_document_generation			= dsJobs2Generate.Getitemnumber(i, "ndocument_generation") 	// 09.06.2016 HR:

	ii_freeze											= dsJobs2Generate.Getitemnumber(i, "nfreeze") 							// 02.09.2016 HR: 
	ii_newFlightState						= dsJobs2Generate.Getitemnumber(i, "nflight_state") 					// 02.09.2016 HR: 

	ib_forecast_relevant					= ( dsJobs2Generate.Getitemnumber(i, "nforecast_relevant")  = 1 ) 	// 08.11.2019 HR: issue 5710: Forecast Ramp Up Extension
	ib_use_comapp_data					= ( dsJobs2Generate.Getitemnumber(i, "ndata_source")  = 1 ) 		// 04.12.2019 HR:
		
	// --------------------------------------------------------------------------------------------------------------------
	//  16.01.2023 HR: AlmID 6658: Dynamic Meal CBASE Integration
	// --------------------------------------------------------------------------------------------------------------------
	ib_use_dynamic_meals				=  ( dsJobs2Generate.Getitemnumber(i, "ndynamic_meals")  = 1 ) 
	uo_generate_meals.ib_use_dynamic_meals = ib_use_dynamic_meals
	
	// 27.02.2019 HR:
	of_get_unit_language(sUnit)
	...
	if bExtendedLog then	
	 	ls_jobname = this.of_get_job_name(i)
	 	guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] Starting job   # " + String(i, "0000") + " - "  + ls_jobname )
	end if
	...
	// --------------------------------------------------------------------------------------------------------------------
	if iActiv = 0 and bAdmin = false Then
		 guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] Jobs for Airline are deactivated!")
	else
		
		choose case iJob_Type
			case 10 // 10 Tagesflugplan Neuanlage 			pro Betrieb
				if ii_newFlightState = 1 then
		...
		//			 of_generate_explosion()
			...
			case 170 // 170 Asynchrone Generierung (Tagesflugplan + Matdispo $$HEX1$$fc00$$ENDHEX$$ber OnlineExplosion)
				...
				if ii_newFlightState = 1 then
				 ...
				 if bReturn then
					bReturn = of_generate_explosionjobs(1)
					 sGenerierungsstatus 	= "Asynchron + OE-Jobs"
				end if
				
				 
			case 180 //180 Tagesflugplan CCS (Tagesflugplan + Matdispo nur Level 1)
				if ii_newFlightState = 1 then
					iGenerierungsstatus 	= 1
					sGenerierungsstatus 	= "Insert"
				else
				...
				bReturn = of_generate_schedule(True) 
				 ...
				 if bReturn then
					iGenerierungsstatus 	= 4
					bReturn = of_generate_explosion_level1()
					sGenerierungsstatus 	= "Tagesflugplan CCS + MatDispo"
				end if
				
			case 190 // 190 Erstelle Checkpoints	
				 iGenerierungsstatus 	= 1
				 sGenerierungsstatus 	= "Insert"
				 bReturn = of_generate_checkpts()

			case 200 // 17.05.2023 HR: 8456 new generation type to close flights
				iGenerierungsstatus 	= 2
				sGenerierungsstatus 	= "Close Flights"
				bReturn = of_generate_flightclose()
				
			case 210 // 17.05.2023 HR: 8358 2 new generation jobs requested
				iGenerierungsstatus 	= 1
				sGenerierungsstatus 	= "Distribution"
				bReturn = of_generate_distribution()
				
			case 220 // 17.05.2023 HR: 8358 2 new generation jobs requested
				iGenerierungsstatus 	= 2
				sGenerierungsstatus 	= "Flight Calculation"
				bReturn = of_generate_flightcalc()
				
			case else
				guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] Jobstype "+string(iJob_Type)+" not defined!")
	...
	if bReturn = false then
		if ii_generate_jobtype=2 then
			...
			of_write_job_history_once_end(2)	
		end if

		guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs]         job   # " + String(i, "0000") + " - " + sGenerierungsstatus + " - Returned FALSE!!")
	...
	if bExtendedLog then
		...
		guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] Processing job   # " + String(i, "0000") + " of " + String(dsjobs2generate.rowcount(), "0000") + " - "  + ls_jobname + " took " + string((lEnd - lStart) / 1000, "0.00") + " seconds")
	end if
	...
	if ii_generate_jobtype=2 then
		...
		if bExtendedLog then
			guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] Exit Loop due to Onetimejob finsihed")
		end if
		exit 
	end if
...
if bExtendedLog then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_jobs] Finished")
else
	guoLog.uf_debug("["+ this.classname( )+".of_generate_jobs] Finished")
end if
...
// 29.11.2018 HR: request #4339 wir gehen ab jetzt immer von Heute in die Vergangenheit
//                        wenn zu generierender Wochentag dem heutigen entspricht, dann nehmen wir die 
//                        Abfertigung von heute ansonsten gehen wir weiter in die Vergangenheit
// ---------------------------------------------------
if daynumber(today()) <> daynumber(dGenerationDate) then
	lKey = daynumber(today()) - daynumber(dGenerationDate)
	if lkey < 0 then lkey += 7
else
	lkey =  0
end if
dUpdate7Date		= Relativedate( today(), -1 * lkey)
...
//-------------------------------------------------------------------------------------
if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"ds_cen_out_validation_1_"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
...
guoLog.uf_info("["+ this.classname( )+".of_validation] Rows in dsCenOut after Step 1: "+string(dsCenOut.rowcount()))
...
if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"ds_cen_out_validation_2_"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
guoLog.uf_info("["+ this.classname( )+".of_validation] Rows in dsCenOut after Step 2: "+string(dsCenOut.rowcount()))
...
if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"ds_cen_out_validation_3_"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
...
guoLog.uf_info("["+ this.classname( )+".of_validation] Rows in dsCenOut after Step 3: "+string(dsCenOut.rowcount()))
...
if not bCFSAirline then
	...
	dsCenOut.Sort()
	if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"ds_cen_out_validation_4_"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
...
guoLog.uf_info("["+ this.classname( )+".of_validation] Rows in dsCenOut after Step 4: "+string(dsCenOut.rowcount()))

dsCenOut.setsort("nrouting_group_key,  nleg_number")
dsCenOut.Sort()

if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"ds_cen_out_validation_5_"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
...
public function integer of_build_arrays (uo_generate_datastore odw, string scolumn);long lRow
...
String 		sReturn
Long 			lType
boolean  	lb_paxtype, lb_parameter, lb_forecast
...
sReturn +=  left(dsJobs2Generate.GetitemString(lRow,"loc_jobs_types_ctext")+fill(" ", ii_loc_jobs_types_ctext_length), ii_loc_jobs_types_ctext_length)

lType 	 			= dsJobs2Generate.Getitemnumber(lRow,"njob_type")
Choose Case lType
	Case 30, 40 , 50, 90, 100, 110, 120, 130, 140, 150, 160, 190
		lb_parameter 	= false
	case 200, 210, 220
		lb_paxtype 		= false
		lb_parameter 	= false
...
if lb_parameter then
	...
	Choose Case lType
		...
		case 7 // 26.06.2023 HR: #8552 add new columns to allow Ramp Box to be maintained here 
			sReturn += 	"CFS Ramp Box"
		Case else
...
sReturn += 	" (Prio " + string(dsJobs2Generate.Getitemnumber(lrow, "njob_prio") )+")"

if lb_forecast then
	// 08.11.2019 HR: AlmID 5710: Forecast Ramp Up Extension
	if dsJobs2Generate.Getitemnumber(lrow, "nforecast_relevant")  = 1  then
		sReturn += 	" [Check if Flight is forecast relevant]"
	else
		sReturn += 	" [no forecast check]"
	end if
end if
...
If sqlca.sqlcode <> 0 then
	...
	guoLog.uf_allways("["+ this.classname( )+".of_delete_pps_changes] Delete " + string( sqlca.sqlnrows) + " rows from loc_pps_object_changes <= " + string(dGenerationDate)+" and Unit "+sunit)
end if
...
If sqlca.sqlcode <> 0 then
	...
	guoLog.uf_allways("["+ this.classname( )+".of_delete_pps_changes] Delete " + string( sqlca.sqlnrows) + " rows from cen_pps_object_event_map <= " + string(dGenerationDate))
end if
...
If sqlca.sqlcode <> 0 then
	...
	guoLog.uf_allways("["+ this.classname( )+".of_delete_pps_changes] Delete " + string( sqlca.sqlnrows) + " rows from cen_pps_object_state_map <= " + string(dGenerationDate))
end if
...
If dsGenerateSchedule.rowcount() <= 0 Then
	...
	guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_by_fre] dsGenerateSchedule.RowCount()=" + string(dsGenerateSchedule.rowcount()) + &
...
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_by_fre] cached " + string( dsCenOutCache.RowCount()) + " flights for " + string(dGenerationDate) + " / " + sUnit + " / " + string(lAirlineKey))
...
If sqlca.sqlcode <> 0 then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_by_fre] delete from cen_out - error " + 	string(sqlca.sqldbcode) + ": " + sqlca.sqlerrtext)
	of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline,string(dGenerationDate,s_app.sDateformat),"Can't delete flight schedule, sqlcode " + string(sqlca.sqlcode) + ".")
	rollback using sqlca;
	return False
end if
...
guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] lRoutingPlanKey=" + string(lRoutingPlanKey) )
...
For I = 1 To dsGenerateRoutingPlan.RowCount()
	...
	*/
	...
	guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] processing flight " + string(lFlightNumber) + ", nrouting_group_key = " + string(lCurrentGroupKey))
	...
	If (ll_flightGroup <> ll_flightGroupOld) Or &
		...
		If ll_flightGroup <> ll_flightGroupOld Then
			guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] Group Change for nrouting_group_key = " + String(ll_flightGroupOld) )
		Else
			guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] Flight Change for nflight_number = " + String(ll_flightNrOld) + &
		...
		*/
		...
		if bCharter then
			...
			if dsCharterMemory.RowCount() > 0 then
				dsCenOut.SetFilter("")
				dsCenOut.Filter()
				guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] dsCharterMemory.RowCount()=" + string(dsCharterMemory.rowcount()) &
				...
				dsCenOut.Filter()
				guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] Filter = " + sFilter + " => dsCharterMemory.RowCount()=" + string(dsCharterMemory.rowcount()) &
								+ " dsCenOut.RowCount()=" + string(dsCenOut.rowcount()))
				//
				// Weicht Anzahl Legs ab?
				//
				if dsCenOut.RowCount() <> dsCharterMemory.RowCount() then
					guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] bDeleteLegs = true because of Rowcount" )
					bDeleteLegs = true
				end if
					...
					for k = 1 to dsCharterMemory.RowCount()
						...
						if dsCenOut.GetItemNumber(j,"nleg_number") = dsCharterMemory.GetItemNumber(k,"nleg_number") then
							...
							if dsCenOut.GetItemNumber(j,"ntlc_from") <> dsCharterMemory.GetItemNumber(k,"ntlc_from") or &
								...
								guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] bDeleteLegs = true because Leg " + string(dsCenOut.GetItemNumber(j,"nleg_number")) + "  " + string(dsCenOut.GetItemNumber(j,"ntlc_from")) + " <> " + &
								...
								guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] bDeleteLegs = true (1)" )
								bDeleteLegs = true
							end if
				...
				if bDeleteLegs then
					guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] bDeleteLegs set nrouting_group_key=" + string(lKey) )
				end if
...
if bCharter then
	...
	//
	if dsCharterMemory.RowCount() > 0 then
		guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] final dsCharterMemory.RowCount()=" + string(dsCharterMemory.rowcount()) &
						+ " dsCenOut.RowCount()=" + string(dsCenOut.rowcount()))
		bDeleteLegs = false
		//
		// Kontrolle: dsCharterMemory des vorherigen Flugs gegen dsCenOut
				...
				if dsCenOut.GetItemNumber(j,"nleg_number") = dsCharterMemory.GetItemNumber(k,"nleg_number") then
					...
					if dsCenOut.GetItemNumber(j,"ntlc_from") <> dsCharterMemory.GetItemNumber(k,"ntlc_from") or &
						...
						guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] bDeleteLegs = true because Leg " + string(dsCenOut.GetItemNumber(j,"nleg_number")) + "  " + string(dsCenOut.GetItemNumber(j,"ntlc_from")) + " <> " + &
								string(dsCharterMemory.GetItemNumber(k,"ntlc_from")) + " or " + string(dsCenOut.GetItemNumber(j,"ntlc_to")) + " <> " + &
								string(dsCharterMemory.GetItemNumber(k,"ntlc_to")) )
						guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_by_fre] bDeleteLegs = true (2)" )
						bDeleteLegs = true
					end if
...
//dsCenOut.SaveAs("c:\temp\cbase\cen_out.xlsx", XLSX!, true)
...
if dsCenOut.rowcount()=0 then
	guoLog.uf_allways("["+ this.classname( )+".of_write_flights] No Rows in dsCenOut")
	return 0
end if
...
ls_checkflights += string(ll_sumflightnumbers)+".XLSX"

//Datastore speichern
i = dsCenOut.saveas(ls_checkflights_path+ls_checkflights, XLSX!, true)
if i=1 then
	guoLog.uf_allways("["+ this.classname( )+".of_write_flights] File "+ls_checkflights_path+ls_checkflights+" created")
else
	guoLog.uf_error("["+ this.classname( )+".of_write_flights] Error creating File "+ls_checkflights_path+ls_checkflights)
end if
...
//  14.10.2025    1.1      Heiko Rothenbach  #13038 Flight Generation does not considers Polaris "Seat Configuration"
// --------------------------------------------------------------------------------


string	sReturn

select CBASE_FUNCTIONS.pf_get_aircraft_config(:arg_aircraftkey, -1) 
into :sReturn
from dual;

if sqlca.sqlcode <> 0 then
		guoLog.uf_error("["+ this.classname( )+".of_get_configuration] Error Get Default Version for ac_key " + string(arg_aircraftkey) + ": " +string(sqlca.sqlcode))
		return " "
end if
...
lds_ac = create uo_generate_datastore
...
uo_generate_datastore 	lds_aqp
long 			i, j, lrow, lnew, lkeychange
...
lds_aqp = create uo_generate_datastore
...
for i=1 to dsCenOut.rowcount()
	...
	// 12.04.2021 HR: NAM hat den gleichen Flug einmal als LEG3 und einmal als LEG1 Flug f$$HEX1$$fc00$$ENDHEX$$r einen Tag generiert, daher pr$$HEX1$$fc00$$ENDHEX$$fen wir zuerst, ob wir den Flug mit der Legnummer haben
	lfound=dsResultkeys.find("nqp = 0 and csearch = '"+ls_CFLIGHT_KEY+"' and nleg_number=" + string(dsCenOut.GetItemNumber(i,"nleg_number")) ,1,dsResultkeys.rowcount())
	if lfound = 0 then
		// 12.04.2021 HR: und danach wie gehabt ohne Leg-Nr
	...
	if lfound>0 then
		 ...
		 if llresultOld <> ll_resultkey then
			...
			next
			guoLog.uf_info("["+ this.classname( )+".of_generate_qp] Change  "+string(dsCenOutQP.rowcount())+" Rows from RESULT_KEY  "+string(llresultOld)+" to "+string(ll_resultkey))
...
guoLog.uf_allways("["+ this.classname( )+".of_generate_qp] " + string(lds_aqp.rowcount()) + " QP-Rows for Airline "+string(lAirlineKey)+" - Rows in Cen_out: "+string(dsCenOut.rowcount())+" - Rows in CenOutQP: "+string(dsCenOutQP.rowcount())+" - New: "+string(lnew) + " - Keychanged: "+string(lkeychange))
...
for i=1 to dsCenOut.rowcount()
	...
	// 12.04.2021 HR: NAM hat den gleichen Flug einmal als LEG3 und einmal als LEG1 Flug f$$HEX1$$fc00$$ENDHEX$$r einen Tag generiert, daher pr$$HEX1$$fc00$$ENDHEX$$fen wir zuerst, ob wir den Flug mit der Legnummer haben
	lfound=dsResultkeys.find("nresuse = 0 and csearch = '"+ls_CFLIGHT_KEY+"' and nleg_number=" + string(dsCenOut.GetItemNumber(i,"nleg_number")) ,1,dsResultkeys.rowcount())
	if lfound = 0 then
		// 12.04.2021 HR: und danach wie gehabt ohne Leg-Nr
	...
	if lfound>0 then
		 ...
		 if sqlca.sqlcode<0 then
			guoLog.uf_error("["+ this.classname( )+".of_regen_keys] Error Updating CEN_REQUEST for Flight "+ls_CFLIGHT_KEY+": "+SQLCA.SQLErrText )
		end if
...
//			 if sqlca.sqlcode<0 then
//				guoLog.uf_error("["+ this.classname( )+".of_regen_keys] Error Updating CEN_OUT_QP for Flight "+ls_CFLIGHT_KEY+": "+SQLCA.SQLErrText )
//			end if
...
//
// --------------------------------------------------------------------------------
uo_generate_datastore 	lds_acsearch, lds_classes
...
guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] " +ls_flgnr+"Anzahl m$$HEX1$$f600$$ENDHEX$$glicher Regeln f$$HEX1$$fc00$$ENDHEX$$r Set "+sAdjustmentSet+": "+string(dsLocal_adjustments.rowcount()))
...
// --------------------------------------------------------------------------------------------------------------------
lds_classes = create uo_generate_datastore
...
for i=1 to dsCenOutPax.rowcount()
	...
	guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] " +ls_flgnr+"Paxanpassung Klasse "+ls_cclass+" wegen "+ls_kind +"-Regel : Pax Alt: "+string(ll_pax_old)+" Pax Neu: "+string(ll_pax_new)+" Offset "+ls_offset)
next
...
if  li_findversion=1 then
	...
	if ll_found=1 then
		...
		// --------------------------------------------------------------------------------
		lds_acsearch = create uo_generate_datastore
		...
		for i=1 to dsCenOutPax.rowcount()
			...
			if ll_found=0 then 
				if lds_acsearch.rowcount()>0 then
					...
					guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] " +ls_flgnr+"Versionsanpassung: kein Zeile mehr in lds_acsearch. Paxzeile "+ string(i)+"; ls_version: "+ls_version +";ls_pax: "+ls_pax)
					ll_found 	= -1
					exit
				end if
			...
			guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] "+ ls_flgnr+"Versionsanpassung: Versionssuche Filter: "+ls_filter +" Count "+String(lds_acsearch.rowcount()))
		next
		...
		if ll_found<> -1 then
			...
			if ls_version <>  dsCenOut.GetItemString(arg_lrow,"cconfiguration") then
				guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] " +ls_flgnr+"Versionsanpassung: Alt: "+ dsCenOut.GetItemString(arg_lrow,"cconfiguration")+"; Pax: "+ls_pax +"; Neu: "+ls_version)
		...
		guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] " +ls_flgnr+"Versionsanpassung: Keine Versionsanpassung n$$HEX1$$f600$$ENDHEX$$tig, da Paxe: "+ ls_pax +" in Version "+ls_version +" passen.")
	end if
	...
	if li_overload[i]=0 then
		if ll_pax_old > ll_version then
			...
			if ls_upclass[i]="none" then
				guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] " +ls_flgnr+"Paxanpassung Klasse "+ls_cclass+", da $$HEX1$$dc00$$ENDHEX$$berbeladung abgeschnitten werden soll. Pax Alt: "+string(ll_pax_old)+" Pax Neu: "+string(ll_version)+" keine Upgradeklasse definiert")
			else
				guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] " +ls_flgnr+"Paxanpassung Klasse "+ls_cclass+", da $$HEX1$$dc00$$ENDHEX$$berbeladung abgeschnitten werden soll. Pax Alt: "+string(ll_pax_old)+" Pax Neu: "+string(ll_version)+" Upgrade "+string(ll_pax_new)+" Paxe ("+string( li_upgrade[i])+"%) nach "+ ls_upclass[i] )
				...
				if ll_found>0 then
					...
					guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] " +ls_flgnr+"                     -> Anpassung Klasse "+ ls_upclass[i]+" Pax Alt: "+string(ll_pax_old)+" Pax Neu: "+string(ll_pax_old + ll_pax_new))
				else
					guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] " +ls_flgnr+"                     -> Upgradeklasse "+ls_upclass[i]+" nicht gefunden")
				end if
			end if
		end if
	elseif  ll_pax_old > ll_version then
			guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] " +ls_flgnr+"keine Paxanpassung Klasse "+ls_cclass+", da $$HEX1$$dc00$$ENDHEX$$berbeladung gew$$HEX1$$fc00$$ENDHEX$$nscht")		
	end if
next
...
for i = 1 to  dsCenOutPax.rowcount() 
	...
	if ll_pax_old >= ll_version - li_red_add_delivery[i] and ll_pax_old < ll_version then
		dsCenOutPax.setitem(i,"npax", ll_version)
		guoLog.uf_debug("["+ this.classname( )+".of_recalc_pax] " +ls_flgnr+"Paxanpassung Nachfahrtenreduktion Klasse "+ls_cclass+" Pax old: "+string(ll_pax_old)+" Version: "+string(ll_version)+" FH ab "+string(ll_version - li_red_add_delivery[i])+" Paxe")
	end if 
next
...
integer  li_spml_new = 0
integer  li_spml_update = 0

if dsCITPFlightDataSPML.rowcount()=0 then 
	guoLog.uf_debug("["+ this.classname( )+".of_generate_spml_from_citp] No Rows in dsCITPFlightDataSPML")
	return true
end if
...
If bDelete = True Then
	...
	If SQLCA.SQLCODE <> 0 Then
		guoLog.uf_error("["+ this.classname( )+".of_generate_spml_from_citp] DELETE FROM cen_out_spml where nresult_key = "+string(lResultKey)+" => "+ string(SQLCA.SQLCODE))
		guoLog.uf_error("["+ this.classname( )+".of_generate_spml_from_citp] " + SQLCA.SQlerrtext)
		return False
	End if	
End if
...
lnreq_flight_key = dsCITPFlightDataSPML.GetItemnumber(1,"nreq_flight_key")


For i = 1 to dsCITPFlightDataSPML.Rowcount()

	If lnreq_flight_key <> dsCITPFlightDataSPML.GetItemnumber(i,"nreq_flight_key") Then Exit
	...
	if lFound <= 0 then
		guoLog.uf_error("["+ this.classname( )+".of_generate_spml_from_citp] cspml = '" + sSPML + "' and nairline_key = " + string(lAirlineKey) + " not found in dsValidSPML")
	...
	if lFind = 0 then
		...
		if lReturn > 0 then
			...
			dsCenOutNewSPML.SetItem(lReturn,"cspml_source", 	is_spml_source + " " + dsCITPFlightDataSPML.GetItemString(i,"cquery_period") )  // 23.04.2025 HR: Almid 11358 Flight Generation with SPML setting "Forecast" is ignoring SPMLs
...
guoLog.uf_debug( "["+ this.classname( )+".of_generate_spml_from_citp] 	Flightnumber=" + string(dsCenOut.getitemnumber(lcenoutrow, "nflight_number")) +" " +  dsCenOut.getitemstring(lcenoutrow, "ctlc_from") + dsCenOut.getitemstring(lcenoutrow, "ctlc_to")+": dsCenOutNewSPML.rowcount()=" + string(dsCenOutNewSPML.rowcount())+" Add new Rows: " + string(li_spml_new)+" Update Rows: " + string(li_spml_update))
...
If lScheduleKey = -1 Then
	guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": No valid flight schedule key available.")
	return False
End if	
...
lRoutingPlanKey = of_get_routingplan_key()
If lRoutingPlanKey = -1 Then
	guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": No valid loading definition key available.")
	return False
End if	
...
lTransActionKey = of_get_history_key()
If lTransActionKey = -1 Then
	guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": No valid loading history key available.")
	return False
End if
// ---------------------------------------------------------
// Retieve Traffic Areas
...
dsAirlineClasses.Retrieve(lAirlineKey)	
If dsAirlineClasses.Rowcount() <= 0 Then
	guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": No valid airline classes available.")
	return False
End if
...
// Erstellung der Fl$$HEX1$$fc00$$ENDHEX$$ge	CEN_OUT
// ---------------------------------------------------------
guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] Start generate Flights")
// --------------------------------------------------------------------------------------------------------------------
// Erstellung der Fl$$HEX1$$fc00$$ENDHEX$$ge	CEN_OUT
...
//	dsGenerateSchedule.DataObject 		= "dw_generate_schedule_all"
	...
	guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] of_generate_schedule: Rows in dsCenOut after creation (cfs): "+string(dsCenOut.rowcount()))
else
	of_generate_flights()
end if
guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] Rows in dsCenOut after creation: "+string(dsCenOut.rowcount()))
if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"of_compare_flights_1_ds_cen_out_after_generate_flights"+string(now(),"hhmmss")+".xlsx", XLSX!, true)

// ---------------------------------------------------------
// Pr$$HEX1$$fc00$$ENDHEX$$fung der generierten Daten vor dem Speichern
// ---------------------------------------------------------
of_validation()
guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] Rows in dsCenOut after validation: "+string(dsCenOut.rowcount()))
if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"of_compare_flights_2_ds_cen_out_after_validation"+string(now(),"hhmmss")+".xlsx", XLSX!, true)

// ---------------------------------------------------------
//Legnummer neu durchnummerieren und Zeiten anpassen
// ---------------------------------------------------------
of_reorg_legs()
guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] Rows in dsCenOut after reorg_legs: "+string(dsCenOut.rowcount()))
if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"of_compare_flights_3_ds_cen_out_after_reorg"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
...
dsTemp = create uo_generate_datastore
...
if ii_Debug_Save =1 then dsCenOutIst.SaveAs(is_Debug_save_path+"of_compare_flights_3a_dsCenOutIst"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
...
for i= 1 to dsCenOutIst.rowcount()
	...
	if lrow=0 then
		...
		guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] Flight to delete because not found "+ls_find)
...
if dsCenOutTemp.rowcount()>0 then
	...
	for i = 1 to dsCenOut.rowcount()
		...
		guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] New Flight to create "+ls_find)
	...
	if ii_Debug_Save =1 then dsCenOut.saveas(is_Debug_save_path+"of_compare_flights_4_dsCenOut_new_"+string(now(),"hhmmss")+".xlsx", XLSX!,TRUE)
	if ii_Debug_Save =1 then dsCenOutPax.saveas(is_Debug_save_path+"of_compare_flights_4_dsCenOutPax_new_"+string(now(),"hhmmss")+".xlsx", XLSX!,TRUE)

	// 09.08.2010 HR: Neuer Protokolleintrag
	guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": Anzahl S$$HEX1$$e400$$ENDHEX$$tze in dsCenOut "+string(dsCenOut.rowcount()))
	
	//Neue Fl$$HEX1$$fc00$$ENDHEX$$ge speichern
	if dsCenOut.update()=1 then
		if dsCenOutPax.update()<>1 then
			// 09.08.2010 HR: Ausgabe richtiger SQLCODE und TEXT
			guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": Fehler Speichern dsCenOutPax "+string(dsCenOutPax.lSQLErrorDBCode)+" "+dsCenOutPax.sSQLErrorText)
			rollback;
			...
			guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": Speichern erfolgreich")
		end if
	else
		// 09.08.2010 HR: Ausgabe richtiger SQLCODE und TEXT
		guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": Fehler Speichern dsCenOut "+string(dsCenOut.lSQLErrorDBCode)+" "+dsCenOut.sSQLErrorText)
		rollback;
...
if dsCenOutIst.update()<>1 then
	guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": Fehler Speichern dsCenOutIst "+string(dsCenOutIst.lSQLErrorDBCode)+" "+dsCenOutIst.sSQLErrorText)
	rollback;
	...
	guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": Speichern dsCenOutIst erfolgreich")
end if

if dsTemp.Update() <> 1 then
	guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": Fehler Speichern Nachberechnungsauftr$$HEX1$$e400$$ENDHEX$$ge "+string(sqlca.sqlcode)+" "+sqlca.sqlerrtext)
	rollback;
	...
	// 09.08.2010 HR: Erfolgsmeldung ausgeben
	guoLog.uf_debug("["+ this.classname( )+".of_compare_flights] "+arg_cunit+"-"+string(lAirlineKey)+"-"+string(dGenerationDate)+": "+string(dsTemp.rowcount())+" Nachberechnungsauftr$$HEX1$$e400$$ENDHEX$$ge erstellt.")
end if

if ii_Debug_Save =1 then dsTemp.saveas(is_Debug_save_path+"of_compare_flights_5_dsTemp_"+string(now(),"hhmmss")+".xlsx", XLSX!,TRUE)
...
// --------------------------------------------------------------------------------------------------------------------
string 		ls_find, ls_actype_new, ls_configuration_sky, ls_airline_owner_sky, ls_actype, ls_configuration, ls_galleyversion, ls_airline
...
for i=0 to 3 
	...
	// 09.05.2025 HR: Wir nehmen den ersten, wenn es mehrere Treffer gibt
			SELECT 	cen_airlines.cairline,
				...
				FROM cen_aircraft, 
						cen_airlines
				where CEN_AIRCRAFT.NAIRLINE_OWNER_KEY = cen_airlines.nairline_key
				   and cen_aircraft.naircraft_key in ( SELECT cen_aircraft_mapping.naircraft_key  
					 											  FROM cen_aircraft_mapping  
																WHERE cen_aircraft_mapping.caircraft_owner = :ls_airline_owner_sky 
																    AND cen_aircraft_mapping.caircraft_type = :ls_actype 
																    AND cen_aircraft_mapping.caircraft_version = :ls_configuration_sky 
															  ) 
				  and rownum <= 1;

			if sqlca.sqlcode=0 then
				dsGenerateSchedule.setitem(lrow,"cairline_owner", 			ls_airline) // 28.07.2025 HR: Aircraft Owner auch anpassen auch $$HEX1$$e400$$ENDHEX$$ndern
				dsGenerateSchedule.setitem(lrow,"nairline_owner_key", 	ll_airlineownerkey) // 28.07.2025 HR: Aircraft Owner Key auch anpassen auch $$HEX1$$e400$$ENDHEX$$ndern
				...
				// 31.08.2017 HR: issue #2836 Meldung nur f$$HEX1$$fc00$$ENDHEX$$r den Betrieb loggen, ansonsten ins Server-LOG-File 
				// --------------------------------------------------------------------------------------------------------------------
				if arg_ds.GetItemString(arg_row, "cunit")= sUnit then
					...
					guoLog.uf_info("["+ this.classname( )+".of_search_cfs_flight] Flight "+ls_find+" found no CBASE-AC-Type for AC " + ls_airline_owner_sky+" "+ls_actype+" Configuration: "+ ls_configuration_sky +", sqlcode="+string(sqlca.sqlcode)+", sqlerrtext=" + sqlca.sqlerrtext )
				end if
...
Long         ll_Rows
Long         ll_Setting
uo_generate_datastore   lds_Airline


lds_Airline   = CREATE uo_generate_datastore
...
if ii_Debug_Save =1 then dsExtCatSched.saveas(is_Debug_save_path+"of_check_cfs_flights_dsExtCatSched_nach_verarbeitung"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
...
uo_generate_datastore 	lds_handling_types
uo_generate_datastore 	lds_handling_all
...
lds_handling_types = create uo_generate_datastore
...
if lds_handling_types.rowcount()=0 then 
	guoLog.uf_debug("["+ this.classname( )+".of_get_packet_handling] "+ls_flight+": No HandlingTypes found for "+ls_type)
...
if dsCenOutPackets.rowcount()=0 then 
	guoLog.uf_debug("["+ this.classname( )+".of_get_packet_handling] "+ls_flight+": No FlightPackets found")
...
guoLog.uf_debug("["+ this.classname( )+".of_get_packet_handling] "+ls_flight+": FlightPackets for all Legs: "+string(dsCenOutPackets.rowcount()))
...
if dsCenOutLos.rowcount()=0 then 
	guoLog.uf_debug("["+ this.classname( )+".of_get_packet_handling] "+ls_flight+": No FlightLOS found")
...
lds_handling_all = create uo_generate_datastore
...
//	end if
	...
	for l2 = 1 to dsCenOutLos.rowcount()
		...
		if lfind=0 then 
			guoLog.uf_debug("["+ this.classname( )+".of_get_packet_handling] "+ls_flight+": "+ lds_handling_types.Getitemstring(l1,"ctext")+" not possible.")
	...
	if lfind=1 then
		...
		guoLog.uf_debug("["+ this.classname( )+".of_get_packet_handling] "+ls_flight+": New Handling: "+ lds_handling_types.Getitemstring(l1,"ctext"))
...
if lfind <>1 then  
	lfind =0
	guoLog.uf_debug("["+ this.classname( )+".of_get_packet_handling] "+ls_flight+": No Handling found")
...
if lds.rowcount()> 0 then
	...
	if i<>1 then
		guoLog.uf_error("["+ this.classname( )+".of_write_cen_out_packets_los] error copy "+string(lds.rowcount())+" cfs-packets to flight")
	end if
end if
...
if lds.rowcount()> 0 then
	...
	if i<>1 then
		guoLog.uf_error("["+ this.classname( )+".of_write_cen_out_packets_los] error copy "+string(lds.rowcount())+" cfs-los to flight")
	end if
end if
...
uo_generate_datastore 			lds_pl_wksarea
...
if  dsCenOut.getitemnumber(arg_row,"nppm_lock")=1 then 
	guoLog.uf_debug("["+ this.classname( )+".of_generate_ppm] NPPM_LOCK for Flight is set to 1")	
	return 1
end if
...
lds_pl_wksarea = create uo_generate_datastore
...
if uo_loading4flight.uf_retrieve() <= 0 then
	guoLog.uf_error("["+ this.classname( )+".of_generate_ppm] Error uo_loading4flight.uf_retrieve(): " + dsCenOut.GetItemString(arg_row,"cairline") + " " + string(dsCenOut.GetItemNumber(arg_row,"nflight_number")) + " " + &
					" (key " + string(ll_ResultKey) + ") " )
	guoLog.uf_error("["+ this.classname( )+".of_generate_ppm] Error uo_loading4flight.uf_retrieve(): " + uo_loading4flight.sStatusText )
else
	guoLog.uf_debug("["+ this.classname( )+".of_generate_ppm] "+string(lFlightNumber,"0000")+sSuffix+": Rows in ds_loginglist_result: "+string(uo_loading4flight.ds_loadinglist.rowcount()))	
	...
	if dsCenOutPPM.rowcount()>0 then
		guoLog.uf_info("["+ this.classname( )+".of_generate_ppm] "+string(lFlightNumber,"0000")+sSuffix+": Delete  "+ string(dsCenOutPPM.rowcount())+" old rows")	
...
/*		dsCenOutPPM.setitem(lrow, "npltype_key",					uo_loading4flight.ds_loadinglist.getitem(i,""))
	...
	guoLog.uf_debug("["+ this.classname( )+".of_generate_ppm] "+string(lFlightNumber,"0000")+sSuffix+": Rows in dsCenOutPPM: "+string(dsCenOutPPM.rowcount()))	
	guoLog.uf_debug("["+ this.classname( )+".of_generate_ppm] "+string(lFlightNumber,"0000")+sSuffix+": Rows in dsCenOutPPMStowages: "+string(dsCenOutPPMStowages.rowcount()))	
	...
	uo_generate_meals.dsCenOutMeals.filter()
	guoLog.uf_debug("["+ this.classname( )+".of_generate_ppm] "+string(lFlightNumber,"0000")+sSuffix+": Rows in uo_generate_meals.dsCenOutMeals: "+string(uo_generate_meals.dsCenOutMeals.rowcount()))	
...
lEnde = CPU()
guoLog.uf_info("["+ this.classname( )+".of_generate_ppm] "+string(lFlightNumber,"0000")+sSuffix+": Rows in dsCenOutPPM: "+string(dsCenOutPPM.rowcount())+" Duration "+string((lEnde - lstart)/1000)+" sek")	
...
uo_generate_datastore 	lds_PackageLos
boolean 		bCFSPackages, bCFSExact
integer 		k, lFound
string 		sFind, sKind
...
lds_PackageLos = create uo_generate_datastore
...
if lds_PackageLos.rowcount()>0 then
	if bCFSPackages then
		...
		if dsCenOutPackets.rowcount( )=0 then 
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_paclos] No Packages for this flight found")
			return 0
		end if
		
		if dsCenOutPackets.getitemnumber(1,"compute_maxleg")<>lds_PackageLos.getitemnumber(1,"comp_maxleg") then 
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_paclos] Legs in Flight: "+string(dsCenOutPackets.getitemnumber(1,"compute_maxleg"))+" vs. Legs in Package-Masterdata: "+string(lds_PackageLos.getitemnumber(1,"comp_maxleg") ))
			return 0
		end if
		...
		if dsCenOutLos.rowcount( )=0 then 
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_paclos] No LOS for this flight found")
			return 0
		end if
		
		if dsCenOutLos.getitemnumber(1,"compute_maxleg")<>lds_PackageLos.getitemnumber(1,"comp_maxleg") then 
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_paclos] Legs in Flight: "+string(dsCenOutLos.getitemnumber(1,"compute_maxleg"))+" vs. Legs in LOS-Masterdata: "+string(lds_PackageLos.getitemnumber(1,"comp_maxleg") ))
			return 0
		end if
	...
	if bCFSExact then
		...
		if lds_PackageLos.getitemnumber(1,"comp_found") =0 then 
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_paclos] "+sKind+ sLoadinglist +" not used, because no Package/Los found")
			return 0
		end if
	else
		...
		if lds_PackageLos.getitemnumber(1,"comp_found") <> lds_PackageLos.rowcount() then 
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_paclos] "+sKind+ sLoadinglist +" not used, because "+string( lds_PackageLos.getitemnumber(1,"comp_found"))+" of "+string( lds_PackageLos.rowcount())+"Package/Los found")
			return 0
		end if
	end if
	guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_paclos] "+ sKind+ sLoadinglist +" is used.")
end if
...
string					ls_sapconnect_instanz
uo_generate_datastore	dsmap
...
if li_ok=0 then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_idocjobs] IDOC-SEND f$$HEX1$$fc00$$ENDHEX$$r Betrieb ausgeschaltet")
	return true
end if

if date(ldt) > dGenerationDate then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_idocjobs] IDOC-SEND f$$HEX1$$fc00$$ENDHEX$$r Betrieb erst ab "+string(ldt, "dd.mm.yyyy"))
...
li_ok 		= 0 
li_error 	= 0
//1. Schritt: Wir mappen die Instanz, wenn sie ungleich none ist:
if sInstanceName <> "None" then
		dsmap = create uo_generate_datastore
		dsmap.dataobject='dw_map_instance'
		dsmap.settransobject(sqlca)
		
		dsmap.retrieve(sInstanceName)
		if dsmap.rowcount()>0 then
			ls_sapconnect_instanz=dsmap.getitemstring(1,"csap_instance")
		else
			ls_sapconnect_instanz=''
		end if
		destroy (dsmap)
end if
...
for i=1 to dsCenOut.rowcount()
	...
	// --------------------------------------------------------------------------------------------------------------------
	if uo_ridoc.of_insert_generation( dsCenOut.GetItemnumber(i, "nresult_key") ,3,  '', dsCenOut.GetItemnumber(i, "ntransaction"),ls_sapconnect_instanz) =0 then
		li_ok ++
	else
		li_error ++
	end if
...
guoLog.uf_allways("["+ this.classname( )+".of_generate_idocjobs] IDOC Auftr$$HEX1$$e400$$ENDHEX$$ge erstellt: "+string(li_ok)+" / mit Fehler: "+string(li_error))
...
if lds.update()=1 and lds.rowcount()>0 then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_skytelexsendjobs] Generate "+string(lds.rowcount())+" Jobs for SKY-Telex_SEND")
end if
...
for l3=1 to dsCenOut.rowcount()
	...
	guoLog.uf_info("["+ this.classname( )+".of_change_handling] Changed Flight "+ string(dsCenOut.Getitemnumber(l3,"nflight_number"))+" to " +arg_sHandlingShortText)
next
...
guoLog.uf_allways("["+ this.classname( )+"."+arg_function+"]"+  trace_text + "  **************************" )
...
if dsCenOutPackets.setfilter(ls_filter)<> 1 then
	arg_packetkey[1] = -1
	guoLog.uf_error("["+ this.classname( )+".of_get_co_packetkeys] Error Filter Packages: " +of_checknull(sAirline +string(lFlightNumber)+" "+ sTLCFrom +"-"+sTLCTo))
else
	dsCenOutPackets.filter()
	...
	if dsCenOutPackets.rowcount()>0 then
		for xx=1 to dsCenOutPackets.rowcount()
			if xx > 1000 then
				guoLog.uf_allways("["+ this.classname( )+".of_get_co_packetkeys] skip Packages more then 1000 " +of_checknull(sAirline +string(lFlightNumber)+" "+ sTLCFrom +"-"+sTLCTo)+": "+string(dsCenOutPackets.rowcount()))
				exit
			else
...
uo_generate_datastore 	lds_chkpt
integer  		liRet

lds_chkpt 				= create uo_generate_datastore
lds_chkpt.dataobject 	= dsCenOutCheckPt.dataobject

liRet = of_create_checkpts (dsCenOut, lds_chkpt)
...
uo_generate_datastore  	lds_sky
string 		ls_packets[], ls_null[] //03.05.2011 HR
boolean		lb_NoPackets
boolean 		lb_NewClass
long 			ll_nhandling_meal_keys[], ll_empty[]
// ------------------------------------------
...
If dNewGenerationDate < Date (2005,1,1) Then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_handling_meals] " +arg_rowcount+"Bullshit dNewGenerationDate:" + string(dNewGenerationDate))
End if

If dGenerationDate < Date (2005,1,1) Then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_handling_meals] "+ arg_rowcount+"Bullshit dGenerationDate:" + string(dGenerationDate))
End if
...
if dsCenOutPackets.setfilter("NRESULT_KEY = "+string(lResultKey))<> 1 then
	...
	guoLog.uf_error("["+ this.classname( )+".of_generate_handling_meals] " + arg_rowcount+"Error Filter Packages: " +of_checknull(sAirline +string(lFlightNumber)+" "+ sTLCFrom +"-"+sTLCTo))
	...
	if dsCenOutPackets.rowcount()>0 then
		for xx=1 to dsCenOutPackets.rowcount()
			if xx > 1000 then
				guoLog.uf_error("["+ this.classname( )+".of_generate_handling_meals] "+arg_rowcount+"skip Packages more then 1000 " +of_checknull(sAirline +string(lFlightNumber)+" "+ sTLCFrom +"-"+sTLCTo)+": "+string(dsCenOutPackets.rowcount()))
...
lds_sky = create uo_generate_datastore
...
For i = 1 to dsHandling.Rowcount()
	...
	if  dsHandling.getitemnumber(i, "nuse_short_packets") = 1 then
		...
		if lds_sky.rowcount()>0 then
			...
			if lFind <> 1 then
				guoLog.uf_error("["+ this.classname( )+".of_generate_handling_meals] "+arg_rowcount+"Error Copy Rows from lds_sky ("+lds_sky.dataobject +") to dsHandlingMealCover ("+dsHandlingMealCover.dataobject +"): "+string(lFlightNumber)+" Handlingkey: "+string(lHandling_Key))
			end if
		...
		if xx>0 then
			...
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_meals] "+arg_rowcount+"ResultKey "+	string(lResultKey) + " not found in DsCenOut")
		end if
	else
		// --------------------------------------------------------------------------------------------------------------------
	...
	if  dsHandling.Getitemnumber(i,"nuse_customer_packets")=1 and  dsHandling.getitemnumber(i, "nuse_short_packets") =0 then
		...
		//if ii_Debug_Save =1 then lds_sky.SaveAs(is_Debug_save_path+"of_generate_handling_meals_1_"+is_flugnummer+"_lds_sky"+string(now(),"hhmmss")+".xlsx", XLSX!, true)

		if lds_sky.rowcount()>0 then
			if lds_sky.find("nhandling_key = "+string(lHandling_Key), 1,lds_sky.rowcount())=0 then 
				//if ii_Debug_Save =1 then dsHandlingMealCover.SaveAs(is_Debug_save_path+"of_generate_handling_meals_2_"+is_flugnummer+"_dsHandlingMealCover_"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
				...
				For xx = dsHandlingMealCover.rowcount() to 1 step -1
					if lds_sky.find("nhandling_key = "+string(dsHandlingMealCover.Getitemnumber(xx,"nhandling_foreign_key")), 1,lds_sky.rowcount())=0 then
						guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_meals] " +arg_rowcount+"Handling not found in SKY_EXT: " + &
				...
				//if ii_Debug_Save =1 then dsHandlingMealCover.SaveAs(is_Debug_save_path+"of_generate_handling_meals_3_"+is_flugnummer+"_dsHandlingMealCover_"+string(now(),"hhmmss")+".xlsx", XLSX!, true)

			else
					guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_meals] "+arg_rowcount+"Handling found in SKY_EXT: result_key=" + &
						string(lResultKey) + ", airline_key=" + string(lairlinekey) + &
						", client=" + sunit + ", handling_key=" + string(lHandling_Key)+ &
						" " + sHandlingObjectText+" "+sAirline+string(lFlightNumber)+sSuffix+" "+string(dNewGenerationDate)+" "+sTLCFrom+"-"+sTLCTo)
			end if
		else
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_meals] "+arg_rowcount+"SKY_EXT is Emty: result_key=" + &
				string(lResultKey) + ", airline_key=" + string(lairlinekey) + &
				", client=" + sunit + ", handling_key=" + string(lHandling_Key)+ &
				" " + sHandlingObjectText+" "+sAirline+string(lFlightNumber)+sSuffix+" "+string(dNewGenerationDate)+" "+sTLCFrom+"-"+sTLCTo)
			continue	
...
//	If lHandlingId = iHandlingID and dsHandlingMealCover.rowcount() > 0 Then	// 11 oder 5
	If dsHandlingMealCover.rowcount() > 0 Then	// 11 oder 5
		guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_meals] "+arg_rowcount+"processing result_key=" + &
						string(lResultKey) + ", airline_key=" + string(lairlinekey) + &
						", client=" + sunit + ", handling_key=" + string(lHandling_Key)+ &
						" " + sHandlingObjectText+ ", arg_module_type="+string(arg_module_type) )

		// --------------------------------------------------------------------------------------------------------------------
		// 16.05.2024 HR: Nur die Passagierzahlen des Fluges und nicht alle
		// --------------------------------------------------------------------------------------------------------------------
		dsCenOutPax.setfilter("nresult_key = " + string(lResultKey) )
		dsCenOutPax.filter()
		...
		uo_generate_meals.lHandlingTypeKeyFlight		= lHandlingTypeKey // 13.06.2017 HR:

		uo_generate_meals.is_packets						= ls_packets	     // 30.10.2020 HR: #5358 Old pax counting window by change of departure time	
		uo_generate_meals.sDepartureTime 				= sDepartureTime // 30.10.2020 HR: #5358 Old pax counting window by change of departure time	
		...
		// 03.08.2023 HR:  request #8155: Overwrite / Adjust Reserves / Top Offs
		uo_generate_meals.il_co_tlc_from 					= lTlcfrom
		uo_generate_meals.il_co_tlc_to 						= lTlcTo
...
// --------------------------------------------------------------------------------------------------------------------
// 14.09.2021 HR: 
// 11.02.2022 HR: Schleige nur, wenn DW dsCenOutNewSPML auch vorhanden
// 13.03.2023 HR: Only when s_change.dsnewmeals is valid
// --------------------------------------------------------------------------------------------------------------------
if arg_module_type = 0 and isvalid(dsCenOutNewSPML) and isvalid(s_change.dsnewmeals) then
	string ls_class		 
	ls_class = "NANANANA"

	for j = 1 to dsCenOutNewSPML.RowCount() 
		if dsCenOutNewSPML.getitemnumber(j, "npt_manual")= 1 then continue
		
		if ls_class <> dsCenOutNewSPML.getitemstring(j, "cclass") then
			ll_nhandling_meal_keys 	= ll_empty
			ls_class 						= dsCenOutNewSPML.getitemstring(j, "cclass") // 18.10.2023 HR: Remember Class on Classchange
			
			for i = 1 to s_change.dsnewmeals.rowcount()	
				if dsCenOutNewSPML.getitemstring(j, "cclass") <>  s_change.dsnewmeals.getitemstring(i , "cclass") then continue
				
				if i > 1 then
					if s_change.dsnewmeals.getitemnumber(i -1, "nhandling_meal_key") = s_change.dsnewmeals.getitemnumber(i , "nhandling_meal_key") then continue
				end if
				ll_nhandling_meal_keys[upperbound(ll_nhandling_meal_keys) + 1] = s_change.dsnewmeals.getitemnumber(i , "nhandling_meal_key")
			next
		
		end if
		
		i = uo_generate_meals.dsspmldetail.find("NMASTER_KEY=" + string( dsCenOutNewSPML.getitemnumber(j, "nmaster_key") ), 1, uo_generate_meals.dsspmldetail.rowcount())
		
		if i > 0 then
			// 07.03.2023 HR: AlmID 9086: Flight Browser is picking the wrong validity for a SPML Defintion
			// 18.10.2023 HR: AlmID 9706: SPML description not displaying right by rotation the the Flight Browser
			dsCenOutNewSPML.SetItem(j, "cproduction_text", f_get_spml_production_text( dGenerationDate, dsCenOutNewSPML.getitemstring(j , "cspml"), ll_nhandling_meal_keys,  uo_generate_meals.dsspmldetail.getitemnumber(i, "nrotation_name_key") ))
		else
			dsCenOutNewSPML.SetItem(j, "cproduction_text", f_get_spml_production_text( dGenerationDate, dsCenOutNewSPML.getitemstring(j , "cspml"), ll_nhandling_meal_keys,  -2 ))
		end if			
	next
end if
...
long			lInfoRow,lHandlingSort
long			ll_RoutingPlanDetailKey
uo_generate_datastore  	lds_sky_mc, lds_sky_packets
...
If dNewGenerationDate < Date (2005,1,1) Then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_handling_meals_new] "+ arg_rowcount + "Bullshit dNewGenerationDate:" + string(dNewGenerationDate))
End if

If dGenerationDate < Date (2005,1,1) Then
	guoLog.uf_error("["+ this.classname( )+".of_generate_handling_meals_new] "+arg_rowcount + "Bullshit dGenerationDate:" + string(dGenerationDate))
End if
...
lds_sky_mc 			= create uo_generate_datastore
lds_sky_packets 	= create uo_generate_datastore
		...
		for xx = 1 to dsCenOutPax.rowcount()
			...
			if ll_packets[1]<> -1 then
				...
				if lds_sky_mc.rowcount()>0 then
					...
					if lFind <> 1 then
						guoLog.uf_error("["+ this.classname( )+".of_generate_handling_meals_new] "+arg_rowcount + "Error Copy Rows from lds_sky_mc to lds_sky_packets: "+string(lFlightNumber))
					end if
				end if
			end if
		next
...
For i = 1 to dsHandling.Rowcount()
	...
	if  dsHandling.getitemnumber(i, "nuse_short_packets") = 1 then
			...
			for xx = 1 to dsCenOutPax.rowcount()
				...
				if ll_packets[1]<> -1 then
					...
					if lds_sky_mc.rowcount()>0 then
						...
						if lFind <> 1 then
							guoLog.uf_error("["+ this.classname( )+".of_generate_handling_meals_new] "+arg_rowcount + "Error Copy Rows from lds_sky_mc to dsHandlingMealCover: "+string(lFlightNumber)+" Handlingkey: "+string(lHandling_Key))
						end if
					end if
				end if
			next
		...
		if xx>0 then
			...
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_meals_new] "+arg_rowcount + "ResultKey "+	string(lResultKey) + " not found in DsCenOut")
		end if
	else
		// --------------------------------------------------------------------------------------------------------------------
		// 06.02.2013 HR: ansonsten wie gehabt
			...
			if lds_sky_packets.find("nhandling_key = "+string(lHandling_Key), 1,lds_sky_packets.rowcount()) = 0 then 
				For xx = dsHandlingMealCover.rowcount() to 1 step -1
					if lds_sky_packets.find("nhandling_key = "+string(dsHandlingMealCover.Getitemnumber(xx,"nhandling_foreign_key")), 1,lds_sky_packets.rowcount()) = 0 then
						guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_meals_new] "+arg_rowcount + "Handling not found in SKY_EXT: " + &
							"handling_key=" + string(dsHandlingMealCover.Getitemnumber(xx,"nhandling_foreign_key")))
				...
				next
					...
					guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_meals_new] "+arg_rowcount + "Handling found in SKY_EXT: result_key=" + &
						string(lResultKey) + ", airline_key=" + string(lairlinekey) + &
						", client=" + sunit + ", handling_key=" + string(lHandling_Key)+ &
						" " + sHandlingObjectText+" "+sAirline+string(lFlightNumber)+sSuffix+" "+string(dNewGenerationDate)+" "+sTLCFrom+"-"+sTLCTo)
			end if
		else
			guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_meals_new] "+ arg_rowcount + "SKY_EXT is Emty: result_key=" + &
				string(lResultKey) + ", airline_key=" + string(lairlinekey) + &
				", client=" + sunit + ", handling_key=" + string(lHandling_Key)+ &
				" " + sHandlingObjectText+" "+sAirline+string(lFlightNumber)+sSuffix+" "+string(dNewGenerationDate)+" "+sTLCFrom+"-"+sTLCTo)
			continue	
	...
	If dsHandlingMealCover.rowcount() > 0 Then	// 11 oder 5
		guoLog.uf_debug("["+ this.classname( )+".of_generate_handling_meals_new] "+arg_rowcount + "processing result_key=" + &
						string(lResultKey) + ", airline_key=" + string(lairlinekey) + &
						", client=" + sunit + ", handling_key=" + string(lHandling_Key)+ &
						" " + sHandlingObjectText)
		// --------------------------------------------------------------------------------------------------------------------
...
guoLog.uf_info("["+ this.classname( )+".of_get_handling_from_text] Change Handling from " + sHandlingShortText + " to " + arg_handling)
...
sqlca_temp.LogPass 		= sqlca.LogPass
sqlca_temp.LogId 			= sqlca.LogId 	

connect using sqlca_temp;

if sqlca_temp.sqlcode<>0 then
	guoLog.uf_error("["+ this.classname( )+".of_set_jobs_to_ignore] Error connect "+ string(sqlca_temp.sqlcode) )
	destroy sqlca_temp
	return -3
end if
...
if arg_kind = 0 or arg_kind = 1 then
	...
	guoLog.uf_allways("["+ this.classname( )+".of_set_jobs_to_ignore] Set "+string(sqlca_temp.sqlnrows)+" Explosion - Jobs to ignore" )
...
if arg_kind = 0 or arg_kind = 2 then
	...
	guoLog.uf_allways("["+ this.classname( )+".of_set_jobs_to_ignore] Set "+string(sqlca_temp.sqlnrows)+" FlightCalc - Jobs to ignore" )
	commit using sqlca_temp;
end if
...
if arg_kind = 0 or arg_kind = 3 then
	...
	guoLog.uf_allways("["+ this.classname( )+".of_set_jobs_to_ignore] Set "+string(sqlca_temp.sqlnrows)+" DocEngine - Jobs to ignore" )
	commit using sqlca_temp;
end if
...
datetime dtQueryID
long 		i, j, lSPML_Class, lSPML_Quantity, lFound, lFind, lreturn, lSPML_Quantity_Old, iSPML_TopOff_old, lnreq_flight_key
string 	ls_CFLIGHT_KEY, sSPML_Class, sSPML, sSPML_Remark, sOriginal_Remark, sFirstname, sFindString, sSPMLInfo
integer 	iSPML_TopOff
...
For i = 1 to dsGenerateCenExternalSpml.Rowcount()
	...
	sSPMLInfo				= dsGenerateCenExternalSpml.GetItemString(i,"cinfo") // 02.06.2016 HR: #5.30-107
	...
	if lFind = 0 then
		...
		if lReturn > 0 then
			...
			dsCenOutNewSPML.SetItem(lReturn,"nclass_number",lSPML_Class)
			dsCenOutNewSPML.SetItem(lReturn,"cspml",sSPML)
			dsCenOutNewSPML.SetItem(lReturn,"cadd_text", sSPMLInfo) // 02.06.2016 HR: #5.30-107
			dsCenOutNewSPML.SetItem(lReturn,"cremark",sSPML_Remark) // 02.06.2016 HR: #5.30-107
			dsCenOutNewSPML.SetItem(lReturn,"nspml_key",dsValidSPML.GetItemNumber(lFound,"nspml_key"))
			dsCenOutNewSPML.SetItem(lReturn,"nquantity",lSPML_Quantity)
			dsCenOutNewSPML.SetItem(lReturn,"ndummy",1)
			dsCenOutNewSPML.SetItem(lReturn,"ntopoff",iSPML_TopOff)
			dsCenOutNewSPML.SetItem(lReturn,"status_nquantity",1)
			dsCenOutNewSPML.SetItem(lReturn,"cspml_source", 'EXT' )  // 23.04.2025 HR: Almid 11358 Flight Generation with SPML setting "Forecast" is ignoring SPMLs
...
uo_matdispo.ib_full_explosion = false
...
// --------------------------------------------------------------------------------------------------------------------
// 10.10.2016 HR: Wenn Fl$$HEX1$$fc00$$ENDHEX$$ge LOCKED sind, dann ist der Flug nicht in dsCenOut, wird 
//                        aber bei der obigen Aufl$$HEX1$$f600$$ENDHEX$$sung mit aufgel$$HEX1$$f600$$ENDHEX$$st
// --------------------------------------------------------------------------------------------------------------------
for i = 1 to uo_matdispo.dsflightsonly.rowcount()
	if uo_matdispo.dsflightsonly.dataobject='dw_exp_flights_of_the_day' then
		if dsCenOut.find("nresult_key = " + string( uo_matdispo.dsflightsonly.getitemnumber(i,"cen_out_nresult_key")), 1,  dsCenOut.rowcount() )=0 then
			lcnt = dsCenOut.insertrow(0)
			dsCenOut.setitem(lcnt, "nresult_key", uo_matdispo.dsflightsonly.getitemnumber(i,"cen_out_nresult_key"))
			dsCenOut.setitem(lcnt, "ddeparture", uo_matdispo.dsflightsonly.getitemdatetime(i,"cen_out_ddeparture"))
			dsCenOut.setitem(lcnt, "cdeparture_time", uo_matdispo.dsflightsonly.getitemstring(i,"cen_out_cdeparture_time"))
		end if
	else
		if dsCenOut.find("nresult_key = " + string( uo_matdispo.dsflightsonly.getitemnumber(i,"nresult_key")), 1,  dsCenOut.rowcount() )=0 then
			lcnt = dsCenOut.insertrow(0)
			dsCenOut.setitem(lcnt, "nresult_key", uo_matdispo.dsflightsonly.getitemnumber(i,"nresult_key"))
			dsCenOut.setitem(lcnt, "ddeparture", uo_matdispo.dsflightsonly.getitemdatetime(i,"ddeparture"))
			dsCenOut.setitem(lcnt, "cdeparture_time", uo_matdispo.dsflightsonly.getitemstring(i,"cdeparture_time"))
		end if
	end if
next
...
return of_generate_explosionjobs(4)
...
for i=1 to dsCenOut.rowcount()
	...
	if lsequence = -1 then
		guoLog.uf_error("["+ this.classname( )+".of_generate_explosionjobs] Error getting Sequence:  " + string( SQLCA.SQLCODE) + " - " + SQLCA.SQLERRTEXT)
		destroy lds
		return false
	end if 
	...
	lds.setitem(1,"nrequester", arg_requester) // 02.06.2016 HR:
	
next

if lds.update()=1 then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_explosionjobs] Generate " + string( lds.rowcount()) + " Explosionjobs.")
	...
	guoLog.uf_error("["+ this.classname( )+".of_generate_explosionjobs] Update Error:  " + string( lds.lSQLErrorDBCode)+" "+lds.sSQLErrorText)
...
public function boolean of_generate_docengine_jobs ();// --------------------------------------------------------------------------------------------------------------------
// Objekt : uo_generate
// Methode: of_generate_docengine_jobs (Function)
// Autor  : Heiko Rothenbach
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):
// none
...
// Return: boolean
// --------------------------------------------------------------------------------------------------------------------
//  Beschreibung: CBASE-NAM-CR-16008: Neue Funktion zum Erstellen von Doc-Engine-Jobs
// --------------------------------------------------------------------------------------------------------------------
//  Modifikationen:
//  Datum       Version  Autor          Kommentar
// --------------------------------------------------------------------------------------------------------------------
//  09.06.2016	   1.0      H.Rothenbach   Erstellung
//
// --------------------------------------------------------------------------------------------------------------------
uo_doc_gen_queue 	luo_doc_gen_queue
integer					li_ok, li_error, i, li_ret, li_ignore
...
luo_doc_gen_queue.bCommit = false
...
for i=1 to dsCenOut.rowcount()
	...
	//Wir erstellen Auftr$$HEX1$$e400$$ENDHEX$$ge f$$HEX1$$fc00$$ENDHEX$$r die Fl$$HEX1$$fc00$$ENDHEX$$ge
	// --------------------------------------------------------------------------------------------------------------------
	li_ret = luo_doc_gen_queue.of_enqueue_flight(  dsCenOut.GetItemnumber(i, "nresult_key") )
	if  li_ret = 1 then
		li_ok ++
...
guoLog.uf_allways("["+ this.classname( )+".of_generate_docengine_jobs] DOC Engine - Jobs erstellt: "+string(li_ok)+" / Ignore: "+string(li_ignore)+" / mit Fehler: "+string(li_error))
...
long			i, j, lRow, lOffset, lOffsetAlert, lFind
date			ld_vortag
string			sFind
...
if lds_chkpt.rowcount()=0 then
	guoLog.uf_allways("["+ this.classname( )+".of_create_checkpts] No CheckPoints found.")
	destroy lds_chkpt
...
for i=1 to arg_cen_out.rowcount()
	ldt_dep 			= datetime(date(arg_cen_out.getitemdatetime(i, "Ddeparture")), time(arg_cen_out.getitemstring(i, "cdeparture_time")))
	ld_vortag 		= relativedate(date(ldt_dep), -1)	
	
	// 09.06.2016 HR: Wenn Rampenzeit gleich Abflugszeit, dann nicht mehr Vortag
	if arg_cen_out.getitemstring(i, "cdeparture_time") >= arg_cen_out.getitemstring(i, "cramp_time") then
		ldt_ramp		= datetime(date(ldt_dep), time(arg_cen_out.getitemstring(i, "cramp_time")) )
	else
		ldt_ramp		= datetime(ld_vortag, time(arg_cen_out.getitemstring(i, "cramp_time")) )
	end if
	
	// 09.06.2016 HR: Wenn K$$HEX1$$fc00$$ENDHEX$$chenzeit gleich Abflugszeit, dann nicht mehr Vortag
	if arg_cen_out.getitemstring(i, "cdeparture_time") >= arg_cen_out.getitemstring(i, "ckitchen_time") then
		ldt_kitchen	= datetime(date(ldt_dep), time(arg_cen_out.getitemstring(i, "ckitchen_time")))
	else
		ldt_kitchen 	= datetime(ld_vortag, time(arg_cen_out.getitemstring(i, "ckitchen_time")))
	end if

	lds_chkpt.setfilter("cen_routing_crouting = '"+arg_cen_out.getitemstring(i, "crouting")+"' ")
	lds_chkpt.filter()
	
	if lds_chkpt.rowcount()=0 then
		guoLog.uf_allways("["+ this.classname( )+".of_create_checkpts] No CheckPoints for Routing "+ arg_cen_out.getitemstring(i, "crouting") +" found.")
		continue
	end if
	 
	 for j = 1 to lds_chkpt.rowcount()
		if arg_chkpts.rowcount()>0 then
			//Wenn wir diesen Checkpoint in den $$HEX1$$fc00$$ENDHEX$$bergebenen Checkpoints haben, dann nehmen wir diesen DS
			sFind = "nresult_key = "+string(arg_cen_out.getitemnumber(i, "nresult_key"))
			sFind += "and ncheckpoint_key = " + string(lds_chkpt.getitemnumber(j, "loc_unit_checkpt_ncheckpoint_key"))
			lFind = arg_chkpts.find(sFind, 1, arg_chkpts.rowcount())
			
			if lFind > 0 then
				arg_chkpts.setitem(lfind, "ntransaction", arg_cen_out.getitemnumber(i, "ntransaction"))
				arg_chkpts.rowscopy(lfind, lfind, primary!, dsCenOutCheckPt, 1, primary!)
				
				// 26.06.2017 HR: Wir m$$HEX1$$fc00$$ENDHEX$$ssen den Zeilen-Status auf  ge$$HEX1$$e400$$ENDHEX$$ndert setzen, damit ein Update- anstatt Insertstatement erzeugt wird
				dsCenOutCheckPt.setitemstatus( 1, 0, Primary!, DataModified!)
		...
		dsCenOutCheckPt.setitem(lrow, "nresult_key", arg_cen_out.getitemnumber(i, "nresult_key"))
		dsCenOutCheckPt.setitem(lrow, "ntransaction", arg_cen_out.getitemnumber(i, "ntransaction"))
...
public function boolean of_generate_checkpts ();uo_generate_datastore 	lds_chkpt
integer  		liRet
long 			lSQLCode, lSQLRow
string 		sSQLErrorText
...
lds_chkpt 				= create uo_generate_datastore
lds_chkpt.dataobject 	= "dw_cen_out_checkpt_finished"
lds_chkpt.settransobject(SQLCA)
lds_chkpt.retrieve(dGenerationDate, sClient, sUnit, lAirlineKey)

// 02.09.2016 HR: Wir m$$HEX1$$fc00$$ENDHEX$$ssen den DS leeren
dsCenOutCheckPt.reset()

// 02.09.2016 HR: L$$HEX1$$f600$$ENDHEX$$schen der Fl$$HEX1$$fc00$$ENDHEX$$ge nicht $$HEX1$$fc00$$ENDHEX$$ber Generationdate sondern Departure 
delete from cen_out_checkpt  
   WHERE cen_out_checkpt.nresult_key in (select nresult_key 
													  FROM cen_out 
													  WHERE ddeparture 	= :dGenerationDate 
                     										  and cclient	  				= :sclient 
                     										  and cunit		  			= :sunit 
                     										  and nairline_key 			= :lAirlineKey)
and cen_out_checkpt.ncheckpt_state <= 20;

// --------------------------------------------------------------------------------------------------------------------
// 28.07.2017 HR: Wir filtern die Fl$$HEX1$$fc00$$ENDHEX$$ge aus, die nicht generiert werden sollen, da diese im 2. Schritt 
//                            generiert werden
// --------------------------------------------------------------------------------------------------------------------
dsCenOut.setfilter("nnotregenerate = 0")
dsCenOut.filter()

dsCenOut.retrieve(lAirlineKey, dGenerationDate, sclient, sunit)
if dsCenOut.rowcount()>0 then
	liRet = of_create_checkpts (dsCenOut, lds_chkpt)
end if
...
if dsCenOutNotRegenerate.rowcount()>0 then
	liRet = of_create_checkpts (dsCenOutNotRegenerate, lds_chkpt)
end if
...
if dsCenOutCheckPt.update() = -1 then
	...
	guoLog.uf_info("["+ this.classname( )+".of_generate_checkpts] Rows in dsCenOutCheckPt: "+string(dsCenOutCheckPt.rowcount()))	
	
	lTimeEnd = cpu() // 28.06.2017 HR: F$$HEX1$$fc00$$ENDHEX$$rs LOGGING die Endezeit merken
...
//Neue lfdNR ermitteln
ll_sequence = f_sequence("seq_sys_queue_flight_calc", sqlca)
...
li_row = ads_flightcalc.InsertRow(0)
ll_result_key = dw_1.getitemnumber(al_row, "nresult_key")
li_status = dw_1.GetItemNumber(al_row,"nstatus")
	
//queue flight calc setzen
ads_flightcalc.SetItem(li_row, "njob_nr", ll_sequence)
ads_flightcalc.SetItem(li_row, "nresult_key", ll_result_key)
ads_flightcalc.SetItem(li_row, "ddeparture", DateTime(Date(dw_1.GetItemDatetime(al_row, "ddeparture")), Time(dw_1.GetItemString(al_row, "cdeparture_time"))))
ads_flightcalc.SetItem(li_row, "dcreated", DateTime(today(), now()))
ads_flightcalc.SetItem(li_row, "cmodified", "requested by " + s_app.sUser)
ads_flightcalc.SetItem(li_row, "cuser", s_app.sUser)
ads_flightcalc.SetItem(li_row, "nstatus", li_status)
ads_flightcalc.SetItem(li_row, "nfunction", 15)
ads_flightcalc.SetItem(li_row, "nforecast", 0)
ads_flightcalc.SetItem(li_row, "nhistory", 0)
ads_flightcalc.SetItem(li_row, "njob_group", ll_sequence)
ads_flightcalc.SetItem(li_row, "cdescription",dw_1.GetItemString(al_row,"cairline") + " " + String(dw_1.GetItemNumber(al_row,"nflight_number")) + " " + String(Date(dw_1.GetItemDatetime(al_row,"ddeparture"))))
ads_flightcalc.SetItem(li_row, "nsort", 1)	

dw_1.SetItem(al_row, "sys_queue_flight_calc_nresult_key", ll_result_key)
ll_stop = CPU()
dw_1.SetItem(al_row, "compute_status", string((ll_stop - ll_start) / 1000, "0.00"))
*/
Return True
...
if ii_Debug_Save =1 then dsGenerateSchedule.saveas(is_Debug_save_path+"of_generate_flights_1_dsGenerateSchedule_vorher"+string(now(),"hhmmss")+".xlsx", XLSX!, true)


dsGenerateSchedule.SetFilter(sFrequenz)
dsGenerateSchedule.Filter()

if ii_Debug_Save =1 then dsGenerateSchedule.saveas(is_Debug_save_path+"of_generate_flights_3_dsGenerateSchedule_nach_filter"+string(now(),"hhmmss")+".xlsx", XLSX!,TRUE)
...
if ii_Debug_Save =1 then dsGenerateRoutingPlan.saveas(is_Debug_save_path+"of_generate_flights_4_dsGenerateRoutingPlan_vorher_"+string(now(),"hhmmss")+".xlsx", XLSX!,TRUE)

guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Vorbereiten" )
For I = 1 to dsGenerateRoutingPlan.Rowcount()
...
// -----------------------------------------------------------------		
dsCenOutCache.Retrieve(lAirlineKey, dGenerationDate, sclient, sunit)
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights] cached " + string( dsCenOutCache.RowCount()) + " flights for " + string(dGenerationDate) + " / " + sUnit + " / " + string(lAirlineKey))
...
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights] cached " + string( dsCenOutQP.RowCount()) + " QPs for " + string(dGenerationDate) + " / " + sUnit + " / " + string(lAirlineKey))
...
if ii_delete_flights = 1 then
	// --------------------------------------------------------------------------------------------------------------------
	// 09.02.2018 HR: In Funktion ausgelagert, da auch bei CFS ben$$HEX1$$f600$$ENDHEX$$tigt
	// 14.05.2018 HR: Wenn beim L$$HEX1$$f600$$ENDHEX$$schen ein Fehler aufgetreten ist, dann nicht weiter machen
	// --------------------------------------------------------------------------------------------------------------------
	if of_generate_flights_deletebefore() = 0 then
		return 0
	end if
end if
...
dsCenOutNotRegenerate.retrieve(lAirlineKey, dGenerationDate, sclient, sUnit)
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights] cached " + string( dsCenOutNotRegenerate.RowCount()) + " flights for " + string(dGenerationDate) + " / " + sUnit + " / " + string(lAirlineKey)+" with markt not to regenerate.")

If dsGenerateSchedule.rowcount() <= 0 Then
	of_write_protocol(iJob_Type,iGenerierungsstatus,1,iWarnung,sAirline,string(dGenerationDate,s_app.sDateformat),"Found no flights in Flight Schedule.")
	guoLog.uf_error("["+ this.classname( )+".of_generate_flights] Found no flights in Flight Schedule. dsGenerateSchedule.RowCount()=" + string(dsGenerateSchedule.rowcount()) + &
					", dsGenerateRoutingPlan.RowCount()=" + string(dsGenerateRoutingPlan.rowcount()))
	
	// 18.03.2020 HR: ALM-ID 6208: Wir m$$HEX1$$fc00$$ENDHEX$$ssen hier auch die Fl$$HEX1$$fc00$$ENDHEX$$ge noch l$$HEX1$$f600$$ENDHEX$$schen
	of_generate_flights_delete()
	return 1
End if

If dsGenerateRoutingPlan.rowcount() <= 0 Then
	of_write_protocol(iJob_Type,iGenerierungsstatus,1,iWarnung,sAirline,string(dGenerationDate,s_app.sDateformat),"Found no flights in Loading Definition.")
	guoLog.uf_error("["+ this.classname( )+".of_generate_flights] Found no flights in Loading Definition. dsGenerateSchedule.RowCount()=" + string(dsGenerateSchedule.rowcount()) + &
					", dsGenerateRoutingPlan.RowCount()=" + string(dsGenerateRoutingPlan.rowcount()))
...
guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] lRoutingPlanKey=" + string(lRoutingPlanKey) )


dsGenerateRoutingPlan.SetSort("nsort A nrouting_group_key A nleg_number A")
dsGenerateRoutingPlan.Sort()

if ii_Debug_Save =1 then dsGenerateRoutingPlan.saveas(is_Debug_save_path+"of_generate_flights_4_dsGenerateRoutingPlan_after_sort_"+string(now(),"hhmmss")+".xlsx", XLSX!,TRUE)
...
For I = 1 to lRowcount
	...
	// 24.06.2010 HR: No Citypairs
	if lFlightNumber = -1 then continue
	
	// 28.09.2009 HR: Falsche Zeiten
	if lLegNumber=1 then
		lResultKeyGroup	= 0 //13.03.2024 HR AlmID 10147 Sicherstellen, dass folgende 2.Legs nicht an ein andern Flug angeh$$HEX1$$e400$$ENDHEX$$ngt werden
		cdeparture_vorleg	= ""
		iOffset_RF			= 0 // 25.07.2017 HR: Wir setzen das RF-Flag auf 0, damit wir bei der Suche ab Leg 2, diese Ber$$HEX1$$fc00$$ENDHEX$$cksichtigt wird
	...
	if isnull(sLoadingUnit) and lFlightNumber >0 then
		guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" Nullvalue in cunit found for Flighnumber " + string(lFlightNumber) )
		
		//01.11.2012 HR
		if dsGenerateRoutingPlan.GetitemNumber(i,"nrouting_group_key") <> lFlightGroup or iMLFlight = 1 then
			guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" Group Change for nrouting_group_key = " + string(lFlightGroup) )
			lFlightGroup	= dsGenerateRoutingPlan.Getitemnumber(i,"nrouting_group_key")
	...
	if lFound > 0 then	
		guoLog.uf_allways("["+ this.classname( )+".of_generate_flights] Flight found in NotToRegenerate Cache: " + string(lFlightNumber)+sSuffix+" Leg "+string(lLegNumber)+" " +sTLCFrom+"-"+sTLCTo)
	...
	//*alt*/if dsGenerateRoutingPlan.GetitemNumber(i,"nrouting_group_key") <> lFlightGroup then
		...
		if bCharter then
			...
			if dsCharterMemory.RowCount() > 0 then
				...
				guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" dsCharterMemory.RowCount()=" + string(dsCharterMemory.rowcount()) &
								+ " dsCenOut.RowCount()=" + string(dsCenOut.rowcount()))
				bDeleteLegs = false
				...
				dsCenOut.SetFilter(sFilter)
				dsCenOut.Filter()
				guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" Filter = " + sFilter + " => dsCharterMemory.RowCount()=" + string(dsCharterMemory.rowcount()) &
								+ " dsCenOut.RowCount()=" + string(dsCenOut.rowcount()))
				//
				// Weicht Anzahl Legs ab?
				//
				if dsCenOut.RowCount() <> dsCharterMemory.RowCount() then
					guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" bDeleteLegs = true because of Rowcount" )
					bDeleteLegs = true
				end if
				...
				for j = 1 to dsCenOut.RowCount() 
					for k = 1 to dsCharterMemory.RowCount()
						if dsCenOut.GetItemNumber(j,"nleg_number") = dsCharterMemory.GetItemNumber(k,"nleg_number") then
							...
							if dsCenOut.GetItemNumber(j,"ntlc_from") <> dsCharterMemory.GetItemNumber(k,"ntlc_from") or &
								dsCenOut.GetItemNumber(j,"ntlc_to") <> dsCharterMemory.GetItemNumber(k,"ntlc_to") then
								guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" bDeleteLegs = true because Leg " + string(dsCenOut.GetItemNumber(j,"nleg_number")) + "  " + string(dsCenOut.GetItemNumber(j,"ntlc_from")) + " <> " + &
										string(dsCharterMemory.GetItemNumber(k,"ntlc_from")) + " or " + string(dsCenOut.GetItemNumber(j,"ntlc_to")) + " <> " + &
										string(dsCharterMemory.GetItemNumber(k,"ntlc_to")) )
								guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" bDeleteLegs = true (1)" )
								bDeleteLegs = true
							end if
						end if
					next
				...
				if bDeleteLegs then
					guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" bDeleteLegs set nrouting_group_key=" + string(lKey) )
	...
	guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" processing flight " + string(lFlightNumber) + ", nrouting_group_key = " + string(lCurrentGroupKey))
	// -------------------------------------------------------------------------
	// Kein City Pair und innerhalb der Gruppe kommt der Generierungsbetrieb vor.
	// -------------------------------------------------------------------------
	If lFlightnumber <> -1 and bGenerateFlight = True Then
		...
		if lLegNumber>1 and lResultKeyGroup=0 then
			guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" flight " + string(lFlightNumber) + " ignored, because 1. Leg not generated")
		else
			of_search_flightnumber(i)
		end if
	else
		guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" flight " + string(lFlightNumber) + " ignored")
	End if
Next
...
if bCharter then
	...
	//
	if dsCharterMemory.RowCount() > 0 then
		guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] final dsCharterMemory.RowCount()=" + string(dsCharterMemory.rowcount()) &
						+ " dsCenOut.RowCount()=" + string(dsCenOut.rowcount()))
		bDeleteLegs = false
		//
		// Kontrolle: dsCharterMemory des vorherigen Flugs gegen dsCenOut
		...
		//
		if dsCenOut.RowCount() <> dsCharterMemory.RowCount() then
			guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] bDeleteLegs = true because of Rowcount" )
			bDeleteLegs = true
		end if
		for j = 1 to dsCenOut.RowCount() 
			for k = 1 to dsCharterMemory.RowCount()
				if dsCenOut.GetItemNumber(j,"nleg_number") = dsCharterMemory.GetItemNumber(k,"nleg_number") then
					...
					if dsCenOut.GetItemNumber(j,"ntlc_from") <> dsCharterMemory.GetItemNumber(k,"ntlc_from") or &
						dsCenOut.GetItemNumber(j,"ntlc_to") <> dsCharterMemory.GetItemNumber(k,"ntlc_to") then
						guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] bDeleteLegs = true because Leg " + string(dsCenOut.GetItemNumber(j,"nleg_number")) + "  " + string(dsCenOut.GetItemNumber(j,"ntlc_from")) + " <> " + &
								string(dsCharterMemory.GetItemNumber(k,"ntlc_from")) + " or " + string(dsCenOut.GetItemNumber(j,"ntlc_to")) + " <> " + &
								string(dsCharterMemory.GetItemNumber(k,"ntlc_to")) )
						guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] bDeleteLegs = true (2)" )
						bDeleteLegs = true
					end if
				end if
			next
		next
		if bDeleteLegs then
			guoLog.uf_debug("["+ this.classname( )+".of_generate_flights] bDeleteLegs set nrouting_group_key=" + string(lKey) )
		end if
		for j = dsCenOut.RowCount() to 1 step -1
			if bDeleteLegs then
				dsCenOut.DeleteRow(j)
...
For I = 1 to lRowcount
	...
	// 24.06.2010 HR: No FlightNumbers 
	if lFlightNumber <> -1 then continue
	
	//13.03.2024 HR AlmID 10147 Sicherstellen, dass folgende 2.Legs nicht an ein andern Flug angeh$$HEX1$$e400$$ENDHEX$$ngt werden
	if lLegNumber=1 then
		lResultKeyGroup	= 0 
		cdeparture_vorleg	= ""
		iOffset_RF			= 0 
		dt_dep_vorleg 		= datetime(date("01.01.2000"),time("00:01"))
		dt_arr_vorleg 		= datetime(date("01.01.2000"),time("00:01")) 
	end if
	...
	if isnull(sLoadingUnit) and lFlightNumber= -1 then
		guoLog.uf_info("["+ this.classname( )+".of_generate_flights] Row "+string(i)+" of "+string(lRowcount)+" Nullvalue in cunit found for Citypair  " + sTLCFrom + " - " + sTLCTo )
		continue
	end if
...
if ii_Debug_Save =1 then dsCenOut.SaveAs(is_Debug_save_path+"cen_out.xlsx", XLSX!, true)
...
// --------------------------------------------------------------------------------------------------------------------
dsCenOutCache.Retrieve(lAirlineKey, dGenerationDate, sclient, sunit)
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_cfs] cached " + string( dsCenOutCache.RowCount()) + " flights for " + string(dGenerationDate) + " / " + sUnit + " / " + string(lAirlineKey))

// --------------------------------------------------------------------------------------------------------------------
// 23.04.2015 HR: F$$HEX1$$fc00$$ENDHEX$$r das Receiycling brauchen wir auch hier die alten QP (Finnland)
// --------------------------------------------------------------------------------------------------------------------
dsCenOutQP.Retrieve(lAirlineKey, sunit, dGenerationDate)
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_cfs] cached " + string( dsCenOutQP.RowCount()) + " QPs for " + string(dGenerationDate) + " / " + sUnit + " / " + string(lAirlineKey))
...
if ii_delete_flights = 1 then
	// --------------------------------------------------------------------------------------------------------------------
	// 09.02.2018 HR: In Funktion ausgelagert, da auch bei normal ben$$HEX1$$f600$$ENDHEX$$tigt
	// 14.05.2018 HR: Wenn beim L$$HEX1$$f600$$ENDHEX$$schen ein Fehler aufgetreten ist, dann nicht weiter machen
	// --------------------------------------------------------------------------------------------------------------------
	if of_generate_flights_deletebefore() = 0 then
		return 0
...
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_cfs] Reading CFS-Flights")

dsExtCatSched.Retrieve(this.sAirline, dGenerationDate, lRoutingPlanKey, sunit)

if ii_Debug_Save =1 then dsExtCatSched.saveas(is_Debug_save_path+"of_generate_flights_cfs_1_dsExtCatSched_vorher"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
...
If dsExtCatSched.rowcount() = 0 then
	...
	guoLog.uf_error("["+ this.classname( )+".of_generate_flights_cfs] No valid CFS data available. ("+f_check_null(this.sAirline)+"/"+f_check_null(string(dGenerationDate))+")")
...
guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_cfs] Rows in dsExtCatSched: "+string(dsExtCatSched.rowcount()))
...
if ii_Debug_Save =1 then dsGenerateSchedule.saveas(is_Debug_save_path+"of_generate_flights_cfs_2_dsGenerateSchedule_vorher"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_cfs] Rows in dsGenerateSchedule: "+string(dsGenerateSchedule.rowcount()))
...
if ii_Debug_Save =1 then dsExtCatSched.saveas(is_Debug_save_path+"of_generate_flights_cfs_3_dsExtCatSched_vor_filter"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
...
if ii_Debug_Save =1 then dsExtCatSched.saveas(is_Debug_save_path+"of_generate_flights_cfs_3_dsExtCatSched_nach_filter"+string(now(),"hhmmss")+".xlsx", XLSX!, true)

guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_cfs] Rows in dsExtCatSched after check Flugplan: "+string(dsExtCatSched.rowcount()))

dsExtCatSched.rowscopy(1,dsExtCatSched.rowcount(), primary!,dsExtCatSchedTemp, 1, Primary!)

if ii_Debug_Save =1 then dsGenerateSchedule.saveas(is_Debug_save_path+"of_generate_flights_cfs_4_dsGenerateSchedule_nach_filter"+string(now(),"hhmmss")+".xlsx", XLSX!,TRUE)
...
dsGenerateRoutingPlan.SetFilter(sFrequenz)
dsGenerateRoutingPlan.Filter()
guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_cfs] Rows in dsGenerateRoutingPlan: "+string(dsGenerateRoutingPlan.rowcount()))

if ii_Debug_Save =1 then dsGenerateRoutingPlan.saveas(is_Debug_save_path+"of_generate_flights_cfs_5_dsGenerateRoutingPlan_vorher_"+string(now(),"hhmmss")+".xlsx", XLSX!,TRUE)

dsCenOutNotRegenerate.reset()
// dsCenOutNotRegenerate.setfilter("nnotregenerate = 1")  // 13.04.2015 HR: Wird nicht mehr ben$$HEX1$$f600$$ENDHEX$$tigt
dsCenOutNotRegenerate.retrieve(lAirlineKey, dGenerationDate, sclient, sUnit)
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_cfs] cached " + string( dsCenOutNotRegenerate.RowCount()) + " flights for " + string(dGenerationDate) + " / " + sUnit + " / " + string(lAirlineKey)+" with markt not to regenerate.")
...
If dsGenerateSchedule.rowcount() <= 0 Then
	...
	guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_cfs] dsGenerateSchedule.RowCount()=" + string(dsGenerateSchedule.rowcount()) + &
					", dsGenerateRoutingPlan.RowCount()=" + string(dsGenerateRoutingPlan.rowcount()))
...
guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_cfs] lRoutingPlanKey=" + string(lRoutingPlanKey)+" Rows: "+string(dsExtCatSched.rowcount()) )
...
dsExtCatSched.filter()
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_cfs] start finding flights") // 21.06.2012 HR: Ausgabe unabh$$HEX1$$e400$$ENDHEX$$ngig vom Tracelevel einschaltbar
...
for i=1 to dsExtCatSched.rowcount()
	if mod(i, 100) = 0 then
		guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_cfs] Row " +string(i) +" of " + string(dsExtCatSched.rowcount()))
	end if
	...
	guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_cfs]  Flight "+string(i) +" of "+string(dsExtCatSched.rowcount())+": "+string(lFlightNumber)+sSuffix+" "+sTLCFrom+sTLCTo)
	...
	if lFound > 0 and  not bCFSCheckOnly then	
		guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_cfs] Flight found in NotToRegenerate Cache: " + string(lFlightNumber)+sSuffix+" Leg 1 " +sTLCFrom+"-"+sTLCTo)
		continue
	end if
	...
	for xx=1 to 2
		...
		// --------------------------------------------------------------------------------------------------------------------
		// 24.07.2023 HR: AlmID 6597: whole routing of flight is not considered in handling assignment
		// --------------------------------------------------------------------------------------------------------------------
		sFind += " and nleg_count= "+string(dsExtCatSchedTemp.getitemnumber(1,"nleg_count")) 
		...
		do
			...
			if lfound < 0 then
				guoLog.uf_error("["+ this.classname( )+".of_generate_flights_cfs]  dsGenerateRoutingPlan.find " + sFind +" => " +string(lfound))
			end if
	...
	if k=1 then
		...
		for j=1 to dsExtCatSchedTemp.rowcount()
			if bCFSCheckOnly then
				...
				// 26.06.2023 HR:  #8552 add new columns to allow Ramp Box to be maintained here 
				// --------------------------------------------------------------------------------------------------------------------
				is_cfs_cbox_from 		= dsExtCatSchedTemp.Getitemstring(j,"cbox_from")
				is_cfs_cbox_to 			= dsExtCatSchedTemp.Getitemstring(j,"cbox_to")
				...
				if bOutstation and dsGenerateRoutingPlan.Getitemnumber(lfound +j -1,"anzunit")> 0 then
					sLoadingUnit				= sunit
				else
				...
				// 19.02.2025 HR Get Registration from CFS Browser if filled
				if trim( dsExtCatSchedTemp.Getitemstring(j,"cregistration") ) > " " then
					sRegistration		= dsExtCatSchedTemp.Getitemstring(j,"cregistration")
				else
					setnull( sRegistration )
				end if
				...
				guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_cfs] processing flight " + string(lFlightNumber) + ", nrouting_group_key = " + string(lCurrentGroupKey))
		...
		next
         ...
         next
         guoLog.uf_debug("["+ this.classname( )+".of_generate_flights_cfs] Not Found in Loadingdefinition: "+sfind)
	end if
next

if bCFSCheckOnly then
	if ii_Debug_Save =1 then dsExtCatSched.saveas(is_Debug_save_path+"of_generate_flights_cfs_6_dsExtCatSched_nach_verarbeitung"+string(now(),"hhmmss")+".xlsx", XLSX!, true)
end if
...
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_cfs] finish finding Flights") 
...
if lRoutingPlanDetailKey > 0 then
	i = lRoutingPlanDetailKey
else
	i = lRoutingPlanDetailKey_CP
end if 

  SELECT cen_routingplan.naccount_key,   
         		cen_airline_accounts.caccount  
    INTO :il_nAccountKeyBelDef,   
         	   :is_sAccountBelDef  
  FROM cen_routingplan,   
             cen_airline_accounts  
   WHERE cen_routingplan.nairline_key = cen_airline_accounts.nairline_key 
	   and  cen_routingplan.naccount_key = cen_airline_accounts.naccount_key 
	  and  cen_routingplan.nroutingdetail_key = :i  ;

if sqlca.sqlcode <> 0 then
	setnull(il_nAccountKeyBelDef)
	setnull(is_sAccountBelDef)
end if
...
public function integer of_generate_flights_deletebefore ();// --------------------------------------------------------------------------------------------------------------------
// Objekt : uo_generate
// Methode: of_generate_flights_deletebefore (Function)
// Autor  : Heiko Rothenbach
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):
// none
...
//  Datum       Version  Autor          Kommentar
// --------------------------------------------------------------------------------------------------------------------
//  09.02.2018	   1.0      H.Rothenbach   Erstellung
//
// --------------------------------------------------------------------------------------------------------------------

guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_deletebefore]  start delete PPM Data")	

DECLARE del_ppm_data PROCEDURE  FOR CBASE_FLIGHTS.pp_gen_delete_ppm_data(:dGenerationDate, :sclient, :sunit,  :lAirlineKey) ;
execute del_ppm_data; 

if SQLCA.SQLCODE < 0 THEN
	guoLog.uf_error("["+ this.classname( )+".of_generate_flights_deletebefore] Error delete PPM Data: (" + string(SQLCA.SQLCODE) + ") " + SQLCA.sqlerrtext )
end if

// 08.06.2017 HR: Wir commiten hier erst mal, damit die LOCKS auf den PPM-Tabellen nicht so lange gehalten werden 
commit using sqlca;

// -----------------------------------------------------------------------------------------------------------
// 03.05.2019 HR: Wir l$$HEX1$$f600$$ENDHEX$$schen nicht mehr am Anfang der Generierung, sondern locken nur noch die Fl$$HEX1$$fc00$$ENDHEX$$ge (CEN_OUT)
// -----------------------------------------------------------------------------------------------------------
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_deletebefore]  start lock flights in cen_out")

datastore lds
long 			i, ll_nresultkey
lds = create datastore
lds.dataobject = "dw_generate_lock_flights_of_the_day"
lds.settransobject(SQLCA)

if lds.retrieve(dGenerationDate, sclient, sunit, lAirlineKey) = -1 then
	guoLog.uf_error("["+ this.classname( )+".of_generate_flights_deletebefore] retrieve for update cen_out - error " + string(sqlca.sqldbcode) + ": " + sqlca.sqlerrtext)
	of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline,string(dGenerationDate,s_app.sDateformat),"Can't lock flights, sqlcode " + string(sqlca.sqlcode) + ".")
	rollback using sqlca;
	return 0
else
	for i = 1 to lds.rowcount()
		ll_nresultkey = lds.getitemnumber(i, "nresult_key")
		select nresult_key 
		   into :ll_nresultkey 
	      from cen_out
		WHERE nresult_key 	= :ll_nresultkey
		   For Update NOWAIT;
				
		If sqlca.sqlcode <> 0 then
			guoLog.uf_error("["+ this.classname( )+".of_generate_flights_deletebefore] Lock flight " + string(lds.getitemnumber(i, "nresult_key")) +" - error " + string(sqlca.sqldbcode) + ": " + sqlca.sqlerrtext)
			rollback using sqlca;
			return 0
		end if
	next
...
guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_deletebefore] finish Lock flights: " + string(lds.rowcount()))

destroy lds
/* 
guoLog.uf_error("["+ this.classname( )+".of_generate_flights_deletebefore]  1,"start delete from cen_out")
...
If sqlca.sqlcode <> 0 then
	guoLog.uf_error("["+ this.classname( )+".of_generate_flights_deletebefore] delete from cen_out - error " + string(sqlca.sqldbcode) + ": " + sqlca.sqlerrtext)
	of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline,string(dGenerationDate,s_app.sDateformat),"Can't delete flight schedule, sqlcode " + string(sqlca.sqlcode) + ".")
	rollback using sqlca;
	return 0
else
	guoLog.uf_error("["+ this.classname( )+".of_generate_flights_deletebefore]  1,"finish delete from cen_out: " + string(sqlca.sqlnrows))
end if
 */
...
/*
	// 06.11.2020 HR: Wenn die Verbindung nicht mehr besteht, dann beenden wir die Verarbeitung und starten sauber mit einem Reconnectversuch
	...
	// Database Connection
	// ------------------------------------------
	SQLCA.ServerName 	= ProfileString(s_App.sProfile,"Database","Server","")
	SQLCA.DBMS 			= ProfileString(s_App.sProfile,"Database","DBMS","ODBC")
	SQLCA.DBParm 		= ProfileString(s_App.sProfile,"Database","DBPARM","")
	SQLCA.LogPass 		= ProfileString(s_App.sProfile,"Database","LogPass","")
	SQLCA.LogId 			= ProfileString(s_App.sProfile,"Database","LogId","")
	SQLCA.AutoCommit 	= False
	connect using sqlca;
	
	if sqlca.sqlcode = 0 then
		guoLog.uf_debug("["+ this.classname( )+".of_checkconnection] " + SQLCA.ServerName +": Transaction re-created" )
		...
		if isvalid(dsExtCatSched) then dsExtCatSched.Settransobject(sqlca)
		dsCenOutPackets.SetTransObject(SQLCA)
		...
		dsForecastUse.settransobject(SQLCA)
		...
		guoLog.uf_error("["+ this.classname( )+".of_checkconnection] " + SQLCA.ServerName +": ReConnect-ErrorCode = " + String(sqlca.sqlcode))
		guoLog.uf_error("["+ this.classname( )+".of_checkconnection] " + SQLCA.ServerName +": ReConnect-ErrorText = " + String(sqlca.sqlerrtext))
...
public function integer of_get_unit_language (string arg_cunit);string ls_Setting
integer li_language
...
datastore								ldsSysQueueFlightBob
long										ll_flight_key, ll_seq
integer									li_row, li_found
string										ls_find

string 		ls_cclient, ls_cairline, ls_ctlc_from, ls_ctlc_to, ls_csuffix
integer 		li_nflight_number
datetime 	ldt_ddeparture, ldt_sysdate
long 			ll_nairline_key

ll_nairline_key	= dsCenOut.getitemnumber(arg_lcenoutrow, "nairline_key")

ldsSysQueueFlightBob = create uo_generate_datastore
ldsSysQueueFlightBob.dataobject = "dw_bob_schedule_gen"
ldsSysQueueFlightBob.settransobject( SQLCA)
ldsSysQueueFlightBob.retrieve(arg_nreq_flight_key, ll_nairline_key)

if ldsSysQueueFlightBob.rowcount() = 0 then
	destroy ldsSysQueueFlightBob
	return 1
end if

ls_cairline			= dsCenOut.getitemstring(arg_lcenoutrow, "cairline")
ls_ctlc_from			= dsCenOut.getitemstring(arg_lcenoutrow, "ctlc_from")
ls_csuffix				= dsCenOut.getitemstring(arg_lcenoutrow, "csuffix")
ldt_ddeparture		= dsCenOut.getitemdatetime(arg_lcenoutrow, "ddeparture")
li_nflight_number 	= dsCenOut.getitemnumber(arg_lcenoutrow, "nflight_number")

ldsBobSched = create uo_generate_datastore
ldsBobSched.dataobject = "dw_bob_schedule_gen"
ldsBobSched.settransobject( SQLCA)
ldsBobSched.retrieve(ls_cairline, li_nflight_number, ls_csuffix, ldt_ddeparture, ls_ctlc_from)

if ldsBobSched.rowcount()=0 then
	ll_flight_key = f_sequence("SEQ_CEN_BOB_SCHEDULE", SQLCA)

	if ll_flight_key = -1 then
		guoLog.uf_allways("["+ this.classname( )+".of_retrieve_bob_figures] Fehler bei der Ermittlung der SEQ_CEN_BOB_SCHEDULE" )
		destroy ldsBobSched
		return 0
	end if		
	
	ls_cclient			= dsCenOut.getitemstring(arg_lcenoutrow, "cclient")
	ls_ctlc_to			= dsCenOut.getitemstring(arg_lcenoutrow, "ctlc_to")
	ldt_sysdate		= f_jetzt()
	...
	INSERT INTO cen_bob_schedule  ( nflight_key, nsystem_key, cclient, cairline, nflight_number, csuffix, ddeparture, ctlc_from, ctlc_to, dorder_time, dtimestamp, nairline_key, nsource )  
  			values ( :ll_flight_key, 2, :ls_cclient, :ls_cairline, :li_nflight_number, :ls_csuffix, :ldt_ddeparture, :ls_ctlc_from, :ls_ctlc_to, :ldt_sysdate, :ldt_sysdate, :ll_nairline_key, 1 ); 

	if sqlca.sqlcode <> 0 then
		guoLog.uf_allways("["+ this.classname( )+".of_retrieve_bob_figures] Fehler bei der Anlage cen_bob_schedule (" + string(sqlca.sqlcode)+") "+sqlca.sqlerrtext )
		destroy ldsBobSched
		return 0
	end if	
else
...
ldsBobPaxCount.retrieve(ll_flight_key)

for li_row = 1 to ldsSysQueueFlightBob.rowcount()
	ls_find = "nclass_number = " + string( ldsSysQueueFlightBob.getitemnumber(li_row, "cen_class_name_nclass_number") )
	ls_find += " and cpackinglist = '"+ ldsSysQueueFlightBob.getitemstring(li_row, "cen_request_bob_cbob_type") + "' "
	...
	if li_found > 0 then
		...
		if ll_seq = -1 then
			guoLog.uf_allways("["+ this.classname( )+".of_retrieve_bob_figures] Fehler bei der Ermittlung der SEQ_CEN_BOB_PAX_COUNTS" )
			destroy ldsBobSched
			return 0
		end if		
		...
		ldsBobPaxCount.setitem(li_found, "ctext", ldsSysQueueFlightBob.getitemstring(li_row, "cen_class_name_cclass") )
		ldsBobPaxCount.setitem(li_found, "cclass", ldsSysQueueFlightBob.getitemstring(li_row, "cen_class_name_cclass"))
		ldsBobPaxCount.setitem(li_found, "nclass_number",  ldsSysQueueFlightBob.getitemnumber(li_row, "cen_class_name_nclass_number"))
		ldsBobPaxCount.setitem(li_found, "nbooking_class", ldsSysQueueFlightBob.getitemnumber(li_row, "cen_class_name_nbooking_class"))
		ldsBobPaxCount.setitem(li_found, "cpackinglist", ldsSysQueueFlightBob.getitemstring(li_row, "cen_request_bob_cbob_type"))
	end if

	ldsBobPaxCount.setitem(li_found, "nfixed_qty",  ldsSysQueueFlightBob.getitemnumber(li_row, "cen_request_bob_namount"))
...
guoLog.uf_allways("["+ this.classname( )+".of_retrieve_bob_figures] Create or Update " + string( ldsBobPaxCount.rowcount() ) +" BOB-Items Rows")
...
public function integer of_generate_flights_delete ();if ii_delete_flights = 1 then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_delete] start delete from cen_out: ")
	...
	If sqlca.sqlcode <> 0 then
		guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_delete] delete from cen_out - error " + string(sqlca.sqldbcode) + ": " + sqlca.sqlerrtext)
		of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline,string(dGenerationDate,s_app.sDateformat),"Can't delete flight schedule, sqlcode " + string(sqlca.sqlcode) + ".")
		rollback using sqlca;
		return 0
	else
		guoLog.uf_allways("["+ this.classname( )+".of_generate_flights_delete] finish delete from cen_out: " + string(sqlca.sqlnrows))
		return 1
	end if
end if
...
public function integer of_service_alive ();// --------------------------------------------------------------------------------------------------------------------
// Objekt : uo_generate
// Methode: of_service_alive (Function)
// Autor  : Heiko Rothenbach
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):
// none
...
//  Datum       Version  Autor          Kommentar
// --------------------------------------------------------------------------------------------------------------------
//  18.03.2020	   1.0      H.Rothenbach   Erstellung (ALM-ID 6208)
//
// --------------------------------------------------------------------------------------------------------------------
datastore 	lds
integer		li_ret
...
idsCenOutLoading.reset() // 05.05.2025 HR: request #11290 New dynamic loading settings on loading lists on CBASEclassic
...
public function integer of_update_flights (integer arg_was, integer arg_lrow);// --------------------------------------------------------------------------------------------------------------------
// Objekt : uo_generate
// Methode: of_update_flights (Function)
// Autor  : Heiko Rothenbach
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):
// integer arg_was     1: Flugliste speichern (vorher alles l$$HEX1$$f600$$ENDHEX$$schen)
//                             2: Flug mit all seinen Komponeten speichern
//							3: Abschluss
// integer arg_row		Zeile in CEN_OUT
// --------------------------------------------------------------------------------------------------------------------
// Return: integer    -1 	Fehler => Stop
//						  -2    Fehler => Speichern Flug, aber weiter
//						  1 	OK
// --------------------------------------------------------------------------------------------------------------------
//  Beschreibung: Wir wollen jetzt Flug f$$HEX1$$fc00$$ENDHEX$$r Flug speichern, um das LOG auf CEN_OUT_MEALS zu minimieren
//                         Daf$$HEX1$$fc00$$ENDHEX$$r l$$HEX1$$f600$$ENDHEX$$schen wir alle Fl$$HEX1$$fc00$$ENDHEX$$ge und speichern die Fl$$HEX1$$fc00$$ENDHEX$$ge mit Status 0 und COMMITen danach
//                         Im Anschluss l$$HEX1$$f600$$ENDHEX$$sen wir Flug f$$HEX1$$fc00$$ENDHEX$$r Flug auf und speichern nach jedem Flug
// --------------------------------------------------------------------------------------------------------------------
//  Modifikationen:
//  Datum       Version  Autor          Kommentar
// --------------------------------------------------------------------------------------------------------------------
//  20.05.2020	   1.0      H.Rothenbach   Erstellung
//
// --------------------------------------------------------------------------------------------------------------------

long		lSQLCode
long		lSQLRow 
Long		i, nairlinekey, nflightnumber, nlegnumber, lresult_key, lFound
String		sSQLErrorText, cunit, csuffix, cTLCFrom, cTLCTo, sFind
datetime ddeparture
			
choose case arg_was
	case 1 //Speichern der Flugliste
		guoLog.uf_allways("["+ this.classname( )+".of_update_flights] Speichern der Flugliste")
		...
		for i= dsCenOut.rowcount() to 1 step -1
			...
			// --------------------------------------------------------------------------------------------------------------------
			// Falls Flugnummer im dsCenOutNotRegenerate zu finden ist, dann auch auf Generierung verzichten
			// Es muss die ganze Strecke ber$$HEX1$$fc00$$ENDHEX$$cksichtigt werden, nicht nur CTLCFROM 
			// --------------------------------------------------------------------------------------------------------------------
			sFind = "nflight_number = " + string(nflightnumber) 
			sFind += " and nleg_number = "+string(nlegnumber)
			sFind += " and csuffix = '" + csuffix + "'"
			...
			if lFound > 0 then   
				guoLog.uf_allways("["+ this.classname( )+".of_update_flights] Flight found in NotToRegenerate Cache: " + string(lFlightNumber)+sSuffix+" Leg "+string(lLegNumber)+" " +sTLCFrom+"-"+sTLCTo)
				...
				if sqlca.sqlnrows>0 then
					guoLog.uf_allways("["+ this.classname( )+".of_update_flights] Delete Flight because new in DSCENOUT: "+string(nairlinekey)+" "+string(nflightnumber, "000")+csuffix+" "+string(ddeparture, "dd.mm.yyyy")+" Leg "+string(nlegnumber)+" "+cunit)
				end if 
			end if
		next	
		
		guoLog.uf_allways("["+ this.classname( )+".of_update_flights] CEN_OUT (" + string(dsCenOut.rowcount())+" rows)")
		...
		if dsCenOutPackets.RowCount()>0 then
			...
			if dsCenOutPackets.update() = -1 then
				...
				guoLog.uf_info("["+ this.classname( )+".of_update_flights] Rows in dsCenOutPackets: "+string(dsCenOutPackets.rowcount()))
			end if
		elseif bCFSAirline then
				guoLog.uf_info("["+ this.classname( )+".of_update_flights] Rows in dsCenOutPackets: 0")
		END IF
		...
		if dsCenOutLos.RowCount()>0 then
			...
			if dsCenOutLos.update() = -1 then
				...
				guoLog.uf_info("["+ this.classname( )+".of_update_flights] Rows in dsCenOutLos: "+string(dsCenOutLos.rowcount()))	
			end if
		elseif bCFSAirline then
				guoLog.uf_info("["+ this.classname( )+".of_update_flights] Rows in dsCenOutLos: 0")
		end if
	...
	// ######################################################################################
	case 2 //Speichern eines Fluges
		
		guoLog.uf_allways("["+ this.classname( )+".of_update_flights] Speichern eines Fluges")
		...
		guoLog.uf_allways("["+ this.classname( )+".of_update_flights] CEN_OUT_PAX (" + string(dsCenOutPax.rowcount())+" rows)")
		If dsCenOutPax.update() = -1 Then
			lSQLCode 		= dsCenOutPax.lSQLErrorDBCode
			lSQLRow  		= dsCenOutPax.lSQLErrorRow
			sSQLErrorText	= dsCenOutPax.sSQLErrorText
		...
		guoLog.uf_allways("["+ this.classname( )+".of_update_flights] CEN_OUT_MEALS (" + string( uo_generate_meals.dsCenOutMeals.rowcount())+" rows)")
		if uo_generate_meals.uf_write_cen_out_meals() = -1 then
			lSQLCode 		= uo_generate_meals.dsCenOutMeals.lSQLErrorDBCode
			lSQLRow  		= uo_generate_meals.dsCenOutMeals.lSQLErrorRow
			sSQLErrorText	= uo_generate_meals.dsCenOutMeals.sSQLErrorText
		...
		guoLog.uf_allways("["+ this.classname( )+".of_update_flights] CEN_OUT_SPML (" + string(dsCenOutAllSPML.rowcount())+" rows)")
		if dsCenOutAllSPML.update() = -1 Then
				lSQLCode 		= dsCenOutAllSPML.lSQLErrorDBCode
				lSQLRow  		= dsCenOutAllSPML.lSQLErrorRow
				sSQLErrorText	= dsCenOutAllSPML.sSQLErrorText
		...
		if dsCenOutPPM.update() = -1 then
			...
			guoLog.uf_info("["+ this.classname( )+".of_update_flights] Rows in dsCenOutPPM: "+string(dsCenOutPPM.rowcount()))	
		end if
		...
		if dsCenOutPPMStowages.update() = -1 then
			...
			guoLog.uf_info("["+ this.classname( )+".of_update_flights] Rows in dsCenOutPPMStowages: "+string(dsCenOutPPMStowages.rowcount()))	
		end if
		...
		if dsCenOut.update() = -1 then
			...
			of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline, &
									string(dGenerationDate,s_app.sDateformat),&
									"Can't write generated cen_out to database, sqlcode " + &
									string(lSQLCode))
			f_job_error(string(dGenerationDate,"dd.mm.yyyy") + "~t" + sclient + "~t" + &
							sunit + "~tCan't write generated cen_out to database, " + &
							"sqlcode : " + string(lSQLCode) + "~n" + sSQLErrorText,sTraceFile + "-" + this.sInstanceName + ".log")
			return -2
		end if
		
		dsCenOut.setrow(arg_lrow)
		
		if not this.of_update_history( ) then
			return -2
		end if 
		
		commit;
		
		this.of_reset_flight_ds( )

		of_lock_flights(arg_lrow)

	// ######################################################################################
	case 3 // Abschluss
		guoLog.uf_allways("["+ this.classname( )+".of_update_flights] Finales Speichern")
		...
		if dsCenOutCheckPt.update() = -1 then
			...
			guoLog.uf_info("["+ this.classname( )+".of_update_flights] Rows in dsCenOutCheckPt: "+string(dsCenOutCheckPt.rowcount()))	
		end if
...
public function integer of_lock_flights (integer arg_start);long i, lresult_key, lfrom, lret = 1

if arg_start = 0 then 
	lfrom = 1
else
	lfrom = arg_start + 1
	if lfrom > dsCenOut.rowcount() then return 1
end if 

for i = lfrom to dsCenOut.rowcount()
	lresult_key = dsCenOut.getitemnumber(i, "nresult_key")
	...
	If sqlca.sqlcode <> 0 then
		guoLog.uf_allways("["+ this.classname( )+".of_lock_flights] Lock flight " + string(dsCenOut.getitemnumber(i, "nresult_key")) +" - error " + string(sqlca.sqldbcode) + ": " + sqlca.sqlerrtext)
		lret = 0
	end if
next
...
public function boolean of_generate_spml_from_amos (long lcenoutrow);long 		i, j, lSPML_Class, lSPML_Quantity, lFound, lFind, lreturn, lSPML_Quantity_Old
string		sSPML_Class, sSPML, sFindString
integer	iSPML_TopOff

if dsFlightDataSpml.rowcount()=0 then return true
...
For i = 1 to dsFlightDataSpml.Rowcount()

	lSPML_Class			= dsFlightDataSpml.GetItemNumber(i,"cen_pax_flight_info_nclass_number")
	sSPML_Class		= dsFlightDataSpml.GetItemString(i,"cen_pax_flight_info_cclass")
	...
	sSPML				= dsFlightDataSpml.GetItemString(i,"cen_pax_spml_info_cspml_code")
	lSPML_Quantity		= dsFlightDataSpml.GetItemNumber(i,"nquantity")
	...
	if lFind = 0 then
		...
		if lReturn > 0 then
			...
			dsCenOutNewSPML.SetItem(lReturn,"ntopoff",iSPML_TopOff)
			dsCenOutNewSPML.SetItem(lReturn,"status_nquantity",1)
			dsCenOutNewSPML.SetItem(lReturn,"cspml_source", 'AMOS' )  // 23.04.2025 HR: Almid 11358 Flight Generation with SPML setting "Forecast" is ignoring SPMLs
...
if isnull(sText) then return "<NULL>"
...
public function integer of_get_dynamicmeals (string arg_ls_cflight_key);// --------------------------------------------------------------------------------------------------------------------
// Objekt : uo_generate
// Methode: of_get_dynamicmeals (Function)
// Autor  : Heiko Rothenbach
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):
// string arg_ls_cflight_key
// --------------------------------------------------------------------------------------------------------------------
// Return: integer
// --------------------------------------------------------------------------------------------------------------------
//  Beschreibung:
...
//  Datum       Version  Autor          Kommentar
// --------------------------------------------------------------------------------------------------------------------
//  26.01.2023	   1.0      H.Rothenbach   Erstellung
//
// --------------------------------------------------------------------------------------------------------------------
...
if ib_use_dynamic_meals then
	
	if uo_generate_meals.idsCITPFlightDataPreorder.Retrieve(arg_ls_CFLIGHT_KEY) > 0 then
		guoLog.uf_debug("["+ this.classname( )+".of_get_dynamicmeals] idsCITPFlightDataPreorder Rows all Request: " + string( uo_generate_meals.idsCITPFlightDataPreorder.rowcount()))
		//Wir lassen nur die letzte Abfrage stehen
		for i = uo_generate_meals.idsCITPFlightDataPreorder.rowcount() to 1 step -1
			if uo_generate_meals.idsCITPFlightDataPreorder.getitemnumber(i, "nreq_flight_key") =  uo_generate_meals.idsCITPFlightDataPreorder.getitemnumber(1, "nreq_flight_key") then exit
			
			uo_generate_meals.idsCITPFlightDataPreorder.deleterow( i)
		next
		guoLog.uf_debug("["+ this.classname( )+".of_get_dynamicmeals] idsCITPFlightDataPreorder Rows last Request: " + string( uo_generate_meals.idsCITPFlightDataPreorder.rowcount()))
	else
		guoLog.uf_error("["+ this.classname( )+".of_get_dynamicmeals] no rows in uo_generate_meals.idsCITPFlightDataPreorder for " + arg_ls_CFLIGHT_KEY)
	end if
...
return uo_generate_meals.idsCITPFlightDataPreorder.rowcount()
end function

public function boolean of_generate_flightclose ();// --------------------------------------------------------------------------------------------------------------------
// Objekt : uo_generate
// Methode: of_generate_flightclose (Function)
// Autor  : Heiko Rothenbach
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):
// none
...
//  Datum       Version  Autor          Kommentar
// --------------------------------------------------------------------------------------------------------------------
//  05.06.2023	   1.0      H.Rothenbach   Erstellung
//
// --------------------------------------------------------------------------------------------------------------------

long 	i, ll_okay, ll_fehler, j, lfind
longlong lll_result_key
string ls_log, ls_return
...
dsFlightClosedFlights.reset()

// --------------------------------------------------------------------------------------------------------------------
// 18.03.2024 HR: Sortierung setzen
// --------------------------------------------------------------------------------------------------------------------
dsCenOut.setsort(" nresult_key_group A,  nleg_numbe A")
dsCenOut.sort()
dsCenOut.retrieve(lAirlineKey, dGenerationDate, sclient, sunit)

guoLog.uf_allways("["+ this.classname( )+".of_generate_flightclose] " + string(dsCenOut.rowcount())+ " Flights found") 

if dsCenOut.rowcount()>0 then
	ii_fc_KeepRegistration	= integer( f_unitprofilestring("Default", "SET_REGISTRATION",			"0", dsCenOut.getitemstring(1, "cunit") ) )
	ii_fc_OfCXwithoutReg 	= integer( f_unitprofilestring("Default", "FlightCloseOfCXwithoutReg",	"0", dsCenOut.getitemstring(1, "cunit") ) )
	ll_okay 						= 0
	ll_fehler 						= 0

	select NTAILNUMBER_CHECKOFF
	into :ii_fc_NoRegistrationCheck
	from cen_airlines
	where nairline_key = :lAirlineKey ;

	if sqlca.sqlcode=100 then
		ii_fc_NoRegistrationCheck =0
	elseif sqlca.sqlcode<0 then
		ii_fc_NoRegistrationCheck =0
	end if
	
	guoLog.uf_debug("["+ this.classname( )+".of_generate_flightclose] ii_fc_NoRegistrationCheck="+string(ii_fc_NoRegistrationCheck) + ", ii_fc_KeepRegistration="+string(ii_fc_KeepRegistration)+", ii_fc_OfCXwithoutReg="+string(ii_fc_OfCXwithoutReg))
	
	// Lock all flights
	if of_lock_flights(0) = 0 then
		guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] of_lock_flights returns 0 (not all flights could be locked)")
		
		// --------------------------------------------------------------------------------------------------------------------
		// 18.03.2024 HR: Sortierung zur$$HEX1$$fc00$$ENDHEX$$cksetzen
		// --------------------------------------------------------------------------------------------------------------------
		dsCenOut.setsort(" nrouting_group_key A,  nleg_numbe A")
		dsCenOut.sort()
	...
	lTransActionKey = of_get_history_key()
	If lTransActionKey = -1 Then
		guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] of_get_history_key() returns -1")
	...
	for i=1 to dsCenOut.rowcount() 
		...
		if of_flightclose_for_one_flight(i) then
			ll_okay ++
		else
			ll_fehler ++
			if i > 1 then
				for j=1 to i -1
					//Wir l$$HEX1$$f600$$ENDHEX$$schen alle Legs, die bereits in der INVOICE-QUEUE stehen
					if  dsCenOut.getitemnumber(i, "nresult_key_group") = dsCenOut.getitemnumber(j, "nresult_key_group") then
						// --------------------------------------------------------------------------------------------------------------------
						// 18.03.2024 HR: Kein R$$HEX1$$fc00$$ENDHEX$$ckspielen von Status und Transaction wenn OLD noch auf -1
						// --------------------------------------------------------------------------------------------------------------------
						if dsCenOut.getitemnumber(j, "nold_flight_status") >= 0 then
							dsCenOut.setitem(j, "nstatus", 			dsCenOut.getitemnumber(j, "nold_flight_status"))
						end if
						
						if dsCenOut.getitemnumber(j, "nold_transaction") >= 0 then
							dsCenOut.setitem(j, "ntransaction", 	dsCenOut.getitemnumber(j, "nold_transaction"))
						end if
						
						lfind = dsFlightClosedFlights.find("nresult_key = " + string( dsCenOut.getitemnumber(j, "nresult_key")) , 1, dsFlightClosedFlights.rowcount())
						if lfind > 0 then
							guoLog.uf_debug("["+ this.classname( )+".of_generate_flightclose] Delete Invoice for nresult_key " + string(dsCenOut.getitemnumber(j, "nresult_key")))
							ll_okay --
							ll_fehler ++
							of_write_protocol(iJob_Type, iGenerierungsstatus, 2, iWarnung, &
							         dsCenOut.GetItemString(i, "cairline") + string(dsCenOut.GetItemNumber(i, "nflight_number"), "0000") + dsCenOut.GetItemString(i, "csuffix"), &
									string(dGenerationDate,s_app.sDateformat),&
									"Leg " + string(dsCenOut.getitemnumber(j, "nleg_number"))+" " + string(dsCenOut.getitemnumber(j, "nflight_number"))+" cannot invoiced, too")
    
							dsFlightClosedFlights.deleterow(lfind)
						end if
					end if
				next
				
				//Wir ignorieren weitere noch nicht bearbeitete LEGS
					...
					for j = i + 1 to dsCenOut.rowcount()
						if dsCenOut.getitemnumber(i, "nresult_key_group") = dsCenOut.getitemnumber(j, "nresult_key_group") then
							of_write_protocol(iJob_Type, iGenerierungsstatus, 2, iWarnung, &
							                          dsCenOut.GetItemString(i, "cairline") + string(dsCenOut.GetItemNumber(i, "nflight_number"), "0000") + dsCenOut.GetItemString(i, "csuffix"), &
									                string(dGenerationDate,s_app.sDateformat),&
									                "Leg " + string(dsCenOut.getitemnumber(j, "nleg_number"))+" " + string(dsCenOut.getitemnumber(j, "nflight_number"))+" also ignored")
							guoLog.uf_info("["+ this.classname( )+".of_generate_flightclose] Ignore Flight Leg " + string(dsCenOut.getitemnumber(j, "nleg_number"))+" " + string(dsCenOut.getitemnumber(j, "nflight_number"))+" (" + string(dsCenOut.getitemnumber(j, "nresult_key"))+") as other legs are not ready to invopice")
							i = j
							ll_fehler ++
						else
							exit
	...
	// Save flights and INVOICE Jobs
	j = 0
	if dsCenOut.update() = 1 then
		guoLog.uf_debug("["+ this.classname( )+".of_generate_flightclose] Flights saved")
		if dsFlightClosedFlights.update() = 1 then
			guoLog.uf_debug("["+ this.classname( )+".of_generate_flightclose] Invoice Jobs saved (rows: " + string(dsFlightClosedFlights.rowcount()) +")")

			// Create History 
			for i=1 to dsCenOut.rowcount()
				if  dsCenOut.getitemnumber(i, "ntransaction") = lTransActionKey then 
					if of_create_flighthistory( dsCenOut.getitemnumber(i, "nresult_key"), ls_return )> 0 then
						guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] Error create History. Process stopped")
						ls_log = "Error create History. Process stopped: " + ls_return
						j = 3
						exit
					end if
				end if
			...
			guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] Error create Invoice Jobs")
			guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] Error: "+ dsFlightClosedFlights.sSQLErrorText )
			
			ls_log = "Error create Invoice Jobs"
			j = 2
		end if
	else
		guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] Error save flights")
		guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] Error: "+ dsCenOut.sSQLErrorText )
		ls_log = "Error save flights"
		j = 1
	end if
	...
	if j = 0 then
		guoLog.uf_info("["+ this.classname( )+".of_generate_flightclose] Create " + string( ll_okay ) +" Invoice-Jobs and have " + string( ll_fehler ) +" Flights with errors which can't invoiced")
		
		// 18.03.2024 HR: Count f$$HEX1$$fc00$$ENDHEX$$rs LOG
		lJobActions = ll_okay
		...
		guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] " + string(dGenerationDate,"dd.mm.yyyy") + " " + sclient + " " + &
						sunit + " " + ls_log)
		return False
	...
	guoLog.uf_info("["+ this.classname( )+".of_generate_flightclose] No flights found for this day")
	of_write_protocol(iJob_Type,iGenerierungsstatus,1,iInfo,sAirline,string(dGenerationDate,s_app.sDateformat),"Successfully generated in " + string ((lTimeEnd - lTimeStart) / 1000 , "0.000") + " seconds.") 
	commit using sqlca;
	return True
...
public function boolean of_generate_distribution ();// --------------------------------------------------------------------------------------------------------------------
// Objekt : uo_generate
// Methode: of_generate_distribution (Function)
// Autor  : Heiko Rothenbach
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):
// none
...
// Return: boolean
// --------------------------------------------------------------------------------------------------------------------
//  Beschreibung: Create Distribution FlightCalc Jobs for a Day / Unit / Airline
//					   ( Alm-ID 8358: 2 new generation jobs requested ) 
// --------------------------------------------------------------------------------------------------------------------
//  Modifikationen:
//  Datum       Version  Autor          Kommentar
// --------------------------------------------------------------------------------------------------------------------
//  17.05.2023	   1.0      H.Rothenbach   Erstellung
//
// --------------------------------------------------------------------------------------------------------------------
...
if dsCenOut.rowcount()>0 then
	if not of_generate_flightcalcjobs(10, dsCenOut, 0) then
		of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline, &
								string(dGenerationDate,s_app.sDateformat),&
								"Can't generate flightcalc jobs for distribution")
		return False		
	...
	guoLog.uf_info("["+ this.classname( )+".of_generate_distribution] No flights found for this day")
...
// Return: boolean
// --------------------------------------------------------------------------------------------------------------------
//  Beschreibung: Create FlightCalc Jobs to recalc the flights for a Day / Unit / Airline and afterwards create Documents
//					   ( Alm-ID 8358: 2 new generation jobs requested ) 
// --------------------------------------------------------------------------------------------------------------------
//  Modifikationen:
//  Datum       Version  Autor          Kommentar
...
if dsCenOut.rowcount()>0 then
	if not of_generate_flightcalcjobs(1, dsCenOut, 1) then
		of_write_protocol(iJob_Type,iGenerierungsstatus,1,iFehler,sAirline, &
								string(dGenerationDate,s_app.sDateformat),&
								"Can't generate flightcalc jobs for recalc and distribution")
		return False		
	...
	guoLog.uf_info("["+ this.classname( )+".of_generate_flightcalc] No flights found for this day")
...
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):	
// integer arg_function
// datastore arg_dscenout
// integer arg_distribution
// --------------------------------------------------------------------------------------------------------------------
// Return: boolean
// --------------------------------------------------------------------------------------------------------------------
...
//  06.09.2016     1.1      H.Rothenbach   Erweiterung um Aufrufparameter f$$HEX1$$fc00$$ENDHEX$$r die zu setzenden Funktion
// --------------------------------------------------------------------------------------------------------------------
...
if arg_dsCenOut.rowcount()=0 then 
	return True
end if
...
// --------------------------------------------------------------------------------------------------------------------
if f_cen_profilestring("MealDistribution","SaveDistribution","0") = "0" and arg_function = 10 then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_flightcalcjobs] Function "+string(arg_function)+": SaveDistribution is switched off. No Flightcalc-Jobs are created")
	return true
end if
...
for i=1 to arg_dsCenOut.rowcount()
	// --------------------------------------------------------------------------------------------------------------------
	...
	// --------------------------------------------------------------------------------------------------------------------
	if arg_dsCenOut.GetItemnumber(i, "nleg_number") > 1 and  arg_function = 10 then continue
	
	lsequence = f_sequence("seq_sys_queue_flight_calc", sqlca)

	if lsequence = -1 then
		guoLog.uf_error("["+ this.classname( )+".of_generate_flightcalcjobs] Function "+string(arg_function)+": Error getting Sequence:  " + string( SQLCA.SQLCODE) + " - " + SQLCA.SQLERRTEXT)
		destroy lds
		return false
	end if 
	...
	lds.SetItem(1, "njob_nr", lSequence)
	lds.SetItem(1, "nresult_key", arg_dsCenOut.GetItemnumber(i, "nresult_key"))
	lds.SetItem(1, "ddeparture", Datetime(Date(arg_dsCenOut.GetItemDatetime(i, "ddeparture")), Time(arg_dsCenOut.GetItemString(i, "cdeparture_time"))))
	...
	lds.SetItem(1, "nstatus", arg_dsCenOut.GetItemnumber(i, "nstatus"))
	lds.SetItem(1, "nfunction", arg_function)
	lds.SetItem(1, "nforecast",0)
	lds.SetItem(1, "nhistory",0)
	lds.SetItem(1, "njob_group", lSequence)
	lds.SetItem(1, "cdescription",arg_dsCenOut.GetItemString(i,"cairline") + " " + String(arg_dsCenOut.GetItemNumber(i,"nflight_number")) + " " + String(Date(arg_dsCenOut.GetItemDatetime(i,"ddeparture"))))
	lds.SetItem(1, "nsort", 1)	
	lds.SetItem(1, "NDOC_GENERATION", arg_distribution)  // 17.05.2023 HR: AlmID 8358  2 new generation jobs requested
next

if lds.update()=1 then
	guoLog.uf_allways("["+ this.classname( )+".of_generate_flightcalcjobs] Function "+string(arg_function)+":  Generate " + string( lds.rowcount()) + " FlightCalc Jobs.")
	...
	guoLog.uf_error("["+ this.classname( )+".of_generate_flightcalcjobs] Function "+string(arg_function)+": Update Error:  " + string( lds.lSQLErrorDBCode)+" "+lds.sSQLErrorText)
...
public function boolean of_flightclose_for_one_flight (long arg_row);
// Modified function from w_change_center.wf_flight_closed()
long				lStart , lCurrentLeg, lGroupKey, lFind
DateTime		dtCheckdate
DateTime		dtCreated
String 			ls_flight
String 			ls_Message = ""
string				sRegistrationLeg1, sCurrentRegistration
long 				ll_SalesOrderSent = 0
long				lSequence
//time				tDepartureTime


lStart 				= CPU()	
dtCheckdate		= DateTime(Date(dsCenOut.GetitemDateTime(arg_row,"ddeparture")), + &
								  Time(dsCenOut.GetitemString(arg_row,"cdeparture_time")))

ls_flight = dsCenOut.GetItemString(arg_row,"cairline") + string(dsCenOut.GetItemNumber(arg_row,"nflight_number"), "0000") + dsCenOut.GetItemString(arg_row,"csuffix") 
ls_flight += dsCenOut.GetItemString(arg_row,"ctlc_from") + dsCenOut.GetItemString(arg_row,"ctlc_to")
ls_flight += " ("+string( dsCenOut.GetItemNumber(arg_row,"nresult_key") )+"): "

guoLog.uf_debug("["+ this.classname( )+".of_flightclose_for_one_flight] Start flight " + ls_flight)

dsCenOut.setitem(arg_row, "nold_flight_status", 	dsCenOut.GetItemNumber(arg_row,"nstatus"))							  
dsCenOut.setitem(arg_row, "nold_transaction", 	dsCenOut.GetItemNumber(arg_row,"ntransaction"))							  

// Plausi: Abflugzeit muss $$HEX1$$fc00$$ENDHEX$$berschritten sein ( nicht SAP-LAM )
if s_app.iInvoicingType <> 5 then
	if DateTime(Today(),Now()) < dtCheckdate then
		guoLog.uf_info("["+ this.classname( )+".of_flightclose_for_one_flight] "+ls_flight + "Flug hat Abflugzeit noch nicht erreicht.")

		of_write_protocol(iJob_Type, iGenerierungsstatus, 2, iWarnung, &
		                          dsCenOut.GetItemString(arg_row,"cairline") + string(dsCenOut.GetItemNumber(arg_row,"nflight_number"), "0000") + dsCenOut.GetItemString(arg_row,"csuffix"), &
							    string(dGenerationDate, s_app.sDateformat), &
								"The Departure Time of this Flight is not reached")		
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// Plausi: Sales Order muss erfolgreich geschickt worden sein, nur SAP-LAM
// norder_sent: 0 nix - 1 in queue - 2 abgeschickt - 3 best$$HEX1$$e400$$ENDHEX$$tigt - > 3 Fehler
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if s_app.iInvoicingType = 5 then
	ll_SalesOrderSent = dsCenOut.GetitemNumber(arg_row,"norder_sent")
	if IsNull(ll_SalesOrderSent) then ll_SalesOrderSent = 0
	
	if ll_SalesOrderSent <> 3 then
		
		// fehler als Default
		ls_Message = "Sales Order not sent successfully."
		choose case ll_SalesOrderSent
		case 0 	// noch nicht gemacht
			ls_Message = "Sales Order not sent successfully"
		case 1 	// in queue: noch nicht bearbeitet
			ls_Message = "Sales order in progress, please try later."
		case 2 	// geschickt, aber nicht best$$HEX1$$e400$$ENDHEX$$tigt
			ls_Message = "Sales Order not yet confirmed.."
		end choose
		
		guoLog.uf_info("["+ this.classname( )+".of_flightclose_for_one_flight] "+ls_flight  + ls_Message )
		of_write_protocol(iJob_Type, iGenerierungsstatus, 2, iWarnung, &
		                          dsCenOut.GetItemString(arg_row,"cairline") + string(dsCenOut.GetItemNumber(arg_row,"nflight_number"), "0000") + dsCenOut.GetItemString(arg_row,"csuffix"), &
							    string(dGenerationDate,s_app.sDateformat), &
								ls_Message)		
...
// Jetzt auch bei FlightClosed: $$HEX1$$dc00$$ENDHEX$$bertrag der Registration vom ersten Leg
if ii_fc_KeepRegistration = 1 then
	lCurrentLeg = dsCenOut.GetItemNumber(arg_row,"nleg_number")
	if lCurrentLeg > 1 then
		lGroupKey	= dsCenOut.GetItemNumber(arg_row,"nresult_key_group")
		lFind = dsCenOut.Find("nresult_key_group = " + string(lGroupKey) + " and nleg_number = 1",1,dsCenOut.RowCount())
		if lFind > 0 then
			if ii_fc_KeepRegistration = 1 then
				sRegistrationLeg1 = dsCenOut.GetItemString(lFind,"cregistration")
				sCurrentRegistration = dsCenOut.GetItemString(arg_row,"cregistration")
				if not isnull(sRegistrationLeg1) then
					if sCurrentRegistration <> sRegistrationLeg1 then
						dsCenOut.Setitem(arg_row,"cregistration",sRegistrationLeg1)
					end if
				end if
			end if
		end if
...
if ii_fc_NoRegistrationCheck = 0 and (dsCenOut.GetItemNumber(arg_row,"nflight_status") = 0 or &
   (ii_fc_OfCXwithoutReg=1 and dsCenOut.GetItemNumber(arg_row,"nflight_status") = 1)) then
	
	If	isnull(dsCenOut.GetitemString(arg_row,"cregistration")) or &
		len(trim(dsCenOut.GetitemString(arg_row,"cregistration"))) = 0 Then 
		guoLog.uf_info("["+ this.classname( )+".of_flightclose_for_one_flight] Flug hat keine Registration.")
		of_write_protocol(iJob_Type, iGenerierungsstatus, 2 ,iWarnung, &
		                          dsCenOut.GetItemString(arg_row,"cairline") + string(dsCenOut.GetItemNumber(arg_row,"nflight_number"), "0000") + dsCenOut.GetItemString(arg_row,"csuffix"), &
							    string(dGenerationDate,s_app.sDateformat), &
								"The Tail Number is missing of this flight")		
		return False
	End if
end if
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
If	dsCenOut.GetitemNumber(arg_row,"nstatus") >= 6 Then 
	guoLog.uf_info("["+ this.classname( )+".of_flightclose_for_one_flight] Flugstatus ("+string(dsCenOut.GetitemNumber(arg_row,"nstatus"))+") l$$HEX1$$e400$$ENDHEX$$sst keine Ver$$HEX1$$e400$$ENDHEX$$nderung zu.")
	of_write_protocol(iJob_Type, iGenerierungsstatus, 2, iWarnung, &
	                          dsCenOut.GetItemString(arg_row,"cairline") + string(dsCenOut.GetItemNumber(arg_row,"nflight_number"), "0000") + dsCenOut.GetItemString(arg_row,"csuffix"), &
							string(dGenerationDate,s_app.sDateformat), &
							"The Flight Status prevents a modification")		

	return False
End if

// --------------------------------------------------------------------------------------------------------------------
// Beim Train Business wird der Satz sp$$HEX1$$e400$$ENDHEX$$ter angelegt
// --------------------------------------------------------------------------------------------------------------------
if dsCenOut.getitemnumber( arg_row,"ntb") = 0 then
	dtCreated 			= datetime(today(),now())
	lSequence 			= f_Sequence("seq_sys_flight_pricer", sqlca)

	If lSequence = -1 Then
		guoLog.uf_info("["+ this.classname( )+'.of_flightclose_for_one_flight] '+ls_flight + 'Fehler f_Sequence("seq_sys_flight_pricer"')
		of_write_protocol(iJob_Type, iGenerierungsstatus, 2, iWarnung, &
		                          dsCenOut.GetItemString(arg_row,"cairline") + string(dsCenOut.GetItemNumber(arg_row,"nflight_number"), "0000") + dsCenOut.GetItemString(arg_row,"csuffix"), &
								string(dGenerationDate,s_app.sDateformat),&
								"Could not set flight into Flight Closed mode")		
		return False
	end if
	
	dsFlightClosedFlights.insertrow(1)
	dsFlightClosedFlights.setitem(1, "njob_nr", 				lSequence)
	dsFlightClosedFlights.setitem(1, "nresult_key", 			dsCenOut.GetItemNumber(arg_row,"nresult_key") )
	dsFlightClosedFlights.setitem(1, "ddeparture", 			dtCheckdate)
	dsFlightClosedFlights.setitem(1, "dcreated", 			dtCreated)
	dsFlightClosedFlights.setitem(1, "nstatus", 				0)
	dsFlightClosedFlights.setitem(1, "nfunction", 			1)
end if

dsCenOut.Setitem(arg_row,	"nstatus", 			6)
dsCenOut.Setitem(arg_row,	"ntransaction", 		lTransActionKey)
dsCenOut.Setitem(arg_row,	"dtimestamp", 		dtCreated)
...
public function integer of_create_flighthistory (longlong arg_result_key, ref string arg_return);// --------------------------------------------------------------------------------------------------------------------
// Objekt : uo_generate
// Methode: of_create_flighthistory (Function)
// Autor  : Heiko Rothenbach
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):
// longlong arg_result_key
// string	arg_return
// --------------------------------------------------------------------------------------------------------------------
// Return: integer
// --------------------------------------------------------------------------------------------------------------------
...
//  Datum       Version  Autor          Kommentar
// --------------------------------------------------------------------------------------------------------------------
//  20.06.2023	   1.0      H.Rothenbach   Erstellung
//
// --------------------------------------------------------------------------------------------------------------------
...
j = 0
guoLog.uf_debug("["+ this.classname( )+".of_create_flighthistory] Start") 

declare createHistory procedure for CBASE_HISTORY.PP_CREATE_HISTORY(:arg_result_key) using SQLCA;

if SQLCA.sqlcode <> 0 THEN
	j = 3
	guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] (" + string(arg_result_key)+") CBASE_HISTORY.PP_CREATE_HISTORY Declare failed: " + string(SQLCA.sqlcode))
	arg_return = "Error CBASE_HISTORY.PP_CREATE_HISTORY Declare"
else
	execute createHistory ;
	if SQLCA.sqlcode <> 0 THEN
		j = 4							
		guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] (" + string(arg_result_key)+")  CBASE_HISTORY.PP_CREATE_HISTORY Execute failed: " + string(SQLCA.sqlcode))
		arg_return = "Error CBASE_HISTORY.PP_CREATE_HISTORY Execute"
	else
		fetch createHistory into :ls_return;
		
		if SQLCA.sqlcode <> 0 THEN
			j = 5							
			guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] (" + string(arg_result_key)+") CBASE_HISTORY.PP_CREATE_HISTORY fetch failed: " + string(SQLCA.sqlcode))
			arg_return = "Error CBASE_HISTORY.PP_CREATE_HISTORY fetch"

		else		
			if ls_return <> 'OK' then
				j = 6
				guoLog.uf_error("["+ this.classname( )+".of_generate_flightclose] (" + string(arg_result_key)+") CBASE_HISTORY.PP_CREATE_HISTORY returns: " +ls_return)
				arg_return = "PP_CREATE_HISTORY returns: " +ls_return

			else
				guoLog.uf_debug("["+ this.classname( )+".of_generate_flightclose] (" + string(arg_result_key)+") History created")
			end if
		end if
	end if
...
public function longlong of_get_polaris_docnr ();// --------------------------------------------------------------------------------------------------------------------
// Objekt : uo_generate
// Methode: of_get_polaris_docnr
// Autor  : Heiko Rothenbach
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):
// none
// --------------------------------------------------------------------------------------------------------------------
// Return: Polaris DocNumber
// --------------------------------------------------------------------------------------------------------------------
//  Beschreibung:
//
//
...
//  Datum       Version  Autor          Kommentar
// --------------------------------------------------------------------------------------------------------------------
//  31.01.2025	   1.0      H.Rothenbach   Erstellung
//
// --------------------------------------------------------------------------------------------------------------------

ids_polaris_documentnumber.retrieve(sAirline, lFlightNumber, dNewGenerationDate, sTLCFrom, sTLCTo )

if ids_polaris_documentnumber.rowcount() > 0 then
	if ids_polaris_documentnumber.rowcount() > 1 then
		guoLog.uf_error( "["+ this.classname( )+".of_get_polaris_docnr] Found " + string( ids_polaris_documentnumber.rowcount() )+" Polaris-Flights for " +sAirline + string(lFlightNumber, "000") + " " + string(dNewGenerationDate, "DD.MM.YYYY") +" " + sTLCFrom +"-"+ sTLCTo )
	end if
	
	guoLog.uf_debug( "["+ this.classname( )+".of_get_polaris_docnr] Doc-Nr " + string( ids_polaris_documentnumber.getitemnumber(1, "sky_polaris_ndelivery_note_no") )+" used for Polaris-Flights for " +sAirline + string(lFlightNumber, "000") + " " + string(dNewGenerationDate, "DD.MM.YYYY") +" " + sTLCFrom +"-"+ sTLCTo )
	return ids_polaris_documentnumber.getitemnumber(1, "sky_polaris_ndelivery_note_no")
else
	guoLog.uf_debug( "["+ this.classname( )+".of_get_polaris_docnr] No Polaris-Flights for " +sAirline + string(lFlightNumber, "000") + " " + string(dNewGenerationDate, "DD.MM.YYYY") +" " + sTLCFrom +"-"+ sTLCTo )
	return 0
end if
...
public function integer of_generate_loading ();// --------------------------------------------------------------------------------------------------------------------
// Objekt : uo_generate
// Methode: of_generate_loading (Function)
// Autor  : Heiko Rothenbach
// --------------------------------------------------------------------------------------------------------------------
// Argument(e):
// none
...
//  Datum       Version  Autor          Kommentar
// --------------------------------------------------------------------------------------------------------------------
//  25.04.2025	   1.0      H.Rothenbach   Erstellung
//
// --------------------------------------------------------------------------------------------------------------------

datastore 						ldw_cutoff
long 								lrow1, lrow2, lrow3
string 								ls_filter
long 								lSeq
datetime						ldt_jetzt
uo_flight_explosion	uo_explosion

guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] lResultKey = " + string(lResultKey) + ", dNewGenerationDate = " + string(dNewGenerationDate) + ", sDepartureTime = " + sDepartureTime +", idsOldCenOutLoading.rows: "+string(idsOldCenOutLoading.rowcount()) )

ldw_cutoff = create datastore
ldw_cutoff.dataobject = "dw_loc_unit_airline_cutoff"
ldw_cutoff.settransobject(SQLCA)

if ldw_cutoff.retrieve( sUnit, lAirlinekey, lFlightNumber, sRoutingShortText, sDepartureTime, dGenerationDate )>0 then
	guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] Found a Cutoff Time found for sUnit="+sUnit+", lAirlinekey="+string(lAirlinekey)+", lFlightNumber="+string(lFlightNumber)+", sRoutingShortText="+sRoutingShortText+", sDepartureTime="+sDepartureTime+", dGenerationDate="+string(dGenerationDate))	
	
	lrow1 = ldw_cutoff.getitemnumber(1, "ncutoff_minutes")
	ldt_jetzt = f_jetzt()
	lrow2 = f_dt_diff(ldt_jetzt, dtDepartureTimeLocal)
	
	if  lrow2 <= lrow1 * 60 then
		guoLog.uf_info("["+ this.classname( )+".of_generate_loading] Loading will not changed. Dep: "+string(dtDepartureTimeLocal, "dd.mm.yy hh:mm") +" / now: "+string(ldt_jetzt, "dd.mm.yy hh:mm")+", Diff: " + string(lrow2 / 60) +" / CutOff: "+string(lrow1))
		
		idsCenOutLoading.reset()
		if idsOldCenOutLoading.rowcount() > 0 then
			lrow3 = idsOldCenOutLoading.rowscopy(1, idsOldCenOutLoading.rowcount(), primary!, idsCenOutLoading, 1, primary!)
			if lrow3 <> 1 then
				guoLog.uf_error("["+ this.classname( )+".of_generate_loading] Copy Loading OLD to NEW due to CutoffTime: idsOldCenOutLoading(" +idsOldCenOutLoading.dataobject+") => idsCenOutLoading("+idsCenOutLoading.dataobject +") => " +string(lrow3) )
			else
				guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] Copy " + string(idsOldCenOutLoading.rowcount()) +" from idsOldCenOutLoading to idsCenOutLoading")
			end if
		else
			guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] No Rows in idsOldCenOutLoading")
		end if
		return 1
	else
		guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] Loading will be calculated. Dep: "+string(dtDepartureTimeLocal, "dd.mm.yy hh:mm") +" / now: "+string(ldt_jetzt, "dd.mm.yy hh:mm")+", Diff: " + string(lrow2 / 60) +" / CutOff: "+string(lrow1))
	end if
else
	guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] No Cutoff Time found for sUnit="+sUnit+", lAirlinekey="+string(lAirlinekey)+", lFlightNumber="+string(lFlightNumber)+", sRoutingShortText="+sRoutingShortText+", sDepartureTime="+sDepartureTime+", dGenerationDate="+string(dGenerationDate))
end if

destroy ldw_cutoff


dsCenOutHandling.setfilter("nresult_key = " + string( lResultKey ) )
dsCenOutHandling.filter()
guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] dsCenOutHandling rows: "+string(dsCenOutHandling.rowcount()))

dsCenOutPax.setfilter("NRESULT_KEY_GROUP = " + string( lResultKeyGroup ) )
dsCenOutPax.filter()
guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] dsCenOutPax rows: "+string(dsCenOutPax.rowcount()))

uo_explosion = create uo_flight_explosion

uo_explosion.uf_retrieve_unsaved( dsCenOutPax, dsCenOutHandling, lResultKey, dNewGenerationDate, sDepartureTime)

//uo_explosion.ds_loadinglist.saveas("C:\temp\"+uo_explosion.ds_loadinglist.dataobject +".xlsx", xlsx!, true)

for lrow1 = 1 to uo_explosion.ds_loadinglist.rowcount()
	idsCenOutLoading.insertrow(1)
	idsCenOutLoading.setitem(1, "nresult_key", 									lResultKey )
	idsCenOutLoading.setitem(1, "ntransaction", 								lTransActionKey )
	idsCenOutLoading.setitem(1, "cen_loadinglist_index_cloadinglist", 		uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_loadinglist_index_cloadinglist") )
	idsCenOutLoading.setitem(1, "cen_loadinglist_index_ctext", 				"n/a" )
	idsCenOutLoading.setitem(1, "cen_loadinglist_index_dvalid_from", 	f_jetzt() )
	idsCenOutLoading.setitem(1, "cen_loadinglist_index_dvalid_to", 		f_jetzt() )
	idsCenOutLoading.setitem(1, "cgalley", 										uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_galley_cgalley") )
	idsCenOutLoading.setitem(1, "cpackinglist", 									uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_packinglist_index_cpackinglist") )
	idsCenOutLoading.setitem(1, "cpl_text", 										uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_packinglists_ctext") )
	idsCenOutLoading.setitem(1, "cplace", 										uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_stowage_cplace") )
	idsCenOutLoading.setitem(1, "cstowage", 									uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_stowage_cstowage") )
	idsCenOutLoading.setitem(1, "dtimestamp", 								f_jetzt() )
	idsCenOutLoading.setitem(1, "nbelly_container", 							uo_explosion.ds_loadinglist.getitemnumber( lrow1, "cen_loadinglists_nbelly_container") )
	idsCenOutLoading.setitem(1, "ngalley_key", 								uo_explosion.ds_loadinglist.getitemnumber( lrow1, "cen_galley_ngalley_key") )
	idsCenOutLoading.setitem(1, "ngalley_sort", 								uo_explosion.ds_loadinglist.getitemnumber( lrow1, "cen_galley_nsort") )
	idsCenOutLoading.setitem(1, "nhandling_id", 								0 )
	idsCenOutLoading.setitem(1, "nloadinglist_detail_key", 					uo_explosion.ds_loadinglist.getitemnumber( lrow1, "cen_loadinglists_nloadinglist_detail_key") )
	idsCenOutLoading.setitem(1, "nloadinglist_index_key", 					uo_explosion.ds_loadinglist.getitemnumber( lrow1, "nloadinglist_index_key") )
	idsCenOutLoading.setitem(1, "npackinglist_index_key", 					uo_explosion.ds_loadinglist.getitemnumber( lrow1, "cen_packinglist_index_npackinglist_index_key") )
	idsCenOutLoading.setitem(1, "nquantity", 									uo_explosion.ds_loadinglist.getitemnumber( lrow1, "cen_loadinglists_nquantity") )
	idsCenOutLoading.setitem(1, "nstowage_key", 								uo_explosion.ds_loadinglist.getitemnumber( lrow1, "cen_stowage_nstowage_key") )
	idsCenOutLoading.setitem(1, "nstowage_sort", 							uo_explosion.ds_loadinglist.getitemnumber( lrow1, "cen_stowage_nsort") )
	
	lrow3 = idsOldCenOutLoading.find("nloadinglist_detail_key = " + string( idsCenOutLoading.getitemnumber(1, "nloadinglist_detail_key" ) ), 1, idsOldCenOutLoading.rowcount() )
	if lrow3 = 0 then
		guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] new Entry " + uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_galley_cgalley") + " " + uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_stowage_cstowage") + uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_stowage_cplace") + " / " + uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_packinglist_index_cpackinglist") +" "+ string(uo_explosion.ds_loadinglist.getitemnumber( lrow1, "cen_loadinglists_nquantity")))
		lSeq = f_sequence( "SEQ_CEN_OUT_LOADING", SQLCA )
	
		idsCenOutLoading.setitem(1, "nco_loading_key", 							lSeq )
		idsCenOutLoading.setitem(1, "nchanged", 									1 )
		idsCenOutLoading.setitem(1, "nquantity_old", 								0 )
		idsCenOutLoading.setitem(1, "npackinglist_index_key_old", 				0 )
		idsCenOutLoading.setitem(1, "cpackinglist_old", 							" " )
		idsCenOutLoading.setitem(1, "cpl_text_old", 								" " )
	else
		idsCenOutLoading.setitem(1, "nco_loading_key", 							idsOldCenOutLoading.getitemnumber(lrow3, "nco_loading_key") )
		idsCenOutLoading.setitem(1, "nquantity_old", 								idsOldCenOutLoading.getitemnumber(lrow3, "nquantity") )
		idsCenOutLoading.setitem(1, "npackinglist_index_key_old", 				idsOldCenOutLoading.getitemnumber(lrow3, "npackinglist_index_key") )
		idsCenOutLoading.setitem(1, "cpackinglist_old", 							idsOldCenOutLoading.getitemstring(lrow3, "cpackinglist") )
		idsCenOutLoading.setitem(1, "cpl_text_old", 								idsOldCenOutLoading.getitemstring(lrow3, "cpl_text") )
		
		if idsCenOutLoading.getitemnumber(1, "nquantity") <> idsCenOutLoading.getitemnumber(1, "nquantity_old") or &
			idsCenOutLoading.getitemnumber(1, "npackinglist_index_key") <> idsCenOutLoading.getitemnumber(1, "npackinglist_index_key_old") then

			guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] changed Entry " + uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_galley_cgalley") + " " + uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_stowage_cstowage") + uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_stowage_cplace") + " / " + idsOldCenOutLoading.getitemstring(lrow3, "cpackinglist") +" "+ string(idsOldCenOutLoading.getitemnumber(lrow3, "nquantity")) +" => " + uo_explosion.ds_loadinglist.getitemstring( lrow1, "cen_packinglist_index_cpackinglist") +" "+ string(uo_explosion.ds_loadinglist.getitemnumber( lrow1, "cen_loadinglists_nquantity")))
			idsCenOutLoading.setitem(1, "nchanged", 								1 )
		else
			idsCenOutLoading.setitem(1, "nchanged", 								0 )
		end if
		
		idsOldCenOutLoading.deleterow(lrow3)
	end if


next

guoLog.uf_debug("["+ this.classname( )+".of_generate_loading]  Rest in idsOldCenOutLoading.rowcount(): "+string( idsOldCenOutLoading.rowcount()))

if idsOldCenOutLoading.rowcount() > 0 then
	for lrow3 = idsOldCenOutLoading.rowcount() to 1 step -1
		if idsOldCenOutLoading.getitemnumber(lrow3, "nquantity") = 0 then
			guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] delete Entry " + idsOldCenOutLoading.getitemstring(lrow3, "cgalley") + " " + idsOldCenOutLoading.getitemstring(lrow3, "cstowage") + idsOldCenOutLoading.getitemstring(lrow3, "cplace") + " / " + idsOldCenOutLoading.getitemstring(lrow3, "cpackinglist") +" "+ string(idsOldCenOutLoading.getitemnumber(lrow3, "nquantity")))
			idsOldCenOutLoading.deleterow( lrow3 )
		else
		
			idsOldCenOutLoading.setitem(lrow3, "npackinglist_index_key_old", 			idsOldCenOutLoading.getitemnumber(lrow3, "npackinglist_index_key"))
			idsOldCenOutLoading.setitem(lrow3, "cpackinglist_old", 							idsOldCenOutLoading.getitemstring(lrow3, "cpackinglist"))
			idsOldCenOutLoading.setitem(lrow3, "cpl_text_old", 								idsOldCenOutLoading.getitemstring(lrow3, "cpl_text") )
			idsOldCenOutLoading.setitem(lrow3, "nquantity_old", 							idsOldCenOutLoading.getitemnumber(lrow3, "nquantity") )
			idsOldCenOutLoading.setitem(lrow3, "nquantity", 									0)
			idsOldCenOutLoading.setitem(lrow3, "nchanged", 									1)
			
			  guoLog.uf_debug("["+ this.classname( )+".of_generate_loading] Not needed Entry " + idsOldCenOutLoading.getitemstring(lrow3, "cgalley") + " " + idsOldCenOutLoading.getitemstring(lrow3, "cstowage") + idsOldCenOutLoading.getitemstring(lrow3, "cplace") + " / " + idsOldCenOutLoading.getitemstring(lrow3, "cpackinglist") +" "+ string(idsOldCenOutLoading.getitemnumber(lrow3, "nquantity")))
			  
		end if		
	next
	if idsOldCenOutLoading.rowcount() > 0 then
		idsOldCenOutLoading.rowscopy(1, idsOldCenOutLoading.rowcount(), primary!, idsCenOutLoading, 1, primary!)
	end if
end if
...
idsCenOutLoading.sort()

destroy uo_explosion

guoLog.uf_info("["+ this.classname( )+".of_generate_loading]  idsCenOutLoading.rows: " + string(idsCenOutLoading.rowcount()))
...
event constructor;guoLog.uf_debug("["+ this.classname( )+".constructor] Begin")
// 26.06.2009 HR:
...
dsjobs2generate							= Create uo_generate_datastore
...
dsReturnFlightSchedule					= Create uo_generate_datastore
...
//FRE 15.05.2008
dsGenerateRoutingPlanHandling					= Create uo_generate_datastore
...
dsTrafficAreas								= Create uo_generate_datastore
...
dsAirlineClasses								= Create uo_generate_datastore
...
dsHandlingQaq									= Create uo_generate_datastore
...
dsHandlingNewsAddon							= Create uo_generate_datastore
...
dsLocalTimes									= Create uo_generate_datastore
dsLocalTimes.DataObject 					= "dw_generate_local_times"
dsLocalTimes.SetTransObject(SQLCA)

dsLocalTimesFlights							= Create uo_generate_datastore
dsLocalTimesFlights.DataObject 			= "dw_generate_local_times_flights"
dsLocalTimesFlights.SetTransObject(SQLCA)

dsGenerateFlight								= Create uo_generate_datastore
dsGenerateFlight.DataObject 				= "dw_generate_single_flight"
dsGenerateFlight.SetTransObject(SQLCA)

dsFlightData									= Create uo_generate_datastore
dsFlightData.DataObject 					= "dw_change_flightdata"
dsFlightData.SetTransObject(SQLCA)

dsGenerateNFB									= Create uo_generate_datastore
...
dsHandlingTypeCache = create uo_generate_datastore
...
dsCustomerCodes										= Create uo_generate_datastore
dsCustomerCodes.DataObject 						= "dw_generate_customer_codes"
dsCustomerCodes.SetTransObject(SQLCA)

dsHandlingInfo										= Create uo_generate_datastore
...
dsGenerateNonACType									= Create uo_generate_datastore
dsGenerateNonACType.DataObject 					= "dw_generate_non_actypes"
dsGenerateNonACType.SetTransObject(SQLCA)

dsCenOutCache											= Create uo_generate_datastore
...
dsCITPFlightData									= Create uo_generate_datastore
...
dsResultkeys										= Create uo_generate_datastore
dsResultkeys.DataObject 							= "dw_cen_out_resultkeys"
dsResultkeys.SetTransObject(SQLCA)		

// 02.09.2009 HR: AMOS Abl$$HEX1$$f600$$ENDHEX$$sung
dsCITPFlightDataSPML									= Create uo_generate_datastore
...
// --------------------------------------------------------------------------------------------------------------------
dsLocal_adjustments = create uo_generate_datastore
dsLocal_adjustments.dataobject="dw_altea_local_adjustments"
dsLocal_adjustments.settransobject(SQLCA)

// --------------------------------------------------------------------------------------------------------------------
// 20.08.2019 HR: AlmID 4226: AlmID 4226: Tempor$$HEX1$$e400$$ENDHEX$$re Tabelle f$$HEX1$$fc00$$ENDHEX$$r die schrittweise Umstellung auf den Forecasterzahlen
// --------------------------------------------------------------------------------------------------------------------
dsForecastUse = create uo_generate_datastore
dsForecastUse.dataobject="dw_sys_forecast_use"
dsForecastUse.settransobject(SQLCA)

// --------------------------------------------------------------------------------------------------------------------
// 29.10.2021 HR: AlmID 7905
// --------------------------------------------------------------------------------------------------------------------
dsFlightDataSpml = create uo_generate_datastore
dsFlightDataSpml.dataobject="dw_external_amos_spml"
dsFlightDataSpml.settransobject(SQLCA)

// --------------------------------------------------------------------------------------------------------------------
// 25.05.2023 HR:
// --------------------------------------------------------------------------------------------------------------------
dsFlightClosedFlights = create uo_generate_datastore
dsFlightClosedFlights.dataobject="dw_flightclosed_sysflightpricer"
dsFlightClosedFlights.settransobject(SQLCA)

// --------------------------------------------------------------------------------------------------------------------
// 31.01.2025 HR:
// --------------------------------------------------------------------------------------------------------------------
ids_polaris_documentnumber = create datastore
ids_polaris_documentnumber.dataobject="dw_polaris_documentnumber"
ids_polaris_documentnumber.settransobject(SQLCA)

// --------------------------------------------------------------------------------------------------------------------
// 24.04.2025 HR: request #11290 New dynamic loading settings on loading lists on CBASEclassic
// --------------------------------------------------------------------------------------------------------------------
idsCenOutLoading = create uo_generate_datastore
idsCenOutLoading.dataobject="dw_change_cen_out_loading"
idsCenOutLoading.settransobject(SQLCA)

idsOldCenOutLoading = create uo_generate_datastore
idsOldCenOutLoading.dataobject="dw_change_cen_out_loading"
idsOldCenOutLoading.settransobject(SQLCA)

ibGenerateLoading = ( f_mandant_profilestring(sqlca, s_app.sMandant,  "General", "FillCenOutLoading", "0") = "1" )

select max(length(ctext)) 
into :ii_loc_jobs_types_ctext_length
from loc_jobs_types;

if isnull(ii_loc_jobs_types_ctext_length) or ii_loc_jobs_types_ctext_length<20 then
	ii_loc_jobs_types_ctext_length = 39
end if

ii_loc_jobs_types_ctext_length++

guoLog.uf_debug("["+ this.classname( )+".constructor] End")
end event

event destructor;guoLog.uf_debug("["+ this.classname( )+".destructor] Begin")
destroy (uo_calc)
destroy (uo_generate_meals)

destroy (dsjobs2generate)
destroy (dsGenerateSchedule)
...
destroy (dsForecastUse)				// 20.08.2019 HR: AlmID 4226: Tempor$$HEX1$$e400$$ENDHEX$$re Tabelle f$$HEX1$$fc00$$ENDHEX$$r die schrittweise Umstellung auf den Forecasterzahlen
destroy (dsFlightDataSpml)				// 29.10.2021 HR: AlmID 7905
destroy (dsFlightClosedFlights)			// 25.05.2023 HR:
destroy (ids_polaris_documentnumber ) // 31.01.2025 HR:

// --------------------------------------------------------------------------------------------------------------------
// 24.04.2025 HR: request #11290 New dynamic loading settings on loading lists on CBASEclassic
// --------------------------------------------------------------------------------------------------------------------
guoLog.uf_debug("["+ this.classname( )+".destructor] 2")
destroy (idsCenOutLoading)

guoLog.uf_debug("["+ this.classname( )+".destructor] 3")
destroy (idsOldCenOutLoading)

guoLog.uf_debug("["+ this.classname( )+".destructor] 4")
garbagecollect()

guoLog.uf_allways("["+ this.classname( )+".destructor] End")
end event

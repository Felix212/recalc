...
guoLog.uf_error("["+ this.classname( )+"." + this.dataobject +"] " + sOut)
...
if row > 0 then
	guoLog.uf_error("["+ this.classname( )+"." + this.dataobject +"] --------------------------------------------------------------------")		
	...
	for lColumns = 1 to dsObjects.RowCount()
		...
		guoLog.uf_error("["+ this.classname( )+"." + this.dataobject +"] " + Right(sTemp + sColumn, 30) + ": " + sValue)		
...
event sqlpreview;
guoLog.uf_trace("["+ this.classname( )+"." + this.dataobject +"] " + sqlsyntax)
guoLog.uf_trace("["+ this.classname( )+"." + this.dataobject +"] -----------------------------------------------------------------")

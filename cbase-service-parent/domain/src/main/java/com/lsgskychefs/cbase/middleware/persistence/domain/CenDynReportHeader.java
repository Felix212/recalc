...
/**
 * Entity(DomainObject) for table CEN_DYN_REPORT_HEADER
 *
 * @author Hibernate Tools
 */
@Entity
@Table(name = "CEN_DYN_REPORT_HEADER"
)
public class CenDynReportHeader implements DomainObject, java.io.Serializable {
    /** serialVersionUID */
    private static final long serialVersionUID = 1L;

    private CenDynReportHeaderId id;
    ...
    public CenDynReportHeaderId getId() {
        return this.id;
    }

    public void setId(CenDynReportHeaderId id) {
        this.id = id;
    }

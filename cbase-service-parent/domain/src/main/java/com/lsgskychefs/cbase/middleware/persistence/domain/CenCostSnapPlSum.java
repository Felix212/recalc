...
/**
 * Entity(DomainObject) for table CEN_COST_SNAP_PL_SUM
 *
 * @author Hibernate Tools
 */
@Entity
@Table(name = "CEN_COST_SNAP_PL_SUM"
)
public class CenCostSnapPlSum implements DomainObject, java.io.Serializable {

	/** serialVersionUID */
	private static final long serialVersionUID = 1L;

	private CenCostSnapPlSumId id;
	@JsonIgnore
	...
	private BigDecimal nsumLabCosts;
	private BigDecimal nsumSeconds;
	private long npackinglistBatchQuantity;
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "cunit", column = @Column(name = "CUNIT", nullable = false, length = 5)),
			@AttributeOverride(name = "npriceCatKey", column = @Column(name = "NPRICE_CAT_KEY", nullable = false, precision = 12, scale = 0)) })
	public CenCostSnapPlSumId getId() {
		return this.id;
	}

	public void setId(final CenCostSnapPlSumId id) {
		this.id = id;
	}
	...
	@Column(name = "CCATEGORY", length = 30)
	...
	@Column(name = "NSUM_LAB_COSTS", nullable = false, precision = 13, scale = 5)
	public BigDecimal getNsumLabCosts() {
		return this.nsumLabCosts;
	}

	public void setNsumLabCosts(final BigDecimal nsumLabCosts) {
		this.nsumLabCosts = nsumLabCosts;
	}
	...
	@Column(name = "NPACKINGLIST_BATCH_QUANTITY", nullable = false, precision = 12, scale = 0)
	public long getNpackinglistBatchQuantity() {
		return this.npackinglistBatchQuantity;
	}

	public void setNpackinglistBatchQuantity(final long npackinglistBatchQuantity) {
		this.npackinglistBatchQuantity = npackinglistBatchQuantity;
	}

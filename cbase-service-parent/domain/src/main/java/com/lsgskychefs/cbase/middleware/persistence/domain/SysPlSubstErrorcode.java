...
// Generated Jun 27, 2019 4:02:03 PM by Hibernate Tools 4.3.5.Final
...
/**
 * Entity(DomainObject) for table SYS_PL_SUBST_ERRORCODE
 * 
 * @author Hibernate Tools
 */
@Entity
@Table(name = "SYS_PL_SUBST_ERRORCODE")
public class SysPlSubstErrorcode implements DomainObject, java.io.Serializable {

	/** serialVersionUID */
	private static final long serialVersionUID = 1L;

	private long nplsubstErrorcodeKey;
	private int nsort;
	...
	@Id
	@Column(name = "NPLSUBST_ERRORCODE_KEY", unique = true, nullable = false, precision = 12, scale = 0)
	public long getNplsubstErrorcodeKey() {
		return this.nplsubstErrorcodeKey;
	}

	public void setNplsubstErrorcodeKey(final long nplsubstErrorcodeKey) {
		this.nplsubstErrorcodeKey = nplsubstErrorcodeKey;
	}

...
/**
 * Entity(DomainObject) for table CEN_PRICE_SNAPSHOT_PL
 *
 * @author Hibernate Tools
 */
@Entity
@Table(name = "CEN_PRICE_SNAPSHOT_PL"
)
public class CenPriceSnapshotPl implements DomainObject, java.io.Serializable {

	/** serialVersionUID */
	private static final long serialVersionUID = 1L;

	private CenPriceSnapshotPlId id;
	@JsonIgnore
	...
	public CenPriceSnapshotPlId getId() {
		return this.id;
	}

	public void setId(final CenPriceSnapshotPlId id) {
		this.id = id;
	}

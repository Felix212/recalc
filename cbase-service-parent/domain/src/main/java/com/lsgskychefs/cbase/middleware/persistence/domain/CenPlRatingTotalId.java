...
/**
 * CenPlRatingTotalId generated by hbm2java
 */
@Embeddable
public class CenPlRatingTotalId  implements java.io.Serializable {
    /** serialVersionUID */
    ...
    public CenPlRatingTotalId() {
    }

    public CenPlRatingTotalId(long npackinglistIndexKey, long npackinglistDetailKey) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CenPlRatingTotalId) ) return false;
		 CenPlRatingTotalId castOther = ( CenPlRatingTotalId ) other; 
